---
permalink: /google_workbench_instance_iam_binding/
---

# google_workbench_instance_iam_binding

`google_workbench_instance_iam_binding` represents the `google-beta_google_workbench_instance_iam_binding` Terraform resource.
