...
`google-beta.list.withAttachedDisk` constructs a mixin object that can be merged into the `list`
...
`google-beta.list.withScratchDisk` constructs a mixin object that can be merged into the `list`
...
`google-beta.string.withSourceInstanceTemplate` constructs a mixin object that can be merged into the `string`
