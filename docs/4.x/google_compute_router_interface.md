...
`google-beta.google_compute_router_interface.withPrivateIpAddress` constructs a mixin object that can be merged into the `google_compute_router_interface`
