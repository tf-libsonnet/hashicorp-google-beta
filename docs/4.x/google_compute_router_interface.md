...
`google-beta.string.withInterconnectAttachment` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withPrivateIpAddress` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withRedundantInterface` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withVpnTunnel` constructs a mixin object that can be merged into the `string`
