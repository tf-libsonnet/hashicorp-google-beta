...
`google-beta.google_eventarc_trigger.withChannel` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withDestination` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withDestinationMixin` constructs a mixin object that can be merged into the `google_eventarc_trigger`
Terraform resource block to set or update the destination field.
...
`google-beta.google_eventarc_trigger.withLabels` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withLocation` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withMatchingCriteria` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withMatchingCriteriaMixin` constructs a mixin object that can be merged into the `google_eventarc_trigger`
Terraform resource block to set or update the matching_criteria field.
...
`google-beta.google_eventarc_trigger.withName` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withProject` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withServiceAccount` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withTimeouts` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_eventarc_trigger`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_eventarc_trigger.withTransport` constructs a mixin object that can be merged into the `google_eventarc_trigger`
...
`google-beta.google_eventarc_trigger.withTransportMixin` constructs a mixin object that can be merged into the `google_eventarc_trigger`
Terraform resource block to set or update the transport field.
