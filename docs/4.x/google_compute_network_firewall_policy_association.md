...
`google-beta.google_compute_network_firewall_policy_association.withAttachmentTarget` constructs a mixin object that can be merged into the `google_compute_network_firewall_policy_association`
...
`google-beta.google_compute_network_firewall_policy_association.withFirewallPolicy` constructs a mixin object that can be merged into the `google_compute_network_firewall_policy_association`
...
`google-beta.google_compute_network_firewall_policy_association.withName` constructs a mixin object that can be merged into the `google_compute_network_firewall_policy_association`
...
`google-beta.google_compute_network_firewall_policy_association.withProject` constructs a mixin object that can be merged into the `google_compute_network_firewall_policy_association`
...
`google-beta.google_compute_network_firewall_policy_association.withTimeouts` constructs a mixin object that can be merged into the `google_compute_network_firewall_policy_association`
...
`google-beta.google_compute_network_firewall_policy_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_network_firewall_policy_association`
Terraform resource block to set or update the timeouts field.
