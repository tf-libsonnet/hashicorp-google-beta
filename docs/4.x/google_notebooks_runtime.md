...
`google-beta.google_notebooks_runtime.withAccessConfig` constructs a mixin object that can be merged into the `google_notebooks_runtime`
...
`google-beta.google_notebooks_runtime.withAccessConfigMixin` constructs a mixin object that can be merged into the `google_notebooks_runtime`
Terraform resource block to set or update the access_config field.
...
`google-beta.google_notebooks_runtime.withLocation` constructs a mixin object that can be merged into the `google_notebooks_runtime`
...
`google-beta.google_notebooks_runtime.withName` constructs a mixin object that can be merged into the `google_notebooks_runtime`
...
`google-beta.google_notebooks_runtime.withProject` constructs a mixin object that can be merged into the `google_notebooks_runtime`
...
`google-beta.google_notebooks_runtime.withSoftwareConfig` constructs a mixin object that can be merged into the `google_notebooks_runtime`
...
`google-beta.google_notebooks_runtime.withSoftwareConfigMixin` constructs a mixin object that can be merged into the `google_notebooks_runtime`
Terraform resource block to set or update the software_config field.
...
`google-beta.google_notebooks_runtime.withTimeouts` constructs a mixin object that can be merged into the `google_notebooks_runtime`
...
`google-beta.google_notebooks_runtime.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_notebooks_runtime`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_notebooks_runtime.withVirtualMachine` constructs a mixin object that can be merged into the `google_notebooks_runtime`
...
`google-beta.google_notebooks_runtime.withVirtualMachineMixin` constructs a mixin object that can be merged into the `google_notebooks_runtime`
Terraform resource block to set or update the virtual_machine field.
