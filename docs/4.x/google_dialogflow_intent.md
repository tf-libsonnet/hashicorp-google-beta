...
`google-beta.google_dialogflow_intent.withAction` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withDefaultResponsePlatforms` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withDisplayName` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withEvents` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withInputContextNames` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withIsFallback` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withMlDisabled` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withParentFollowupIntentName` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withPriority` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withProject` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withResetContexts` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withTimeouts` constructs a mixin object that can be merged into the `google_dialogflow_intent`
...
`google-beta.google_dialogflow_intent.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_dialogflow_intent`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_dialogflow_intent.withWebhookState` constructs a mixin object that can be merged into the `google_dialogflow_intent`
