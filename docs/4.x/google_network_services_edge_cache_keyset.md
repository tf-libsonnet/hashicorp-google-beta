...
`google-beta.google_network_services_edge_cache_keyset.withProject` constructs a mixin object that can be merged into the `google_network_services_edge_cache_keyset`
