---
permalink: /google_alloydb_backup/
---

# google_alloydb_backup

`google_alloydb_backup` represents the `google-beta_google_alloydb_backup` Terraform resource.
...
`google-beta.string.withBackupId` constructs a mixin object that can be merged into the `string`
