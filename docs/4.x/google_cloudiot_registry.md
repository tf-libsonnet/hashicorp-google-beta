...
`google-beta.google_cloudiot_registry.withCredentials` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withCredentialsMixin` constructs a mixin object that can be merged into the `google_cloudiot_registry`
Terraform resource block to set or update the credentials field.
...
`google-beta.google_cloudiot_registry.withEventNotificationConfigs` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withEventNotificationConfigsMixin` constructs a mixin object that can be merged into the `google_cloudiot_registry`
Terraform resource block to set or update the event_notification_configs field.
...
`google-beta.google_cloudiot_registry.withHttpConfig` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withLogLevel` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withMqttConfig` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withName` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withProject` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withRegion` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withStateNotificationConfig` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withTimeouts` constructs a mixin object that can be merged into the `google_cloudiot_registry`
...
`google-beta.google_cloudiot_registry.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_cloudiot_registry`
Terraform resource block to set or update the timeouts field.
