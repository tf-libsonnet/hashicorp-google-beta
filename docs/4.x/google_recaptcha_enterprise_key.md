...
`google-beta.list[obj].withAndroidSettings` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withAndroidSettingsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the android_settings field.
...
`google-beta.list[obj].withIosSettings` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withIosSettingsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the ios_settings field.
...
`google-beta.list[obj].withTestingOptions` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withTestingOptionsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the testing_options field.
...
`google-beta.list[obj].withWafSettings` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withWafSettingsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the waf_settings field.
...
`google-beta.list[obj].withWebSettings` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withWebSettingsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the web_settings field.
