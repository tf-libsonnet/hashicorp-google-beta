...
`google-beta.google_security_scanner_scan_config.withAuthentication` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withAuthenticationMixin` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
Terraform resource block to set or update the authentication field.
...
`google-beta.google_security_scanner_scan_config.withBlacklistPatterns` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withDisplayName` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withExportToSecurityCommandCenter` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withMaxQps` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withProject` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withSchedule` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withScheduleMixin` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
Terraform resource block to set or update the schedule field.
...
`google-beta.google_security_scanner_scan_config.withStartingUrls` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withTargetPlatforms` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withTimeouts` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
...
`google-beta.google_security_scanner_scan_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_security_scanner_scan_config.withUserAgent` constructs a mixin object that can be merged into the `google_security_scanner_scan_config`
