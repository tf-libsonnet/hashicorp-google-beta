...
`google-beta.google_container_analysis_occurrence.withAttestation` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
...
`google-beta.google_container_analysis_occurrence.withAttestationMixin` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
Terraform resource block to set or update the attestation field.
...
`google-beta.google_container_analysis_occurrence.withNoteName` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
...
`google-beta.google_container_analysis_occurrence.withProject` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
...
`google-beta.google_container_analysis_occurrence.withRemediation` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
...
`google-beta.google_container_analysis_occurrence.withResourceUri` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
...
`google-beta.google_container_analysis_occurrence.withTimeouts` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
...
`google-beta.google_container_analysis_occurrence.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_container_analysis_occurrence`
Terraform resource block to set or update the timeouts field.
