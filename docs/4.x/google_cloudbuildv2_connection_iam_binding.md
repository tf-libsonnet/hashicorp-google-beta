---
permalink: /google_cloudbuildv2_connection_iam_binding/
---

# google_cloudbuildv2_connection_iam_binding

`google_cloudbuildv2_connection_iam_binding` represents the `google-beta_google_cloudbuildv2_connection_iam_binding` Terraform resource.
