...
`google-beta.google_compute_ha_vpn_gateway.withDescription` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
...
`google-beta.google_compute_ha_vpn_gateway.withName` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
...
`google-beta.google_compute_ha_vpn_gateway.withNetwork` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
...
`google-beta.google_compute_ha_vpn_gateway.withProject` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
...
`google-beta.google_compute_ha_vpn_gateway.withRegion` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
...
`google-beta.google_compute_ha_vpn_gateway.withTimeouts` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
...
`google-beta.google_compute_ha_vpn_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_compute_ha_vpn_gateway.withVpnInterfaces` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
...
`google-beta.google_compute_ha_vpn_gateway.withVpnInterfacesMixin` constructs a mixin object that can be merged into the `google_compute_ha_vpn_gateway`
Terraform resource block to set or update the vpn_interfaces field.
