...
`google-beta.google_compute_image.withDescription` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withDiskSizeGb` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withGuestOsFeatures` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withGuestOsFeaturesMixin` constructs a mixin object that can be merged into the `google_compute_image`
Terraform resource block to set or update the guest_os_features field.
...
`google-beta.google_compute_image.withLabels` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withLicenses` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withRawDisk` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withRawDiskMixin` constructs a mixin object that can be merged into the `google_compute_image`
Terraform resource block to set or update the raw_disk field.
...
`google-beta.google_compute_image.withSourceDisk` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withSourceImage` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withSourceSnapshot` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withTimeouts` constructs a mixin object that can be merged into the `google_compute_image`
...
`google-beta.google_compute_image.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_image`
Terraform resource block to set or update the timeouts field.
