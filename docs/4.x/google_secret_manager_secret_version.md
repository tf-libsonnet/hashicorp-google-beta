...
`google-beta.google_secret_manager_secret_version.withEnabled` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`
...
`google-beta.google_secret_manager_secret_version.withSecretData` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`
...
`google-beta.google_secret_manager_secret_version.withTimeouts` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`
...
`google-beta.google_secret_manager_secret_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`
Terraform resource block to set or update the timeouts field.
