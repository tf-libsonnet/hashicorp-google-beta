...
`google-beta.google_compute_region_ssl_policy.withCustomFeatures` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withDescription` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withMinTlsVersion` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withName` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withProfile` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withProject` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withRegion` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withTimeouts` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
...
`google-beta.google_compute_region_ssl_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_region_ssl_policy`
Terraform resource block to set or update the timeouts field.
