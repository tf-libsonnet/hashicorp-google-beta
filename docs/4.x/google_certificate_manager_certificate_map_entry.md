...
`google-beta.list.withCertificates` constructs a mixin object that can be merged into the `list`
...
`google-beta.string.withMap` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withMatcher` constructs a mixin object that can be merged into the `string`
