...
`google-beta.google_certificate_manager_certificate_map_entry.withMap` constructs a mixin object that can be merged into the `google_certificate_manager_certificate_map_entry`
