---
permalink: /google_cloudbuildv2_connection_iam_member/
---

# google_cloudbuildv2_connection_iam_member

`google_cloudbuildv2_connection_iam_member` represents the `google-beta_google_cloudbuildv2_connection_iam_member` Terraform resource.
