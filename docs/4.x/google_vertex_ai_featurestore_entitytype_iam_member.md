...
`google-beta.google_vertex_ai_featurestore_entitytype_iam_member.withFeaturestore` constructs a mixin object that can be merged into the `google_vertex_ai_featurestore_entitytype_iam_member`
