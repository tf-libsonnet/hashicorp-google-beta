...
`google-beta.google_iam_workload_identity_pool_provider.withAttributeCondition` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withAttributeMapping` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withAws` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withAwsMixin` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
Terraform resource block to set or update the aws field.
...
`google-beta.google_iam_workload_identity_pool_provider.withDescription` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withDisabled` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withDisplayName` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withOidc` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withOidcMixin` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
Terraform resource block to set or update the oidc field.
...
`google-beta.google_iam_workload_identity_pool_provider.withTimeouts` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
...
`google-beta.google_iam_workload_identity_pool_provider.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_iam_workload_identity_pool_provider`
Terraform resource block to set or update the timeouts field.
