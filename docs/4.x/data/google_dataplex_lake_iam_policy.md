---
permalink: /data/google_dataplex_lake_iam_policy/
---

# data.google_dataplex_lake_iam_policy

`google_dataplex_lake_iam_policy` represents the `google-beta_google_dataplex_lake_iam_policy` Terraform data source.
