---
permalink: /data/google_dns_managed_zone_iam_policy/
---

# data.google_dns_managed_zone_iam_policy

`google_dns_managed_zone_iam_policy` represents the `google-beta_google_dns_managed_zone_iam_policy` Terraform data source.
