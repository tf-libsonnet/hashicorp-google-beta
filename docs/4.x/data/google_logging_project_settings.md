---
permalink: /data/google_logging_project_settings/
---

# data.google_logging_project_settings

`google_logging_project_settings` represents the `google-beta_google_logging_project_settings` Terraform data source.
