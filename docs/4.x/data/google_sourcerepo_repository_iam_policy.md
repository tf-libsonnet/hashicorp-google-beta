---
permalink: /data/google_sourcerepo_repository_iam_policy/
---

# data.google_sourcerepo_repository_iam_policy

`google_sourcerepo_repository_iam_policy` represents the `google-beta_google_sourcerepo_repository_iam_policy` Terraform data source.
