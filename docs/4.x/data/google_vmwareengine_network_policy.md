---
permalink: /data/google_vmwareengine_network_policy/
---

# data.google_vmwareengine_network_policy

`google_vmwareengine_network_policy` represents the `google-beta_google_vmwareengine_network_policy` Terraform data source.
