---
permalink: /data/google_sql_database_instance_latest_recovery_time/
---

# data.google_sql_database_instance_latest_recovery_time

`google_sql_database_instance_latest_recovery_time` represents the `google-beta_google_sql_database_instance_latest_recovery_time` Terraform data source.
