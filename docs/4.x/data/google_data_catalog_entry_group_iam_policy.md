---
permalink: /data/google_data_catalog_entry_group_iam_policy/
---

# data.google_data_catalog_entry_group_iam_policy

`google_data_catalog_entry_group_iam_policy` represents the `google-beta_google_data_catalog_entry_group_iam_policy` Terraform data source.
