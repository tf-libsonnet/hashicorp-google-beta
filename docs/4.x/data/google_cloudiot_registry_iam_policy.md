---
permalink: /data/google_cloudiot_registry_iam_policy/
---

# data.google_cloudiot_registry_iam_policy

`google_cloudiot_registry_iam_policy` represents the `google-beta_google_cloudiot_registry_iam_policy` Terraform data source.
