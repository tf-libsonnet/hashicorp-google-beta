---
permalink: /data/google_cloudbuildv2_connection_iam_policy/
---

# data.google_cloudbuildv2_connection_iam_policy

`google_cloudbuildv2_connection_iam_policy` represents the `google-beta_google_cloudbuildv2_connection_iam_policy` Terraform data source.
