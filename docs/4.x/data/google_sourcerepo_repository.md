---
permalink: /data/google_sourcerepo_repository/
---

# data.google_sourcerepo_repository

`google_sourcerepo_repository` represents the `google-beta_google_sourcerepo_repository` Terraform data source.
...
Unlike [google-beta.data.google_sourcerepo_repository.new](#fn-googlesourcereporepositorynew), this function will not inject the `data source`
