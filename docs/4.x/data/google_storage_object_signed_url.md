...
`google-beta.google_storage_object_signed_url.withBucket` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
...
`google-beta.google_storage_object_signed_url.withContentMd5` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
...
`google-beta.google_storage_object_signed_url.withContentType` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
...
`google-beta.google_storage_object_signed_url.withCredentials` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
...
`google-beta.google_storage_object_signed_url.withDuration` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
...
`google-beta.google_storage_object_signed_url.withExtensionHeaders` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
...
`google-beta.google_storage_object_signed_url.withHttpMethod` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
...
`google-beta.google_storage_object_signed_url.withPath` constructs a mixin object that can be merged into the `google_storage_object_signed_url`
