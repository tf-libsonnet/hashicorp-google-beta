---
permalink: /data/google_api_gateway_gateway_iam_policy/
---

# data.google_api_gateway_gateway_iam_policy

`google_api_gateway_gateway_iam_policy` represents the `google-beta_google_api_gateway_gateway_iam_policy` Terraform data source.
