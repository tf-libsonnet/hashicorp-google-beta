---
permalink: /data/google_notebooks_instance_iam_policy/
---

# data.google_notebooks_instance_iam_policy

`google_notebooks_instance_iam_policy` represents the `google-beta_google_notebooks_instance_iam_policy` Terraform data source.
