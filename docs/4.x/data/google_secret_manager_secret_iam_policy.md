---
permalink: /data/google_secret_manager_secret_iam_policy/
---

# data.google_secret_manager_secret_iam_policy

`google_secret_manager_secret_iam_policy` represents the `google-beta_google_secret_manager_secret_iam_policy` Terraform data source.
