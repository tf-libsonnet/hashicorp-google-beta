---
permalink: /data/google_storage_bucket_iam_policy/
---

# data.google_storage_bucket_iam_policy

`google_storage_bucket_iam_policy` represents the `google-beta_google_storage_bucket_iam_policy` Terraform data source.
