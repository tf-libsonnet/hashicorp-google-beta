---
permalink: /data/google_bigquery_connection_iam_policy/
---

# data.google_bigquery_connection_iam_policy

`google_bigquery_connection_iam_policy` represents the `google-beta_google_bigquery_connection_iam_policy` Terraform data source.
