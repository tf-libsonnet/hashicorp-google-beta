---
permalink: /data/google_compute_snapshot_iam_policy/
---

# data.google_compute_snapshot_iam_policy

`google_compute_snapshot_iam_policy` represents the `google-beta_google_compute_snapshot_iam_policy` Terraform data source.
