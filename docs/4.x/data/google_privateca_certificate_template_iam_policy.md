---
permalink: /data/google_privateca_certificate_template_iam_policy/
---

# data.google_privateca_certificate_template_iam_policy

`google_privateca_certificate_template_iam_policy` represents the `google-beta_google_privateca_certificate_template_iam_policy` Terraform data source.
