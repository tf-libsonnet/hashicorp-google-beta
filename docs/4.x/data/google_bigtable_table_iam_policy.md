---
permalink: /data/google_bigtable_table_iam_policy/
---

# data.google_bigtable_table_iam_policy

`google_bigtable_table_iam_policy` represents the `google-beta_google_bigtable_table_iam_policy` Terraform data source.
