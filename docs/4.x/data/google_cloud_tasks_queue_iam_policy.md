---
permalink: /data/google_cloud_tasks_queue_iam_policy/
---

# data.google_cloud_tasks_queue_iam_policy

`google_cloud_tasks_queue_iam_policy` represents the `google-beta_google_cloud_tasks_queue_iam_policy` Terraform data source.
