---
permalink: /data/google_compute_global_forwarding_rule/
---

# data.google_compute_global_forwarding_rule

`google_compute_global_forwarding_rule` represents the `google-beta_google_compute_global_forwarding_rule` Terraform data source.
