---
permalink: /data/google_compute_forwarding_rule/
---

# data.google_compute_forwarding_rule

`google_compute_forwarding_rule` represents the `google-beta_google_compute_forwarding_rule` Terraform data source.
...
Unlike [google-beta.data.google_compute_forwarding_rule.new](#fn-googlecomputeforwardingrulenew), this function will not inject the `data source`
