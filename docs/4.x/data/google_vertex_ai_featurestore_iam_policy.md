---
permalink: /data/google_vertex_ai_featurestore_iam_policy/
---

# data.google_vertex_ai_featurestore_iam_policy

`google_vertex_ai_featurestore_iam_policy` represents the `google-beta_google_vertex_ai_featurestore_iam_policy` Terraform data source.
