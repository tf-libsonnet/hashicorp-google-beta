...
`google-beta.google_container_engine_versions.withLocation` constructs a mixin object that can be merged into the `google_container_engine_versions`
...
`google-beta.google_container_engine_versions.withProject` constructs a mixin object that can be merged into the `google_container_engine_versions`
...
`google-beta.google_container_engine_versions.withVersionPrefix` constructs a mixin object that can be merged into the `google_container_engine_versions`
