---
permalink: /data/google_spanner_instance_iam_policy/
---

# data.google_spanner_instance_iam_policy

`google_spanner_instance_iam_policy` represents the `google-beta_google_spanner_instance_iam_policy` Terraform data source.
