---
permalink: /data/google_cloudfunctions2_function/
---

# data.google_cloudfunctions2_function

`google_cloudfunctions2_function` represents the `google-beta_google_cloudfunctions2_function` Terraform data source.
...
Unlike [google-beta.data.google_cloudfunctions2_function.new](#fn-googlecloudfunctions2functionnew), this function will not inject the `data source`
