...
`google-beta.google_service_account_key.withName` constructs a mixin object that can be merged into the `google_service_account_key`
...
`google-beta.google_service_account_key.withProject` constructs a mixin object that can be merged into the `google_service_account_key`
