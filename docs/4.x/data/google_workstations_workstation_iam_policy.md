---
permalink: /data/google_workstations_workstation_iam_policy/
---

# data.google_workstations_workstation_iam_policy

`google_workstations_workstation_iam_policy` represents the `google-beta_google_workstations_workstation_iam_policy` Terraform data source.
