---
permalink: /data/google_dataproc_metastore_federation_iam_policy/
---

# data.google_dataproc_metastore_federation_iam_policy

`google_dataproc_metastore_federation_iam_policy` represents the `google-beta_google_dataproc_metastore_federation_iam_policy` Terraform data source.
