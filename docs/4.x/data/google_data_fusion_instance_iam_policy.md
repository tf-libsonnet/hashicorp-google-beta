---
permalink: /data/google_data_fusion_instance_iam_policy/
---

# data.google_data_fusion_instance_iam_policy

`google_data_fusion_instance_iam_policy` represents the `google-beta_google_data_fusion_instance_iam_policy` Terraform data source.
