...
`google-beta.google_container_aws_versions.withLocation` constructs a mixin object that can be merged into the `google_container_aws_versions`
...
`google-beta.google_container_aws_versions.withProject` constructs a mixin object that can be merged into the `google_container_aws_versions`
