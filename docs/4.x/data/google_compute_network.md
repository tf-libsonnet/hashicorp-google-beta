---
permalink: /data/google_compute_network/
---

# data.google_compute_network

`google_compute_network` represents the `google-beta_google_compute_network` Terraform data source.
...
Unlike [google-beta.data.google_compute_network.new](#fn-googlecomputenetworknew), this function will not inject the `data source`
