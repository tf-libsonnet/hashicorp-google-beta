---
permalink: /data/google_vmwareengine_external_address/
---

# data.google_vmwareengine_external_address

`google_vmwareengine_external_address` represents the `google-beta_google_vmwareengine_external_address` Terraform data source.
