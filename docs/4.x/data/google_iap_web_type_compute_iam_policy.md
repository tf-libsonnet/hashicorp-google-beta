---
permalink: /data/google_iap_web_type_compute_iam_policy/
---

# data.google_iap_web_type_compute_iam_policy

`google_iap_web_type_compute_iam_policy` represents the `google-beta_google_iap_web_type_compute_iam_policy` Terraform data source.
