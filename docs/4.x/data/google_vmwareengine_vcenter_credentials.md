---
permalink: /data/google_vmwareengine_vcenter_credentials/
---

# data.google_vmwareengine_vcenter_credentials

`google_vmwareengine_vcenter_credentials` represents the `google-beta_google_vmwareengine_vcenter_credentials` Terraform data source.
