...
`google-beta.google_data_catalog_policy_tag.withDescription` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag`
...
`google-beta.google_data_catalog_policy_tag.withDisplayName` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag`
...
`google-beta.google_data_catalog_policy_tag.withParentPolicyTag` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag`
...
`google-beta.google_data_catalog_policy_tag.withTaxonomy` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag`
...
`google-beta.google_data_catalog_policy_tag.withTimeouts` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag`
...
`google-beta.google_data_catalog_policy_tag.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag`
Terraform resource block to set or update the timeouts field.
