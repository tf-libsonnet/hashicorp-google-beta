...
`google-beta.list[obj].withBasicAlgorithm` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withBasicAlgorithmMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the basic_algorithm field.
...
`google-beta.list[obj].withSecondaryWorkerConfig` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withSecondaryWorkerConfigMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the secondary_worker_config field.
