...
`google-beta.string.withEmail` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withLanguageTag` constructs a mixin object that can be merged into the `string`
...
`google-beta.list.withNotificationCategorySubscriptions` constructs a mixin object that can be merged into the `list`
