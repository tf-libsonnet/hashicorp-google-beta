...
`google-beta.google_firebaserules_ruleset.withProject` constructs a mixin object that can be merged into the `google_firebaserules_ruleset`
...
`google-beta.google_firebaserules_ruleset.withSource` constructs a mixin object that can be merged into the `google_firebaserules_ruleset`
...
`google-beta.google_firebaserules_ruleset.withSourceMixin` constructs a mixin object that can be merged into the `google_firebaserules_ruleset`
Terraform resource block to set or update the source field.
...
`google-beta.google_firebaserules_ruleset.withTimeouts` constructs a mixin object that can be merged into the `google_firebaserules_ruleset`
...
`google-beta.google_firebaserules_ruleset.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_firebaserules_ruleset`
Terraform resource block to set or update the timeouts field.
