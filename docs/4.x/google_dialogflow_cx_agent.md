...
`google-beta.google_dialogflow_cx_agent.withAvatarUri` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withDefaultLanguageCode` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withDescription` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withDisplayName` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withEnableSpellCorrection` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withEnableStackdriverLogging` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withLocation` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withProject` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withSecuritySettings` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withSpeechToTextSettings` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withSpeechToTextSettingsMixin` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
Terraform resource block to set or update the speech_to_text_settings field.
...
`google-beta.google_dialogflow_cx_agent.withSupportedLanguageCodes` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withTimeZone` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withTimeouts` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
...
`google-beta.google_dialogflow_cx_agent.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_dialogflow_cx_agent`
Terraform resource block to set or update the timeouts field.
