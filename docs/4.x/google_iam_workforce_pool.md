...
`google-beta.google_iam_workforce_pool.withDescription` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
...
`google-beta.google_iam_workforce_pool.withDisabled` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
...
`google-beta.google_iam_workforce_pool.withDisplayName` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
...
`google-beta.google_iam_workforce_pool.withLocation` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
...
`google-beta.google_iam_workforce_pool.withParent` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
...
`google-beta.google_iam_workforce_pool.withSessionDuration` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
...
`google-beta.google_iam_workforce_pool.withTimeouts` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
...
`google-beta.google_iam_workforce_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_iam_workforce_pool.withWorkforcePoolId` constructs a mixin object that can be merged into the `google_iam_workforce_pool`
