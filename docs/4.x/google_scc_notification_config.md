...
`google-beta.google_scc_notification_config.withConfigId` constructs a mixin object that can be merged into the `google_scc_notification_config`
...
`google-beta.google_scc_notification_config.withDescription` constructs a mixin object that can be merged into the `google_scc_notification_config`
...
`google-beta.google_scc_notification_config.withOrganization` constructs a mixin object that can be merged into the `google_scc_notification_config`
...
`google-beta.google_scc_notification_config.withPubsubTopic` constructs a mixin object that can be merged into the `google_scc_notification_config`
...
`google-beta.google_scc_notification_config.withStreamingConfig` constructs a mixin object that can be merged into the `google_scc_notification_config`
...
`google-beta.google_scc_notification_config.withStreamingConfigMixin` constructs a mixin object that can be merged into the `google_scc_notification_config`
Terraform resource block to set or update the streaming_config field.
...
`google-beta.google_scc_notification_config.withTimeouts` constructs a mixin object that can be merged into the `google_scc_notification_config`
...
`google-beta.google_scc_notification_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_scc_notification_config`
Terraform resource block to set or update the timeouts field.
