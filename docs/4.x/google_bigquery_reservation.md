...
`google-beta.google_bigquery_reservation.withConcurrency` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withIgnoreIdleSlots` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withLocation` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withMultiRegionAuxiliary` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withName` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withProject` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withSlotCapacity` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withTimeouts` constructs a mixin object that can be merged into the `google_bigquery_reservation`
...
`google-beta.google_bigquery_reservation.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_bigquery_reservation`
Terraform resource block to set or update the timeouts field.
