...
`google-beta.google_pubsub_topic.withKmsKeyName` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withLabels` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withMessageRetentionDuration` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withMessageStoragePolicy` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withMessageStoragePolicyMixin` constructs a mixin object that can be merged into the `google_pubsub_topic`
Terraform resource block to set or update the message_storage_policy field.
...
`google-beta.google_pubsub_topic.withName` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withProject` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withSchemaSettings` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withSchemaSettingsMixin` constructs a mixin object that can be merged into the `google_pubsub_topic`
Terraform resource block to set or update the schema_settings field.
...
`google-beta.google_pubsub_topic.withTimeouts` constructs a mixin object that can be merged into the `google_pubsub_topic`
...
`google-beta.google_pubsub_topic.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_pubsub_topic`
Terraform resource block to set or update the timeouts field.
