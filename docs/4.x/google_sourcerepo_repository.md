...
`google-beta.google_sourcerepo_repository.withName` constructs a mixin object that can be merged into the `google_sourcerepo_repository`
...
`google-beta.google_sourcerepo_repository.withProject` constructs a mixin object that can be merged into the `google_sourcerepo_repository`
...
`google-beta.google_sourcerepo_repository.withPubsubConfigs` constructs a mixin object that can be merged into the `google_sourcerepo_repository`
...
`google-beta.google_sourcerepo_repository.withPubsubConfigsMixin` constructs a mixin object that can be merged into the `google_sourcerepo_repository`
Terraform resource block to set or update the pubsub_configs field.
...
`google-beta.google_sourcerepo_repository.withTimeouts` constructs a mixin object that can be merged into the `google_sourcerepo_repository`
...
`google-beta.google_sourcerepo_repository.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_sourcerepo_repository`
Terraform resource block to set or update the timeouts field.
