---
permalink: /google_scc_event_threat_detection_custom_module/
---

# google_scc_event_threat_detection_custom_module

`google_scc_event_threat_detection_custom_module` represents the `google-beta_google_scc_event_threat_detection_custom_module` Terraform resource.
