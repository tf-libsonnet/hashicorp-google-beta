...
`google-beta.google_spanner_instance.withForceDestroy` constructs a mixin object that can be merged into the `google_spanner_instance`
...
`google-beta.google_spanner_instance.withLabels` constructs a mixin object that can be merged into the `google_spanner_instance`
...
`google-beta.google_spanner_instance.withNumNodes` constructs a mixin object that can be merged into the `google_spanner_instance`
...
`google-beta.google_spanner_instance.withProcessingUnits` constructs a mixin object that can be merged into the `google_spanner_instance`
...
`google-beta.google_spanner_instance.withTimeouts` constructs a mixin object that can be merged into the `google_spanner_instance`
...
`google-beta.google_spanner_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_spanner_instance`
Terraform resource block to set or update the timeouts field.
