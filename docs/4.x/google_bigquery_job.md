...
`google-beta.google_bigquery_job.withCopy` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withCopyMixin` constructs a mixin object that can be merged into the `google_bigquery_job`
Terraform resource block to set or update the copy field.
...
`google-beta.google_bigquery_job.withExtract` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withExtractMixin` constructs a mixin object that can be merged into the `google_bigquery_job`
Terraform resource block to set or update the extract field.
...
`google-beta.google_bigquery_job.withJobId` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withJobTimeoutMs` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withLabels` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withLoad` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withLoadMixin` constructs a mixin object that can be merged into the `google_bigquery_job`
Terraform resource block to set or update the load field.
...
`google-beta.google_bigquery_job.withLocation` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withProject` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withQuery` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withQueryMixin` constructs a mixin object that can be merged into the `google_bigquery_job`
Terraform resource block to set or update the query field.
...
`google-beta.google_bigquery_job.withTimeouts` constructs a mixin object that can be merged into the `google_bigquery_job`
...
`google-beta.google_bigquery_job.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_bigquery_job`
Terraform resource block to set or update the timeouts field.
