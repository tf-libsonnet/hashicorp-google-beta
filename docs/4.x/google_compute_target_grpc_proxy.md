...
`google-beta.google_compute_target_grpc_proxy.withDescription` constructs a mixin object that can be merged into the `google_compute_target_grpc_proxy`
...
`google-beta.google_compute_target_grpc_proxy.withName` constructs a mixin object that can be merged into the `google_compute_target_grpc_proxy`
...
`google-beta.google_compute_target_grpc_proxy.withProject` constructs a mixin object that can be merged into the `google_compute_target_grpc_proxy`
...
`google-beta.google_compute_target_grpc_proxy.withTimeouts` constructs a mixin object that can be merged into the `google_compute_target_grpc_proxy`
...
`google-beta.google_compute_target_grpc_proxy.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_target_grpc_proxy`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_compute_target_grpc_proxy.withUrlMap` constructs a mixin object that can be merged into the `google_compute_target_grpc_proxy`
...
`google-beta.google_compute_target_grpc_proxy.withValidateForProxyless` constructs a mixin object that can be merged into the `google_compute_target_grpc_proxy`
