...
serving traffic. Set to &#39;DELETE&#39; to delete the WebApp. Default to &#39;ABANDON&#39; When `null`, the `deletion_policy` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_firebase_web_app.timeouts.new](#fn-google_firebase_web_apptimeoutsnew) constructor.
...
Unlike [google-beta.google_firebase_web_app.new](#fn-google_firebase_web_appnew), this function will not inject the `resource`
