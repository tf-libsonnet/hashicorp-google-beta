...
`google-beta.list[obj].withDefaultVersion` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withDefaultVersionMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the default_version field.
...
`google-beta.bool.withOnlinePredictionConsoleLogging` constructs a mixin object that can be merged into the `bool`
...
`google-beta.bool.withOnlinePredictionLogging` constructs a mixin object that can be merged into the `bool`
