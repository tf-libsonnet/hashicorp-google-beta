...
If not specified, a new Service will automatically be created in the same project as this API. When `null`, the `managed_service` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_api_gateway_api.timeouts.new](#fn-timeoutsnew) constructor.
...
If not specified, a new Service will automatically be created in the same project as this API. When `null`, the `managed_service` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_api_gateway_api.timeouts.new](#fn-timeoutsnew) constructor.
...
`google-beta.string.withApiId` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withManagedService` constructs a mixin object that can be merged into the `string`
