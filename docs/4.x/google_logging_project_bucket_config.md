...
Unlike [google-beta.google_logging_project_bucket_config.new](#fn-google_logging_project_bucket_confignew), this function will not inject the `resource`
