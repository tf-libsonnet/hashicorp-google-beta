...
`google-beta.bool.withIsDefaultNegativeIntent` constructs a mixin object that can be merged into the `bool`
...
`google-beta.bool.withIsDefaultWelcomeIntent` constructs a mixin object that can be merged into the `bool`
