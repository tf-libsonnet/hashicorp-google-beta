...
`google-beta.google_compute_backend_service_signed_url_key.withProject` constructs a mixin object that can be merged into the `google_compute_backend_service_signed_url_key`
