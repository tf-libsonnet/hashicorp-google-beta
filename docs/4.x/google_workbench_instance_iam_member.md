---
permalink: /google_workbench_instance_iam_member/
---

# google_workbench_instance_iam_member

`google_workbench_instance_iam_member` represents the `google-beta_google_workbench_instance_iam_member` Terraform resource.
