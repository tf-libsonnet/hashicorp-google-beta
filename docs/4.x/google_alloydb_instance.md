...
`google-beta.google_alloydb_instance.withAnnotations` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withAvailabilityType` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withCluster` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withDatabaseFlags` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withDisplayName` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withGceZone` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withInstanceId` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withInstanceType` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withLabels` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withMachineConfig` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withMachineConfigMixin` constructs a mixin object that can be merged into the `google_alloydb_instance`
Terraform resource block to set or update the machine_config field.
...
`google-beta.google_alloydb_instance.withReadPoolConfig` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withReadPoolConfigMixin` constructs a mixin object that can be merged into the `google_alloydb_instance`
Terraform resource block to set or update the read_pool_config field.
...
`google-beta.google_alloydb_instance.withTimeouts` constructs a mixin object that can be merged into the `google_alloydb_instance`
...
`google-beta.google_alloydb_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_alloydb_instance`
Terraform resource block to set or update the timeouts field.
