...
`google-beta.list[obj].withClientConnectionConfig` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withClientConnectionConfigMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the client_connection_config field.
...
`google-beta.list[obj].withQueryInsightsConfig` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withQueryInsightsConfigMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the query_insights_config field.
