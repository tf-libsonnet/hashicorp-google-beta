---
permalink: /google_tags_tag_value/
---

# google_tags_tag_value

`google_tags_tag_value` represents the `google-beta_google_tags_tag_value` Terraform resource.
...
`google-beta.google_tags_tag_value.withDescription` constructs a mixin object that can be merged into the `google_tags_tag_value`
...
`google-beta.google_tags_tag_value.withTimeouts` constructs a mixin object that can be merged into the `google_tags_tag_value`
...
`google-beta.google_tags_tag_value.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_tags_tag_value`
Terraform resource block to set or update the timeouts field.
