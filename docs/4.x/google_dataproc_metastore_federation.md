...
Unlike [google-beta.google_dataproc_metastore_federation.new](#fn-google_dataproc_metastore_federationnew), this function will not inject the `resource`
