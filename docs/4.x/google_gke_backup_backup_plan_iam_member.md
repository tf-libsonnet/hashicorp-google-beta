---
permalink: /google_gke_backup_backup_plan_iam_member/
---

# google_gke_backup_backup_plan_iam_member

`google_gke_backup_backup_plan_iam_member` represents the `google-beta_google_gke_backup_backup_plan_iam_member` Terraform resource.
