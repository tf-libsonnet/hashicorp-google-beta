...
`google-beta.google_compute_network_peering_routes_config.withPeering` constructs a mixin object that can be merged into the `google_compute_network_peering_routes_config`
