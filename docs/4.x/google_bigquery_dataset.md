...
`google-beta.google_bigquery_dataset.withAccess` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withAccessMixin` constructs a mixin object that can be merged into the `google_bigquery_dataset`
Terraform resource block to set or update the access field.
...
`google-beta.google_bigquery_dataset.withDatasetId` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withDefaultEncryptionConfiguration` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withDefaultEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `google_bigquery_dataset`
Terraform resource block to set or update the default_encryption_configuration field.
...
`google-beta.google_bigquery_dataset.withDefaultPartitionExpirationMs` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withDefaultTableExpirationMs` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withDeleteContentsOnDestroy` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withDescription` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withFriendlyName` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withLabels` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withLocation` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withMaxTimeTravelHours` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withProject` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withTimeouts` constructs a mixin object that can be merged into the `google_bigquery_dataset`
...
`google-beta.google_bigquery_dataset.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_bigquery_dataset`
Terraform resource block to set or update the timeouts field.
