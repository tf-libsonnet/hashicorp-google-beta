...
`google-beta.google_firebase_android_app.withDeletionPolicy` constructs a mixin object that can be merged into the `google_firebase_android_app`
...
`google-beta.google_firebase_android_app.withDisplayName` constructs a mixin object that can be merged into the `google_firebase_android_app`
...
`google-beta.google_firebase_android_app.withPackageName` constructs a mixin object that can be merged into the `google_firebase_android_app`
...
`google-beta.google_firebase_android_app.withProject` constructs a mixin object that can be merged into the `google_firebase_android_app`
...
`google-beta.google_firebase_android_app.withTimeouts` constructs a mixin object that can be merged into the `google_firebase_android_app`
...
`google-beta.google_firebase_android_app.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_firebase_android_app`
Terraform resource block to set or update the timeouts field.
