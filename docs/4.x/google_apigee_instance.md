...
`google-beta.list.withConsumerAcceptList` constructs a mixin object that can be merged into the `list`
...
`google-beta.string.withDiskEncryptionKeyName` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withIpRange` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withPeeringCidrRange` constructs a mixin object that can be merged into the `string`
