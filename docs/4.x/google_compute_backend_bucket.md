...
`google-beta.google_compute_backend_bucket.withBucketName` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withCdnPolicy` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withCdnPolicyMixin` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
Terraform resource block to set or update the cdn_policy field.
...
`google-beta.google_compute_backend_bucket.withCompressionMode` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withCustomResponseHeaders` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withDescription` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withEdgeSecurityPolicy` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withEnableCdn` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withName` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withProject` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withTimeouts` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
...
`google-beta.google_compute_backend_bucket.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_backend_bucket`
Terraform resource block to set or update the timeouts field.
