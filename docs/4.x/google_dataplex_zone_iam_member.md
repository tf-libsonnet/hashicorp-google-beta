---
permalink: /google_dataplex_zone_iam_member/
---

# google_dataplex_zone_iam_member

`google_dataplex_zone_iam_member` represents the `google-beta_google_dataplex_zone_iam_member` Terraform resource.
