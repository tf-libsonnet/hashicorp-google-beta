...
running &#39;gcloud privateca locations list&#39;.
  ...
  - `config` (`list[obj]`): The config used to create a self-signed X.509 certificate or CSR. When `null`, the `config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_privateca_certificate.config.new](#fn-google_privateca_certificateconfignew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_privateca_certificate.timeouts.new](#fn-google_privateca_certificatetimeoutsnew) constructor.
...
Unlike [google-beta.google_privateca_certificate.new](#fn-google_privateca_certificatenew), this function will not inject the `resource`
