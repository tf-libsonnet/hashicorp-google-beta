...
running &#39;gcloud privateca locations list&#39;.
  ...
  - `config` (`list[obj]`): The config used to create a self-signed X.509 certificate or CSR. When `null`, the `config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_privateca_certificate.config.new](#fn-googleprivatecacertificateconfignew) constructor.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_privateca_certificate.timeouts.new](#fn-googleprivatecacertificatetimeoutsnew) constructor.
...
Unlike [google-beta.google_privateca_certificate.new](#fn-googleprivatecacertificatenew), this function will not inject the `resource`
...
`google-beta.google_privateca_certificate.withCertificateAuthority` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withCertificateTemplate` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withConfig` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withConfigMixin` constructs a mixin object that can be merged into the `google_privateca_certificate`
Terraform resource block to set or update the config field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [google-beta.google_privateca_certificate.withConfig](TODO)
function.
...
`google-beta.google_privateca_certificate.withLabels` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withLifetime` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withLocation` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withName` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withPemCsr` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withPool` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withProject` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withTimeouts` constructs a mixin object that can be merged into the `google_privateca_certificate`
...
`google-beta.google_privateca_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_privateca_certificate`
Terraform resource block to set or update the timeouts field.

This function will merge the passed in value to the existing map. If you wish
to instead replace the entire map with the passed in `value`, use the [google-beta.google_privateca_certificate.withTimeouts](TODO)
function.
