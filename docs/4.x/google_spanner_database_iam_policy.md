---
permalink: /google_spanner_database_iam_policy/
---

# google_spanner_database_iam_policy

`google_spanner_database_iam_policy` represents the `google-beta_google_spanner_database_iam_policy` Terraform resource.
...
`google-beta.google_spanner_database_iam_policy.withDatabase` constructs a mixin object that can be merged into the `google_spanner_database_iam_policy`
...
`google-beta.google_spanner_database_iam_policy.withInstance` constructs a mixin object that can be merged into the `google_spanner_database_iam_policy`
...
`google-beta.google_spanner_database_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `google_spanner_database_iam_policy`
...
`google-beta.google_spanner_database_iam_policy.withProject` constructs a mixin object that can be merged into the `google_spanner_database_iam_policy`
