...
`google-beta.google_bigquery_reservation_assignment.withProject` constructs a mixin object that can be merged into the `google_bigquery_reservation_assignment`
