...
`google-beta.string.withAssignee` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withJobType` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withReservation` constructs a mixin object that can be merged into the `string`
