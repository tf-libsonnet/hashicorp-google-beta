...
&#39;projects/{project_number}/brands/{brand_id}/identityAwareProxyClients/{client_id}&#39;.
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_iap_client.timeouts.new](#fn-google_iap_clienttimeoutsnew) constructor.
...
Unlike [google-beta.google_iap_client.new](#fn-google_iap_clientnew), this function will not inject the `resource`
