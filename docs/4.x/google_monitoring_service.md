...
`google-beta.google_monitoring_service.withBasicService` constructs a mixin object that can be merged into the `google_monitoring_service`
...
`google-beta.google_monitoring_service.withBasicServiceMixin` constructs a mixin object that can be merged into the `google_monitoring_service`
Terraform resource block to set or update the basic_service field.
...
`google-beta.google_monitoring_service.withDisplayName` constructs a mixin object that can be merged into the `google_monitoring_service`
...
`google-beta.google_monitoring_service.withProject` constructs a mixin object that can be merged into the `google_monitoring_service`
...
`google-beta.google_monitoring_service.withServiceId` constructs a mixin object that can be merged into the `google_monitoring_service`
...
`google-beta.google_monitoring_service.withTimeouts` constructs a mixin object that can be merged into the `google_monitoring_service`
...
`google-beta.google_monitoring_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_monitoring_service`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_monitoring_service.withUserLabels` constructs a mixin object that can be merged into the `google_monitoring_service`
