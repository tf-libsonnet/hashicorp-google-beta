---
permalink: /google_vertex_ai_endpoint_iam_binding/
---

# google_vertex_ai_endpoint_iam_binding

`google_vertex_ai_endpoint_iam_binding` represents the `google-beta_google_vertex_ai_endpoint_iam_binding` Terraform resource.
...
`google-beta.string.withEndpoint` constructs a mixin object that can be merged into the `string`
