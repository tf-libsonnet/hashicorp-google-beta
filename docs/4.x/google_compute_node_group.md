...
* [`fn withMaintenanceInterval()`](#fn-withmaintenanceinterval)
...
### fn withMaintenanceInterval

```ts
withMaintenanceInterval()
```

`google-beta.string.withMaintenanceInterval` constructs a mixin object that can be merged into the `string`
