---
permalink: /google_cloud_run_v2_job_iam_member/
---

# google_cloud_run_v2_job_iam_member

`google_cloud_run_v2_job_iam_member` represents the `google-beta_google_cloud_run_v2_job_iam_member` Terraform resource.
