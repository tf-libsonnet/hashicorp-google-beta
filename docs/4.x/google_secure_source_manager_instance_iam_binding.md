---
permalink: /google_secure_source_manager_instance_iam_binding/
---

# google_secure_source_manager_instance_iam_binding

`google_secure_source_manager_instance_iam_binding` represents the `google-beta_google_secure_source_manager_instance_iam_binding` Terraform resource.
