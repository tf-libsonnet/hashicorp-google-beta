...
`google-beta.list.withCustomRequestHeaders` constructs a mixin object that can be merged into the `list`
...
`google-beta.list[obj].withSecuritySettings` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withSecuritySettingsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the security_settings field.
