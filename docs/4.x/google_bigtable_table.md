...
`google-beta.string.withChangeStreamRetention` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withDeletionProtection` constructs a mixin object that can be merged into the `string`
