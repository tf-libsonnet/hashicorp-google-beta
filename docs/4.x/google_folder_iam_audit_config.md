...
`google-beta.google_folder_iam_audit_config.withAuditLogConfig` constructs a mixin object that can be merged into the `google_folder_iam_audit_config`
...
`google-beta.google_folder_iam_audit_config.withAuditLogConfigMixin` constructs a mixin object that can be merged into the `google_folder_iam_audit_config`
Terraform resource block to set or update the audit_log_config field.
...
`google-beta.google_folder_iam_audit_config.withFolder` constructs a mixin object that can be merged into the `google_folder_iam_audit_config`
...
`google-beta.google_folder_iam_audit_config.withService` constructs a mixin object that can be merged into the `google_folder_iam_audit_config`
