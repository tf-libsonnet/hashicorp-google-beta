...
`google-beta.string.withColumnFamily` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withGcRules` constructs a mixin object that can be merged into the `string`
...
`google-beta.list[obj].withMaxAge` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withMaxAgeMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the max_age field.
...
`google-beta.list[obj].withMaxVersion` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withMaxVersionMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the max_version field.
...
`google-beta.string.withTable` constructs a mixin object that can be merged into the `string`
