---
permalink: /google_secure_source_manager_instance_iam_member/
---

# google_secure_source_manager_instance_iam_member

`google_secure_source_manager_instance_iam_member` represents the `google-beta_google_secure_source_manager_instance_iam_member` Terraform resource.
