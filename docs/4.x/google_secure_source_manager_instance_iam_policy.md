---
permalink: /google_secure_source_manager_instance_iam_policy/
---

# google_secure_source_manager_instance_iam_policy

`google_secure_source_manager_instance_iam_policy` represents the `google-beta_google_secure_source_manager_instance_iam_policy` Terraform resource.
