---
permalink: /google_vertex_ai_endpoint_iam_member/
---

# google_vertex_ai_endpoint_iam_member

`google_vertex_ai_endpoint_iam_member` represents the `google-beta_google_vertex_ai_endpoint_iam_member` Terraform resource.
