---
permalink: /google_dataform_repository_iam_member/
---

# google_dataform_repository_iam_member

`google_dataform_repository_iam_member` represents the `google-beta_google_dataform_repository_iam_member` Terraform resource.
