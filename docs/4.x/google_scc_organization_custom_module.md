---
permalink: /google_scc_organization_custom_module/
---

# google_scc_organization_custom_module

`google_scc_organization_custom_module` represents the `google-beta_google_scc_organization_custom_module` Terraform resource.
...
`google-beta.google_scc_organization_custom_module.new` injects a new `google-beta_google_scc_organization_custom_module` Terraform `resource`
...
resource. For example, if you added a new instance to the root using:
    ...
    google-beta.google_scc_organization_custom_module.new('some_id')

You can get the reference to the `id` field of the created `google-beta.google_scc_organization_custom_module` using the reference:

    $._ref.google-beta_google_scc_organization_custom_module.some_id.get('id')

This is the same as directly entering `"${ google-beta_google_scc_organization_custom_module.some_id.id }"` as the value.
...
`google-beta.google_scc_organization_custom_module.newAttrs` constructs a new object with attributes and blocks configured for the `google_scc_organization_custom_module`
Terraform resource.

Unlike [google-beta.google_scc_organization_custom_module.new](#fn-new), this function will not inject the `resource`
...
**Returns**:
  - An attribute object that can be used with [tf.withResource](https://github.com/tf-libsonnet/core/tree/main/docs#fn-withresource) to construct a new `google_scc_organization_custom_module` resource into the root Terraform configuration.
...
`google-beta.google_scc_organization_custom_module.custom_config.new` constructs a new object with attributes and blocks configured for the `custom_config`
Terraform sub block.
...
`google-beta.google_scc_organization_custom_module.custom_config.custom_output.new` constructs a new object with attributes and blocks configured for the `custom_output`
Terraform sub block.
...
`google-beta.google_scc_organization_custom_module.custom_config.custom_output.properties.new` constructs a new object with attributes and blocks configured for the `properties`
Terraform sub block.
...
`google-beta.google_scc_organization_custom_module.custom_config.custom_output.properties.value_expression.new` constructs a new object with attributes and blocks configured for the `value_expression`
Terraform sub block.
...
`google-beta.google_scc_organization_custom_module.custom_config.predicate.new` constructs a new object with attributes and blocks configured for the `predicate`
Terraform sub block.
...
`google-beta.google_scc_organization_custom_module.custom_config.resource_selector.new` constructs a new object with attributes and blocks configured for the `resource_selector`
Terraform sub block.
...
`google-beta.google_scc_organization_custom_module.timeouts.new` constructs a new object with attributes and blocks configured for the `timeouts`
Terraform sub block.
