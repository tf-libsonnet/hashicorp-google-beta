...
`google-beta.google_compute_global_network_endpoint_group.withTimeouts` constructs a mixin object that can be merged into the `google_compute_global_network_endpoint_group`
