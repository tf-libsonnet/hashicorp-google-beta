---
permalink: /google_gke_hub_membership_binding/
---

# google_gke_hub_membership_binding

`google_gke_hub_membership_binding` represents the `google-beta_google_gke_hub_membership_binding` Terraform resource.
...
`google-beta.string.withMembershipBindingId` constructs a mixin object that can be merged into the `string`
