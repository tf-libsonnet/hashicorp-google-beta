...
`google-beta.google_bigtable_instance.withCluster` constructs a mixin object that can be merged into the `google_bigtable_instance`
...
`google-beta.google_bigtable_instance.withClusterMixin` constructs a mixin object that can be merged into the `google_bigtable_instance`
Terraform resource block to set or update the cluster field.
...
`google-beta.google_bigtable_instance.withDeletionProtection` constructs a mixin object that can be merged into the `google_bigtable_instance`
...
`google-beta.google_bigtable_instance.withDisplayName` constructs a mixin object that can be merged into the `google_bigtable_instance`
...
`google-beta.google_bigtable_instance.withInstanceType` constructs a mixin object that can be merged into the `google_bigtable_instance`
...
`google-beta.google_bigtable_instance.withLabels` constructs a mixin object that can be merged into the `google_bigtable_instance`
...
`google-beta.google_bigtable_instance.withName` constructs a mixin object that can be merged into the `google_bigtable_instance`
...
`google-beta.google_bigtable_instance.withProject` constructs a mixin object that can be merged into the `google_bigtable_instance`
