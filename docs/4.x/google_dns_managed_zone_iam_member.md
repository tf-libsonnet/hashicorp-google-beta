---
permalink: /google_dns_managed_zone_iam_member/
---

# google_dns_managed_zone_iam_member

`google_dns_managed_zone_iam_member` represents the `google-beta_google_dns_managed_zone_iam_member` Terraform resource.
