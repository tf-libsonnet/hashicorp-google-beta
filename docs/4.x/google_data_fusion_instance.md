...
`google-beta.list[obj].withCryptoKeyConfig` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withCryptoKeyConfigMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the crypto_key_config field.
...
`google-beta.string.withDataprocServiceAccount` constructs a mixin object that can be merged into the `string`
...
`google-beta.bool.withEnableRbac` constructs a mixin object that can be merged into the `bool`
...
`google-beta.bool.withEnableStackdriverMonitoring` constructs a mixin object that can be merged into the `bool`
...
`google-beta.list[obj].withEventPublishConfig` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withEventPublishConfigMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the event_publish_config field.
...
`google-beta.obj.withOptions` constructs a mixin object that can be merged into the `obj`
...
`google-beta.bool.withPrivateInstance` constructs a mixin object that can be merged into the `bool`
