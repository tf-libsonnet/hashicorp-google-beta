...
`google-beta.google_clouddeploy_target.withAnnotations` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withAnthosCluster` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withAnthosClusterMixin` constructs a mixin object that can be merged into the `google_clouddeploy_target`
Terraform resource block to set or update the anthos_cluster field.
...
`google-beta.google_clouddeploy_target.withDescription` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withExecutionConfigs` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withExecutionConfigsMixin` constructs a mixin object that can be merged into the `google_clouddeploy_target`
Terraform resource block to set or update the execution_configs field.
...
`google-beta.google_clouddeploy_target.withGke` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withGkeMixin` constructs a mixin object that can be merged into the `google_clouddeploy_target`
Terraform resource block to set or update the gke field.
...
`google-beta.google_clouddeploy_target.withLabels` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withLocation` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withName` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withProject` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withRequireApproval` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withRun` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withRunMixin` constructs a mixin object that can be merged into the `google_clouddeploy_target`
Terraform resource block to set or update the run field.
...
`google-beta.google_clouddeploy_target.withTimeouts` constructs a mixin object that can be merged into the `google_clouddeploy_target`
...
`google-beta.google_clouddeploy_target.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_clouddeploy_target`
Terraform resource block to set or update the timeouts field.
