...
`google-beta.google_dataproc_metastore_service.withHiveMetastoreConfig` constructs a mixin object that can be merged into the `google_dataproc_metastore_service`
