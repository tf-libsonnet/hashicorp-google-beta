---
permalink: /google_dataform_repository_iam_binding/
---

# google_dataform_repository_iam_binding

`google_dataform_repository_iam_binding` represents the `google-beta_google_dataform_repository_iam_binding` Terraform resource.
