---
permalink: /google_cloud_run_v2_job_iam_binding/
---

# google_cloud_run_v2_job_iam_binding

`google_cloud_run_v2_job_iam_binding` represents the `google-beta_google_cloud_run_v2_job_iam_binding` Terraform resource.
