...
`google-beta.google_compute_router.withBgp` constructs a mixin object that can be merged into the `google_compute_router`
...
`google-beta.google_compute_router.withBgpMixin` constructs a mixin object that can be merged into the `google_compute_router`
Terraform resource block to set or update the bgp field.
...
`google-beta.google_compute_router.withDescription` constructs a mixin object that can be merged into the `google_compute_router`
...
`google-beta.google_compute_router.withEncryptedInterconnectRouter` constructs a mixin object that can be merged into the `google_compute_router`
...
`google-beta.google_compute_router.withTimeouts` constructs a mixin object that can be merged into the `google_compute_router`
...
`google-beta.google_compute_router.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_router`
Terraform resource block to set or update the timeouts field.
