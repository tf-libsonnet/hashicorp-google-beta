...
`google-beta.google_dns_response_policy.withDescription` constructs a mixin object that can be merged into the `google_dns_response_policy`
...
`google-beta.google_dns_response_policy.withGkeClusters` constructs a mixin object that can be merged into the `google_dns_response_policy`
...
`google-beta.google_dns_response_policy.withGkeClustersMixin` constructs a mixin object that can be merged into the `google_dns_response_policy`
Terraform resource block to set or update the gke_clusters field.
...
`google-beta.google_dns_response_policy.withNetworks` constructs a mixin object that can be merged into the `google_dns_response_policy`
...
`google-beta.google_dns_response_policy.withNetworksMixin` constructs a mixin object that can be merged into the `google_dns_response_policy`
Terraform resource block to set or update the networks field.
...
`google-beta.google_dns_response_policy.withProject` constructs a mixin object that can be merged into the `google_dns_response_policy`
...
`google-beta.google_dns_response_policy.withResponsePolicyName` constructs a mixin object that can be merged into the `google_dns_response_policy`
...
`google-beta.google_dns_response_policy.withTimeouts` constructs a mixin object that can be merged into the `google_dns_response_policy`
...
`google-beta.google_dns_response_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_dns_response_policy`
Terraform resource block to set or update the timeouts field.
