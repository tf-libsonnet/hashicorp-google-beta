...
`google-beta.google_spanner_instance_iam_member.withCondition` constructs a mixin object that can be merged into the `google_spanner_instance_iam_member`
...
`google-beta.google_spanner_instance_iam_member.withConditionMixin` constructs a mixin object that can be merged into the `google_spanner_instance_iam_member`
Terraform resource block to set or update the condition field.
...
`google-beta.google_spanner_instance_iam_member.withInstance` constructs a mixin object that can be merged into the `google_spanner_instance_iam_member`
...
`google-beta.google_spanner_instance_iam_member.withMember` constructs a mixin object that can be merged into the `google_spanner_instance_iam_member`
...
`google-beta.google_spanner_instance_iam_member.withProject` constructs a mixin object that can be merged into the `google_spanner_instance_iam_member`
...
`google-beta.google_spanner_instance_iam_member.withRole` constructs a mixin object that can be merged into the `google_spanner_instance_iam_member`
