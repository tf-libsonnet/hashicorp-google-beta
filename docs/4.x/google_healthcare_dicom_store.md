...
`google-beta.google_healthcare_dicom_store.withDataset` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
...
`google-beta.google_healthcare_dicom_store.withLabels` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
...
`google-beta.google_healthcare_dicom_store.withName` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
...
`google-beta.google_healthcare_dicom_store.withNotificationConfig` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
...
`google-beta.google_healthcare_dicom_store.withNotificationConfigMixin` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
Terraform resource block to set or update the notification_config field.
...
`google-beta.google_healthcare_dicom_store.withStreamConfigs` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
...
`google-beta.google_healthcare_dicom_store.withStreamConfigsMixin` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
Terraform resource block to set or update the stream_configs field.
...
`google-beta.google_healthcare_dicom_store.withTimeouts` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
...
`google-beta.google_healthcare_dicom_store.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_healthcare_dicom_store`
Terraform resource block to set or update the timeouts field.
