---
permalink: /google_workstations_workstation_iam_member/
---

# google_workstations_workstation_iam_member

`google_workstations_workstation_iam_member` represents the `google-beta_google_workstations_workstation_iam_member` Terraform resource.
