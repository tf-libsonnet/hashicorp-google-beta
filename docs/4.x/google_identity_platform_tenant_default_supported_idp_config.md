...
Unlike [google-beta.google_identity_platform_tenant_default_supported_idp_config.new](#fn-google_identity_platform_tenant_default_supported_idp_confignew), this function will not inject the `resource`
