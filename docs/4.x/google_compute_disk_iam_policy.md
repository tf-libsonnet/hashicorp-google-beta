...
`google-beta.google_compute_disk_iam_policy.withName` constructs a mixin object that can be merged into the `google_compute_disk_iam_policy`
...
`google-beta.google_compute_disk_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `google_compute_disk_iam_policy`
...
`google-beta.google_compute_disk_iam_policy.withProject` constructs a mixin object that can be merged into the `google_compute_disk_iam_policy`
...
`google-beta.google_compute_disk_iam_policy.withZone` constructs a mixin object that can be merged into the `google_compute_disk_iam_policy`
