---
permalink: /google_pubsub_schema_iam_binding/
---

# google_pubsub_schema_iam_binding

`google_pubsub_schema_iam_binding` represents the `google-beta_google_pubsub_schema_iam_binding` Terraform resource.
