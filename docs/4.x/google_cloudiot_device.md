...
`google-beta.google_cloudiot_device.withBlocked` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withCredentials` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withCredentialsMixin` constructs a mixin object that can be merged into the `google_cloudiot_device`
Terraform resource block to set or update the credentials field.
...
`google-beta.google_cloudiot_device.withGatewayConfig` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withGatewayConfigMixin` constructs a mixin object that can be merged into the `google_cloudiot_device`
Terraform resource block to set or update the gateway_config field.
...
`google-beta.google_cloudiot_device.withLogLevel` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withMetadata` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withName` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withRegistry` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withTimeouts` constructs a mixin object that can be merged into the `google_cloudiot_device`
...
`google-beta.google_cloudiot_device.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_cloudiot_device`
Terraform resource block to set or update the timeouts field.
