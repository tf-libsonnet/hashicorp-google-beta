---
permalink: /google_dataplex_lake_iam_binding/
---

# google_dataplex_lake_iam_binding

`google_dataplex_lake_iam_binding` represents the `google-beta_google_dataplex_lake_iam_binding` Terraform resource.
