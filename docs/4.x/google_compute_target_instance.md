...
`google-beta.google_compute_target_instance.withDescription` constructs a mixin object that can be merged into the `google_compute_target_instance`
...
`google-beta.google_compute_target_instance.withInstance` constructs a mixin object that can be merged into the `google_compute_target_instance`
...
`google-beta.google_compute_target_instance.withName` constructs a mixin object that can be merged into the `google_compute_target_instance`
...
`google-beta.google_compute_target_instance.withNatPolicy` constructs a mixin object that can be merged into the `google_compute_target_instance`
...
`google-beta.google_compute_target_instance.withNetwork` constructs a mixin object that can be merged into the `google_compute_target_instance`
...
`google-beta.google_compute_target_instance.withProject` constructs a mixin object that can be merged into the `google_compute_target_instance`
...
`google-beta.google_compute_target_instance.withTimeouts` constructs a mixin object that can be merged into the `google_compute_target_instance`
...
`google-beta.google_compute_target_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_target_instance`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_compute_target_instance.withZone` constructs a mixin object that can be merged into the `google_compute_target_instance`
