---
permalink: /google_gke_hub_scope_iam_binding/
---

# google_gke_hub_scope_iam_binding

`google_gke_hub_scope_iam_binding` represents the `google-beta_google_gke_hub_scope_iam_binding` Terraform resource.
