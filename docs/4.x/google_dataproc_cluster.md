...
`google-beta.google_dataproc_cluster.withClusterConfig` constructs a mixin object that can be merged into the `google_dataproc_cluster`
...
`google-beta.google_dataproc_cluster.withClusterConfigMixin` constructs a mixin object that can be merged into the `google_dataproc_cluster`
Terraform resource block to set or update the cluster_config field.
...
`google-beta.google_dataproc_cluster.withGracefulDecommissionTimeout` constructs a mixin object that can be merged into the `google_dataproc_cluster`
...
`google-beta.google_dataproc_cluster.withLabels` constructs a mixin object that can be merged into the `google_dataproc_cluster`
...
`google-beta.google_dataproc_cluster.withName` constructs a mixin object that can be merged into the `google_dataproc_cluster`
...
`google-beta.google_dataproc_cluster.withProject` constructs a mixin object that can be merged into the `google_dataproc_cluster`
...
`google-beta.google_dataproc_cluster.withRegion` constructs a mixin object that can be merged into the `google_dataproc_cluster`
...
`google-beta.google_dataproc_cluster.withTimeouts` constructs a mixin object that can be merged into the `google_dataproc_cluster`
...
`google-beta.google_dataproc_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_dataproc_cluster`
Terraform resource block to set or update the timeouts field.
