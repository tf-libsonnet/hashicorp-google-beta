...
`google-beta.google_kms_crypto_key.withDestroyScheduledDuration` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withImportOnly` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withLabels` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withPurpose` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withRotationPeriod` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withSkipInitialVersionCreation` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withTimeouts` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_kms_crypto_key`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_kms_crypto_key.withVersionTemplate` constructs a mixin object that can be merged into the `google_kms_crypto_key`
...
`google-beta.google_kms_crypto_key.withVersionTemplateMixin` constructs a mixin object that can be merged into the `google_kms_crypto_key`
Terraform resource block to set or update the version_template field.
