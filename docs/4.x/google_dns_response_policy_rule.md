...
`google-beta.string.withBehavior` constructs a mixin object that can be merged into the `string`
...
`google-beta.list[obj].withLocalData` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withLocalDataMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the local_data field.
...
`google-beta.string.withResponsePolicy` constructs a mixin object that can be merged into the `string`
