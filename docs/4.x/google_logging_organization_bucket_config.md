...
`google-beta.google_logging_organization_bucket_config.withRetentionDays` constructs a mixin object that can be merged into the `google_logging_organization_bucket_config`
