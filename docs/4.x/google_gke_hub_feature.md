...
`google-beta.google_gke_hub_feature.withLabels` constructs a mixin object that can be merged into the `google_gke_hub_feature`
...
`google-beta.google_gke_hub_feature.withLocation` constructs a mixin object that can be merged into the `google_gke_hub_feature`
...
`google-beta.google_gke_hub_feature.withName` constructs a mixin object that can be merged into the `google_gke_hub_feature`
...
`google-beta.google_gke_hub_feature.withProject` constructs a mixin object that can be merged into the `google_gke_hub_feature`
...
`google-beta.google_gke_hub_feature.withSpec` constructs a mixin object that can be merged into the `google_gke_hub_feature`
...
`google-beta.google_gke_hub_feature.withSpecMixin` constructs a mixin object that can be merged into the `google_gke_hub_feature`
Terraform resource block to set or update the spec field.
...
`google-beta.google_gke_hub_feature.withTimeouts` constructs a mixin object that can be merged into the `google_gke_hub_feature`
...
`google-beta.google_gke_hub_feature.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_gke_hub_feature`
Terraform resource block to set or update the timeouts field.
