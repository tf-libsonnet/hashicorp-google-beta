---
permalink: /google_vertex_ai_endpoint/
---

# google_vertex_ai_endpoint

`google_vertex_ai_endpoint` represents the `google-beta_google_vertex_ai_endpoint` Terraform resource.
...
`google-beta.google_vertex_ai_endpoint.withDescription` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withDisplayName` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withEncryptionSpec` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withEncryptionSpecMixin` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
Terraform resource block to set or update the encryption_spec field.
...
`google-beta.google_vertex_ai_endpoint.withLabels` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withLocation` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withName` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withNetwork` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withProject` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withTimeouts` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
...
`google-beta.google_vertex_ai_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_vertex_ai_endpoint`
Terraform resource block to set or update the timeouts field.
