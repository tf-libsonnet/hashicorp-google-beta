...
`google-beta.list.withAccessLevels` constructs a mixin object that can be merged into the `list`
...
`google-beta.string.withGroupKey` constructs a mixin object that can be merged into the `string`
