...
`google-beta.google_access_context_manager_gcp_user_access_binding.withTimeouts` constructs a mixin object that can be merged into the `google_access_context_manager_gcp_user_access_binding`
