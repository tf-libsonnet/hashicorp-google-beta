---
permalink: /google_pubsub_schema_iam_member/
---

# google_pubsub_schema_iam_member

`google_pubsub_schema_iam_member` represents the `google-beta_google_pubsub_schema_iam_member` Terraform resource.
