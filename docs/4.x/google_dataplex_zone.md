...
`google-beta.google_dataplex_zone.withDescription` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withDiscoverySpec` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withDiscoverySpecMixin` constructs a mixin object that can be merged into the `google_dataplex_zone`
Terraform resource block to set or update the discovery_spec field.
...
`google-beta.google_dataplex_zone.withDisplayName` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withLabels` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withLake` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withLocation` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withName` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withProject` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withResourceSpec` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withResourceSpecMixin` constructs a mixin object that can be merged into the `google_dataplex_zone`
Terraform resource block to set or update the resource_spec field.
...
`google-beta.google_dataplex_zone.withTimeouts` constructs a mixin object that can be merged into the `google_dataplex_zone`
...
`google-beta.google_dataplex_zone.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_dataplex_zone`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_dataplex_zone.withType` constructs a mixin object that can be merged into the `google_dataplex_zone`
