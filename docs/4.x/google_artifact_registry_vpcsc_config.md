---
permalink: /google_artifact_registry_vpcsc_config/
---

# google_artifact_registry_vpcsc_config

`google_artifact_registry_vpcsc_config` represents the `google-beta_google_artifact_registry_vpcsc_config` Terraform resource.
...
* [`fn withVpcscPolicy()`](#fn-withvpcscpolicy)
...
`google-beta.string.withVpcscPolicy` constructs a mixin object that can be merged into the `string`
