...
`google-beta.google_compute_external_vpn_gateway.withDescription` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
...
`google-beta.google_compute_external_vpn_gateway.withInterface` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
...
`google-beta.google_compute_external_vpn_gateway.withInterfaceMixin` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
Terraform resource block to set or update the interface field.
...
`google-beta.google_compute_external_vpn_gateway.withName` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
...
`google-beta.google_compute_external_vpn_gateway.withProject` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
...
`google-beta.google_compute_external_vpn_gateway.withRedundancyType` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
...
`google-beta.google_compute_external_vpn_gateway.withTimeouts` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
...
`google-beta.google_compute_external_vpn_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_external_vpn_gateway`
Terraform resource block to set or update the timeouts field.
