...
`google-beta.string.withOrigin` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withReason` constructs a mixin object that can be merged into the `string`
...
`google-beta.list.withRestrictions` constructs a mixin object that can be merged into the `list`
