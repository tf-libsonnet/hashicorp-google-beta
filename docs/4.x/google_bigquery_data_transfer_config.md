...
`google-beta.number.withDataRefreshWindowDays` constructs a mixin object that can be merged into the `number`
...
`google-beta.string.withDataSourceId` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withDestinationDatasetId` constructs a mixin object that can be merged into the `string`
...
`google-beta.list[obj].withEmailPreferences` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withEmailPreferencesMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the email_preferences field.
...
`google-beta.string.withNotificationPubsubTopic` constructs a mixin object that can be merged into the `string`
...
`google-beta.obj.withParams` constructs a mixin object that can be merged into the `obj`
...
`google-beta.list[obj].withScheduleOptions` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withScheduleOptionsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the schedule_options field.
...
`google-beta.list[obj].withSensitiveParams` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withSensitiveParamsMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the sensitive_params field.
...
`google-beta.string.withServiceAccountName` constructs a mixin object that can be merged into the `string`
