...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_compute_project_metadata.timeouts.new](#fn-google_compute_project_metadatatimeoutsnew) constructor.
...
Unlike [google-beta.google_compute_project_metadata.new](#fn-google_compute_project_metadatanew), this function will not inject the `resource`
