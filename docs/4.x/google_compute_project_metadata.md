---
permalink: /google_compute_project_metadata/
---

# google_compute_project_metadata

`google_compute_project_metadata` represents the `google-beta_google_compute_project_metadata` Terraform resource.
...
`google-beta.google_compute_project_metadata.withMetadata` constructs a mixin object that can be merged into the `google_compute_project_metadata`
...
`google-beta.google_compute_project_metadata.withProject` constructs a mixin object that can be merged into the `google_compute_project_metadata`
...
`google-beta.google_compute_project_metadata.withTimeouts` constructs a mixin object that can be merged into the `google_compute_project_metadata`
...
`google-beta.google_compute_project_metadata.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_project_metadata`
Terraform resource block to set or update the timeouts field.

This function will merge the passed in value to the existing map. If you wish
to instead replace the entire map with the passed in `value`, use the [google-beta.google_compute_project_metadata.withTimeouts](TODO)
function.
