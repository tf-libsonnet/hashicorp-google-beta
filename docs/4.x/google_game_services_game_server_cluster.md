...
`google-beta.list[obj].withConnectionInfo` constructs a mixin object that can be merged into the `list[obj]`
...
`google-beta.list[obj].withConnectionInfoMixin` constructs a mixin object that can be merged into the `list[obj]`
Terraform resource block to set or update the connection_info field.
...
`google-beta.string.withRealmId` constructs a mixin object that can be merged into the `string`
