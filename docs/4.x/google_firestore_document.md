...
`google-beta.google_firestore_document.withCollection` constructs a mixin object that can be merged into the `google_firestore_document`
...
`google-beta.google_firestore_document.withDatabase` constructs a mixin object that can be merged into the `google_firestore_document`
...
`google-beta.google_firestore_document.withDocumentId` constructs a mixin object that can be merged into the `google_firestore_document`
...
`google-beta.google_firestore_document.withFields` constructs a mixin object that can be merged into the `google_firestore_document`
...
`google-beta.google_firestore_document.withProject` constructs a mixin object that can be merged into the `google_firestore_document`
...
`google-beta.google_firestore_document.withTimeouts` constructs a mixin object that can be merged into the `google_firestore_document`
...
`google-beta.google_firestore_document.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_firestore_document`
Terraform resource block to set or update the timeouts field.
