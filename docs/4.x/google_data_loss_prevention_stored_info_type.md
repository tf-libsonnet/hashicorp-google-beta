...
`google-beta.google_data_loss_prevention_stored_info_type.withDescription` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
...
`google-beta.google_data_loss_prevention_stored_info_type.withDictionary` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
...
`google-beta.google_data_loss_prevention_stored_info_type.withDictionaryMixin` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
Terraform resource block to set or update the dictionary field.
...
`google-beta.google_data_loss_prevention_stored_info_type.withDisplayName` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
...
`google-beta.google_data_loss_prevention_stored_info_type.withLargeCustomDictionary` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
...
`google-beta.google_data_loss_prevention_stored_info_type.withLargeCustomDictionaryMixin` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
Terraform resource block to set or update the large_custom_dictionary field.
...
`google-beta.google_data_loss_prevention_stored_info_type.withParent` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
...
`google-beta.google_data_loss_prevention_stored_info_type.withRegex` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
...
`google-beta.google_data_loss_prevention_stored_info_type.withRegexMixin` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
Terraform resource block to set or update the regex field.
...
`google-beta.google_data_loss_prevention_stored_info_type.withTimeouts` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
...
`google-beta.google_data_loss_prevention_stored_info_type.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_data_loss_prevention_stored_info_type`
Terraform resource block to set or update the timeouts field.
