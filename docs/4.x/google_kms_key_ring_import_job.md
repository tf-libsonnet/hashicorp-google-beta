...
`google-beta.string.withImportJobId` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withImportMethod` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withProtectionLevel` constructs a mixin object that can be merged into the `string`
