---
permalink: /google_dataplex_asset_iam_binding/
---

# google_dataplex_asset_iam_binding

`google_dataplex_asset_iam_binding` represents the `google-beta_google_dataplex_asset_iam_binding` Terraform resource.
