...
`google-beta.bool.withDisableDependentServices` constructs a mixin object that can be merged into the `bool`
...
`google-beta.bool.withDisableOnDestroy` constructs a mixin object that can be merged into the `bool`
