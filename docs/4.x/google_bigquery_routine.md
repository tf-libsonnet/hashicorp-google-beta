...
`google-beta.google_bigquery_routine.withArguments` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withArgumentsMixin` constructs a mixin object that can be merged into the `google_bigquery_routine`
Terraform resource block to set or update the arguments field.
...
`google-beta.google_bigquery_routine.withDatasetId` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withDefinitionBody` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withDescription` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withDeterminismLevel` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withImportedLibraries` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withLanguage` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withProject` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withReturnTableType` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withReturnType` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withRoutineId` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withRoutineType` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withTimeouts` constructs a mixin object that can be merged into the `google_bigquery_routine`
...
`google-beta.google_bigquery_routine.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_bigquery_routine`
Terraform resource block to set or update the timeouts field.
