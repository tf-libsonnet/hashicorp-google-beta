---
permalink: /google_gke_backup_backup_plan_iam_binding/
---

# google_gke_backup_backup_plan_iam_binding

`google_gke_backup_backup_plan_iam_binding` represents the `google-beta_google_gke_backup_backup_plan_iam_binding` Terraform resource.
