...
`google-beta.bool.withAdminEnabled` constructs a mixin object that can be merged into the `bool`
...
`google-beta.string.withBandwidth` constructs a mixin object that can be merged into the `string`
...
`google-beta.list.withCandidateSubnets` constructs a mixin object that can be merged into the `list`
...
`google-beta.string.withEdgeAvailabilityDomain` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withEncryption` constructs a mixin object that can be merged into the `string`
...
`google-beta.string.withInterconnect` constructs a mixin object that can be merged into the `string`
...
`google-beta.list.withIpsecInternalAddresses` constructs a mixin object that can be merged into the `list`
...
`google-beta.string.withMtu` constructs a mixin object that can be merged into the `string`
...
`google-beta.number.withVlanTag8021Q` constructs a mixin object that can be merged into the `number`
