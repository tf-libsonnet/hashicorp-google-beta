...
`google-beta.google_cloudfunctions2_function_iam_policy.withCloudFunction` constructs a mixin object that can be merged into the `google_cloudfunctions2_function_iam_policy`
...
`google-beta.google_cloudfunctions2_function_iam_policy.withLocation` constructs a mixin object that can be merged into the `google_cloudfunctions2_function_iam_policy`
...
`google-beta.google_cloudfunctions2_function_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `google_cloudfunctions2_function_iam_policy`
...
`google-beta.google_cloudfunctions2_function_iam_policy.withProject` constructs a mixin object that can be merged into the `google_cloudfunctions2_function_iam_policy`
