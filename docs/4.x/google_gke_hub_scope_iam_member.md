---
permalink: /google_gke_hub_scope_iam_member/
---

# google_gke_hub_scope_iam_member

`google_gke_hub_scope_iam_member` represents the `google-beta_google_gke_hub_scope_iam_member` Terraform resource.
