---
permalink: /google_iap_web_region_backend_service_iam_binding/
---

# google_iap_web_region_backend_service_iam_binding

`google_iap_web_region_backend_service_iam_binding` represents the `google-beta_google_iap_web_region_backend_service_iam_binding` Terraform resource.
