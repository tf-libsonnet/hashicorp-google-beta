---
permalink: /google_dns_managed_zone_iam_binding/
---

# google_dns_managed_zone_iam_binding

`google_dns_managed_zone_iam_binding` represents the `google-beta_google_dns_managed_zone_iam_binding` Terraform resource.
