---
permalink: /google_dataplex_task_iam_policy/
---

# google_dataplex_task_iam_policy

`google_dataplex_task_iam_policy` represents the `google-beta_google_dataplex_task_iam_policy` Terraform resource.
