...
`google-beta.google_iam_deny_policy.withDisplayName` constructs a mixin object that can be merged into the `google_iam_deny_policy`
...
`google-beta.google_iam_deny_policy.withName` constructs a mixin object that can be merged into the `google_iam_deny_policy`
...
`google-beta.google_iam_deny_policy.withParent` constructs a mixin object that can be merged into the `google_iam_deny_policy`
...
`google-beta.google_iam_deny_policy.withRules` constructs a mixin object that can be merged into the `google_iam_deny_policy`
...
`google-beta.google_iam_deny_policy.withRulesMixin` constructs a mixin object that can be merged into the `google_iam_deny_policy`
Terraform resource block to set or update the rules field.
...
`google-beta.google_iam_deny_policy.withTimeouts` constructs a mixin object that can be merged into the `google_iam_deny_policy`
...
`google-beta.google_iam_deny_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_iam_deny_policy`
Terraform resource block to set or update the timeouts field.
