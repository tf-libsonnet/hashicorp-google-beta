...
`google-beta.google_cloudbuild_worker_pool.withAnnotations` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withDisplayName` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withLocation` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withName` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withNetworkConfig` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withNetworkConfigMixin` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
Terraform resource block to set or update the network_config field.
...
`google-beta.google_cloudbuild_worker_pool.withProject` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withTimeouts` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_cloudbuild_worker_pool.withWorkerConfig` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
...
`google-beta.google_cloudbuild_worker_pool.withWorkerConfigMixin` constructs a mixin object that can be merged into the `google_cloudbuild_worker_pool`
Terraform resource block to set or update the worker_config field.
