...
`google-beta.google_privateca_certificate_authority.withConfig` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withConfigMixin` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
Terraform resource block to set or update the config field.
...
`google-beta.google_privateca_certificate_authority.withDeletionProtection` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withDesiredState` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withGcsBucket` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withIgnoreActiveCertificatesOnDeletion` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withKeySpec` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withKeySpecMixin` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
Terraform resource block to set or update the key_spec field.
...
`google-beta.google_privateca_certificate_authority.withLabels` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withLifetime` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withPemCaCertificate` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withSkipGracePeriod` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withSubordinateConfig` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withSubordinateConfigMixin` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
Terraform resource block to set or update the subordinate_config field.
...
`google-beta.google_privateca_certificate_authority.withTimeouts` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
...
`google-beta.google_privateca_certificate_authority.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_privateca_certificate_authority.withType` constructs a mixin object that can be merged into the `google_privateca_certificate_authority`
