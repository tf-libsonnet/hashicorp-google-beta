---
permalink: /google_gke_hub_feature_iam_binding/
---

# google_gke_hub_feature_iam_binding

`google_gke_hub_feature_iam_binding` represents the `google-beta_google_gke_hub_feature_iam_binding` Terraform resource.
