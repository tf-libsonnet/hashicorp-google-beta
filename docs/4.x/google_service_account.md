...
`google-beta.string.withAccountId` constructs a mixin object that can be merged into the `string`
...
`google-beta.bool.withCreateIgnoreAlreadyExists` constructs a mixin object that can be merged into the `bool`
