...
`google-beta.google_dns_record_set.withRoutingPolicy` constructs a mixin object that can be merged into the `google_dns_record_set`
...
`google-beta.google_dns_record_set.withRoutingPolicyMixin` constructs a mixin object that can be merged into the `google_dns_record_set`
Terraform resource block to set or update the routing_policy field.
...
`google-beta.google_dns_record_set.withRrdatas` constructs a mixin object that can be merged into the `google_dns_record_set`
...
`google-beta.google_dns_record_set.withTtl` constructs a mixin object that can be merged into the `google_dns_record_set`
