...
`google-beta.google_compute_instance_from_machine_image.withAdvancedMachineFeatures` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withAdvancedMachineFeaturesMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the advanced_machine_features field.
...
`google-beta.google_compute_instance_from_machine_image.withAllowStoppingForUpdate` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withCanIpForward` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withConfidentialInstanceConfig` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withConfidentialInstanceConfigMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the confidential_instance_config field.
...
`google-beta.google_compute_instance_from_machine_image.withDeletionProtection` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withDescription` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withDesiredStatus` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withEnableDisplay` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withGuestAccelerator` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withHostname` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withLabels` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withMachineType` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withMetadata` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withMetadataStartupScript` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withMinCpuPlatform` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withName` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withNetworkInterface` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withNetworkInterfaceMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the network_interface field.
...
`google-beta.google_compute_instance_from_machine_image.withNetworkPerformanceConfig` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withNetworkPerformanceConfigMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the network_performance_config field.
...
`google-beta.google_compute_instance_from_machine_image.withProject` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withReservationAffinity` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withReservationAffinityMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the reservation_affinity field.
...
`google-beta.google_compute_instance_from_machine_image.withResourcePolicies` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withScheduling` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withSchedulingMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the scheduling field.
...
`google-beta.google_compute_instance_from_machine_image.withServiceAccount` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withShieldedInstanceConfig` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withShieldedInstanceConfigMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the shielded_instance_config field.
...
`google-beta.google_compute_instance_from_machine_image.withSourceMachineImage` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withTags` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withTimeouts` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
...
`google-beta.google_compute_instance_from_machine_image.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_compute_instance_from_machine_image.withZone` constructs a mixin object that can be merged into the `google_compute_instance_from_machine_image`
