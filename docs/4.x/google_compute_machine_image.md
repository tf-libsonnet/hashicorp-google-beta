...
`google-beta.google_compute_machine_image.withDescription` constructs a mixin object that can be merged into the `google_compute_machine_image`
...
`google-beta.google_compute_machine_image.withGuestFlush` constructs a mixin object that can be merged into the `google_compute_machine_image`
...
`google-beta.google_compute_machine_image.withMachineImageEncryptionKey` constructs a mixin object that can be merged into the `google_compute_machine_image`
...
`google-beta.google_compute_machine_image.withMachineImageEncryptionKeyMixin` constructs a mixin object that can be merged into the `google_compute_machine_image`
Terraform resource block to set or update the machine_image_encryption_key field.
...
`google-beta.google_compute_machine_image.withName` constructs a mixin object that can be merged into the `google_compute_machine_image`
...
`google-beta.google_compute_machine_image.withProject` constructs a mixin object that can be merged into the `google_compute_machine_image`
...
`google-beta.google_compute_machine_image.withSourceInstance` constructs a mixin object that can be merged into the `google_compute_machine_image`
...
`google-beta.google_compute_machine_image.withTimeouts` constructs a mixin object that can be merged into the `google_compute_machine_image`
...
`google-beta.google_compute_machine_image.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_machine_image`
Terraform resource block to set or update the timeouts field.
