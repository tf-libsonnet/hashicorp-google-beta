...
Unlike [google-beta.google_api_gateway_api_config.new](#fn-googleapigatewayapiconfignew), this function will not inject the `resource`
...
`google-beta.google_api_gateway_api_config.withApi` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
`google-beta.google_api_gateway_api_config.withApiConfigId` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `api_config_id` field.
...
`google-beta.google_api_gateway_api_config.withApiConfigIdPrefix` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `api_config_id_prefix` field.
...
`google-beta.google_api_gateway_api_config.withDisplayName` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
`google-beta.google_api_gateway_api_config.withGatewayConfig` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `gateway_config` field.
...
`google-beta.google_api_gateway_api_config.withGatewayConfigMixin` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
Terraform resource block to set or update the gateway_config field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [google-beta.google_api_gateway_api_config.withGatewayConfig](TODO)
function.
...
`google-beta.google_api_gateway_api_config.withGrpcServices` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `grpc_services` field.
...
`google-beta.google_api_gateway_api_config.withGrpcServicesMixin` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
Terraform resource block to set or update the grpc_services field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [google-beta.google_api_gateway_api_config.withGrpcServices](TODO)
function.
...
`google-beta.google_api_gateway_api_config.withLabels` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
`google-beta.google_api_gateway_api_config.withManagedServiceConfigs` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `managed_service_configs` field.
...
`google-beta.google_api_gateway_api_config.withManagedServiceConfigsMixin` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
Terraform resource block to set or update the managed_service_configs field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [google-beta.google_api_gateway_api_config.withManagedServiceConfigs](TODO)
function.
...
`google-beta.google_api_gateway_api_config.withOpenapiDocuments` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
**Args**:
  - `resourceLabel` (`string`): The name label of the block to update.
  - `value` (`TODO`): The value to set for the `openapi_documents` field.
...
`google-beta.google_api_gateway_api_config.withOpenapiDocumentsMixin` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
Terraform resource block to set or update the openapi_documents field.

This function will append the passed in array or object to the existing array. If you wish
to instead replace the array with the passed in `value`, use the [google-beta.google_api_gateway_api_config.withOpenapiDocuments](TODO)
function.
...
`google-beta.google_api_gateway_api_config.withProject` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
`google-beta.google_api_gateway_api_config.withTimeouts` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
...
`google-beta.google_api_gateway_api_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_api_gateway_api_config`
Terraform resource block to set or update the timeouts field.

This function will merge the passed in value to the existing map. If you wish
to instead replace the entire map with the passed in `value`, use the [google-beta.google_api_gateway_api_config.withTimeouts](TODO)
function.
