...
`google-beta.google_os_config_guest_policies.withAssignment` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withAssignmentMixin` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
Terraform resource block to set or update the assignment field.
...
`google-beta.google_os_config_guest_policies.withDescription` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withEtag` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withGuestPolicyId` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withPackageRepositories` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withPackageRepositoriesMixin` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
Terraform resource block to set or update the package_repositories field.
...
`google-beta.google_os_config_guest_policies.withPackages` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withPackagesMixin` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
Terraform resource block to set or update the packages field.
...
`google-beta.google_os_config_guest_policies.withProject` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withRecipes` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withRecipesMixin` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
Terraform resource block to set or update the recipes field.
...
`google-beta.google_os_config_guest_policies.withTimeouts` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
...
`google-beta.google_os_config_guest_policies.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_os_config_guest_policies`
Terraform resource block to set or update the timeouts field.
