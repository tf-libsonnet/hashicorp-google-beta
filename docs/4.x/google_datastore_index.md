...
`google-beta.google_datastore_index.withAncestor` constructs a mixin object that can be merged into the `google_datastore_index`
...
`google-beta.google_datastore_index.withKind` constructs a mixin object that can be merged into the `google_datastore_index`
...
`google-beta.google_datastore_index.withProject` constructs a mixin object that can be merged into the `google_datastore_index`
...
`google-beta.google_datastore_index.withProperties` constructs a mixin object that can be merged into the `google_datastore_index`
...
`google-beta.google_datastore_index.withPropertiesMixin` constructs a mixin object that can be merged into the `google_datastore_index`
Terraform resource block to set or update the properties field.
...
`google-beta.google_datastore_index.withTimeouts` constructs a mixin object that can be merged into the `google_datastore_index`
...
`google-beta.google_datastore_index.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_datastore_index`
Terraform resource block to set or update the timeouts field.
