...
`google-beta.google_compute_disk.withDescription` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withDiskEncryptionKey` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withDiskEncryptionKeyMixin` constructs a mixin object that can be merged into the `google_compute_disk`
Terraform resource block to set or update the disk_encryption_key field.
...
`google-beta.google_compute_disk.withImage` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withInterface` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withLabels` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withMultiWriter` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withName` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withPhysicalBlockSizeBytes` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withProject` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withProvisionedIops` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withResourcePolicies` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withSize` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withSnapshot` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withSourceDisk` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withSourceImageEncryptionKey` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withSourceImageEncryptionKeyMixin` constructs a mixin object that can be merged into the `google_compute_disk`
Terraform resource block to set or update the source_image_encryption_key field.
...
`google-beta.google_compute_disk.withSourceSnapshotEncryptionKey` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withSourceSnapshotEncryptionKeyMixin` constructs a mixin object that can be merged into the `google_compute_disk`
Terraform resource block to set or update the source_snapshot_encryption_key field.
...
`google-beta.google_compute_disk.withTimeouts` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_disk`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_compute_disk.withType` constructs a mixin object that can be merged into the `google_compute_disk`
...
`google-beta.google_compute_disk.withZone` constructs a mixin object that can be merged into the `google_compute_disk`
