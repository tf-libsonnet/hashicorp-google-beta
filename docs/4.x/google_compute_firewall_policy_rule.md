---
permalink: /google_compute_firewall_policy_rule/
---

# google_compute_firewall_policy_rule

`google_compute_firewall_policy_rule` represents the `google-beta_google_compute_firewall_policy_rule` Terraform resource.
...
`google-beta.google_compute_firewall_policy_rule.withAction` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withDescription` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withDirection` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withDisabled` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withEnableLogging` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withFirewallPolicy` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withMatch` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withMatchMixin` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
Terraform resource block to set or update the match field.
...
`google-beta.google_compute_firewall_policy_rule.withPriority` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withTargetResources` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withTargetServiceAccounts` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withTimeouts` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
...
`google-beta.google_compute_firewall_policy_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_firewall_policy_rule`
Terraform resource block to set or update the timeouts field.
