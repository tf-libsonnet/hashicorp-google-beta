...
`google-beta.google_compute_region_ssl_certificate.withPrivateKey` constructs a mixin object that can be merged into the `google_compute_region_ssl_certificate`
