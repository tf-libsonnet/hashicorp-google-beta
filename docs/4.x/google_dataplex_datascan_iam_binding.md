---
permalink: /google_dataplex_datascan_iam_binding/
---

# google_dataplex_datascan_iam_binding

`google_dataplex_datascan_iam_binding` represents the `google-beta_google_dataplex_datascan_iam_binding` Terraform resource.
