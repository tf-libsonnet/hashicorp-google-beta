...
`google-beta.google_game_services_game_server_deployment.withLocation` constructs a mixin object that can be merged into the `google_game_services_game_server_deployment`
