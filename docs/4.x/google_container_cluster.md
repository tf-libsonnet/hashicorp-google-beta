...
`google-beta.google_container_cluster.withAddonsConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withAddonsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the addons_config field.
...
`google-beta.google_container_cluster.withAuthenticatorGroupsConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withAuthenticatorGroupsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the authenticator_groups_config field.
...
`google-beta.google_container_cluster.withBinaryAuthorization` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withBinaryAuthorizationMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the binary_authorization field.
...
`google-beta.google_container_cluster.withClusterAutoscaling` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withClusterAutoscalingMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the cluster_autoscaling field.
...
`google-beta.google_container_cluster.withClusterIpv4Cidr` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withClusterTelemetry` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withClusterTelemetryMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the cluster_telemetry field.
...
`google-beta.google_container_cluster.withConfidentialNodes` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withConfidentialNodesMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the confidential_nodes field.
...
`google-beta.google_container_cluster.withCostManagementConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withCostManagementConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the cost_management_config field.
...
`google-beta.google_container_cluster.withDatabaseEncryption` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withDatabaseEncryptionMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the database_encryption field.
...
`google-beta.google_container_cluster.withDatapathProvider` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withDefaultMaxPodsPerNode` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withDefaultSnatStatus` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withDefaultSnatStatusMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the default_snat_status field.
...
`google-beta.google_container_cluster.withDescription` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withDnsConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withDnsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the dns_config field.
...
`google-beta.google_container_cluster.withEnableAutopilot` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withEnableBinaryAuthorization` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withEnableIntranodeVisibility` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withEnableKubernetesAlpha` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withEnableL4IlbSubsetting` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withEnableLegacyAbac` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withEnableShieldedNodes` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withEnableTpu` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withIdentityServiceConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withIdentityServiceConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the identity_service_config field.
...
`google-beta.google_container_cluster.withInitialNodeCount` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withIpAllocationPolicy` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withIpAllocationPolicyMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the ip_allocation_policy field.
...
`google-beta.google_container_cluster.withLocation` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withLoggingConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withLoggingConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the logging_config field.
...
`google-beta.google_container_cluster.withLoggingService` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withMaintenancePolicy` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withMaintenancePolicyMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the maintenance_policy field.
...
`google-beta.google_container_cluster.withMasterAuth` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withMasterAuthMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the master_auth field.
...
`google-beta.google_container_cluster.withMasterAuthorizedNetworksConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withMasterAuthorizedNetworksConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the master_authorized_networks_config field.
...
`google-beta.google_container_cluster.withMeshCertificates` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withMeshCertificatesMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the mesh_certificates field.
...
`google-beta.google_container_cluster.withMinMasterVersion` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withMonitoringConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withMonitoringConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the monitoring_config field.
...
`google-beta.google_container_cluster.withMonitoringService` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withName` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNetwork` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNetworkPolicy` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNetworkPolicyMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the network_policy field.
...
`google-beta.google_container_cluster.withNetworkingMode` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNodeConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNodeConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the node_config field.
...
`google-beta.google_container_cluster.withNodeLocations` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNodePool` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNodePoolAutoConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNodePoolAutoConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the node_pool_auto_config field.
...
`google-beta.google_container_cluster.withNodePoolDefaults` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNodePoolDefaultsMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the node_pool_defaults field.
...
`google-beta.google_container_cluster.withNodePoolMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the node_pool field.
...
`google-beta.google_container_cluster.withNodeVersion` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNotificationConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withNotificationConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the notification_config field.
...
`google-beta.google_container_cluster.withPodSecurityPolicyConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withPodSecurityPolicyConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the pod_security_policy_config field.
...
`google-beta.google_container_cluster.withPrivateClusterConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withPrivateClusterConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the private_cluster_config field.
...
`google-beta.google_container_cluster.withPrivateIpv6GoogleAccess` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withProject` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withReleaseChannel` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withReleaseChannelMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the release_channel field.
...
`google-beta.google_container_cluster.withRemoveDefaultNodePool` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withResourceLabels` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withResourceUsageExportConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withResourceUsageExportConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the resource_usage_export_config field.
...
`google-beta.google_container_cluster.withServiceExternalIpsConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withServiceExternalIpsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the service_external_ips_config field.
...
`google-beta.google_container_cluster.withSubnetwork` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withTimeouts` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_container_cluster.withTpuConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withTpuConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the tpu_config field.
...
`google-beta.google_container_cluster.withVerticalPodAutoscaling` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withVerticalPodAutoscalingMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the vertical_pod_autoscaling field.
...
`google-beta.google_container_cluster.withWorkloadIdentityConfig` constructs a mixin object that can be merged into the `google_container_cluster`
...
`google-beta.google_container_cluster.withWorkloadIdentityConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`
Terraform resource block to set or update the workload_identity_config field.
