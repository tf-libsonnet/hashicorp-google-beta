...
`google-beta.google_gke_backup_backup_plan.withBackupConfig` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withBackupConfigMixin` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
Terraform resource block to set or update the backup_config field.
...
`google-beta.google_gke_backup_backup_plan.withBackupSchedule` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withBackupScheduleMixin` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
Terraform resource block to set or update the backup_schedule field.
...
`google-beta.google_gke_backup_backup_plan.withCluster` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withDeactivated` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withDescription` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withLabels` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withLocation` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withName` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withProject` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withRetentionPolicy` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withRetentionPolicyMixin` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
Terraform resource block to set or update the retention_policy field.
...
`google-beta.google_gke_backup_backup_plan.withTimeouts` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
...
`google-beta.google_gke_backup_backup_plan.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_gke_backup_backup_plan`
Terraform resource block to set or update the timeouts field.
