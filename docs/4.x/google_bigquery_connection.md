...
`google-beta.google_bigquery_connection.withAws` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withAwsMixin` constructs a mixin object that can be merged into the `google_bigquery_connection`
Terraform resource block to set or update the aws field.
...
`google-beta.google_bigquery_connection.withAzure` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withAzureMixin` constructs a mixin object that can be merged into the `google_bigquery_connection`
Terraform resource block to set or update the azure field.
...
`google-beta.google_bigquery_connection.withCloudResource` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withCloudResourceMixin` constructs a mixin object that can be merged into the `google_bigquery_connection`
Terraform resource block to set or update the cloud_resource field.
...
`google-beta.google_bigquery_connection.withCloudSpanner` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withCloudSpannerMixin` constructs a mixin object that can be merged into the `google_bigquery_connection`
Terraform resource block to set or update the cloud_spanner field.
...
`google-beta.google_bigquery_connection.withCloudSql` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withCloudSqlMixin` constructs a mixin object that can be merged into the `google_bigquery_connection`
Terraform resource block to set or update the cloud_sql field.
...
`google-beta.google_bigquery_connection.withConnectionId` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withDescription` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withFriendlyName` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withLocation` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withProject` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withTimeouts` constructs a mixin object that can be merged into the `google_bigquery_connection`
...
`google-beta.google_bigquery_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_bigquery_connection`
Terraform resource block to set or update the timeouts field.
