...
`google-beta.google_firebase_apple_app.withAppStoreId` constructs a mixin object that can be merged into the `google_firebase_apple_app`
...
`google-beta.google_firebase_apple_app.withBundleId` constructs a mixin object that can be merged into the `google_firebase_apple_app`
...
`google-beta.google_firebase_apple_app.withDeletionPolicy` constructs a mixin object that can be merged into the `google_firebase_apple_app`
...
`google-beta.google_firebase_apple_app.withDisplayName` constructs a mixin object that can be merged into the `google_firebase_apple_app`
...
`google-beta.google_firebase_apple_app.withProject` constructs a mixin object that can be merged into the `google_firebase_apple_app`
...
`google-beta.google_firebase_apple_app.withTeamId` constructs a mixin object that can be merged into the `google_firebase_apple_app`
...
`google-beta.google_firebase_apple_app.withTimeouts` constructs a mixin object that can be merged into the `google_firebase_apple_app`
...
`google-beta.google_firebase_apple_app.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_firebase_apple_app`
Terraform resource block to set or update the timeouts field.
