...
* [`obj service_directory_config`](#obj-service_directory_config)
  ...
  * [`obj service_directory_config.namespace`](#obj-service_directory_confignamespace)
    * [`fn new()`](#fn-service_directory_confignamespacenew)
...
`google-beta.google_dns_managed_zone.withCloudLoggingConfig` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withCloudLoggingConfigMixin` constructs a mixin object that can be merged into the `google_dns_managed_zone`
Terraform resource block to set or update the cloud_logging_config field.
...
`google-beta.google_dns_managed_zone.withDescription` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withDnsName` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withDnssecConfig` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withDnssecConfigMixin` constructs a mixin object that can be merged into the `google_dns_managed_zone`
Terraform resource block to set or update the dnssec_config field.
...
`google-beta.google_dns_managed_zone.withForceDestroy` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withForwardingConfig` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withForwardingConfigMixin` constructs a mixin object that can be merged into the `google_dns_managed_zone`
Terraform resource block to set or update the forwarding_config field.
...
`google-beta.google_dns_managed_zone.withLabels` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withName` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withPeeringConfig` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withPeeringConfigMixin` constructs a mixin object that can be merged into the `google_dns_managed_zone`
Terraform resource block to set or update the peering_config field.
...
`google-beta.google_dns_managed_zone.withPrivateVisibilityConfig` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withPrivateVisibilityConfigMixin` constructs a mixin object that can be merged into the `google_dns_managed_zone`
Terraform resource block to set or update the private_visibility_config field.
...
`google-beta.google_dns_managed_zone.withProject` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withReverseLookup` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withServiceDirectoryConfig` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withServiceDirectoryConfigMixin` constructs a mixin object that can be merged into the `google_dns_managed_zone`
Terraform resource block to set or update the service_directory_config field.
...
`google-beta.google_dns_managed_zone.withTimeouts` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
`google-beta.google_dns_managed_zone.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_dns_managed_zone`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_dns_managed_zone.withVisibility` constructs a mixin object that can be merged into the `google_dns_managed_zone`
...
### fn service_directory_config.new
