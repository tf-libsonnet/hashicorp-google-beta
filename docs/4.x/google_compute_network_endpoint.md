...
`google-beta.google_compute_network_endpoint.withInstance` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
...
`google-beta.google_compute_network_endpoint.withIpAddress` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
...
`google-beta.google_compute_network_endpoint.withNetworkEndpointGroup` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
...
`google-beta.google_compute_network_endpoint.withPort` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
...
`google-beta.google_compute_network_endpoint.withProject` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
...
`google-beta.google_compute_network_endpoint.withTimeouts` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
...
`google-beta.google_compute_network_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
Terraform resource block to set or update the timeouts field.
...
`google-beta.google_compute_network_endpoint.withZone` constructs a mixin object that can be merged into the `google_compute_network_endpoint`
