...
`google-beta.google_composer_environment.withConfig` constructs a mixin object that can be merged into the `google_composer_environment`
...
`google-beta.google_composer_environment.withConfigMixin` constructs a mixin object that can be merged into the `google_composer_environment`
Terraform resource block to set or update the config field.
...
`google-beta.google_composer_environment.withLabels` constructs a mixin object that can be merged into the `google_composer_environment`
...
`google-beta.google_composer_environment.withName` constructs a mixin object that can be merged into the `google_composer_environment`
...
`google-beta.google_composer_environment.withProject` constructs a mixin object that can be merged into the `google_composer_environment`
...
`google-beta.google_composer_environment.withRegion` constructs a mixin object that can be merged into the `google_composer_environment`
...
`google-beta.google_composer_environment.withTimeouts` constructs a mixin object that can be merged into the `google_composer_environment`
...
`google-beta.google_composer_environment.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_composer_environment`
Terraform resource block to set or update the timeouts field.
