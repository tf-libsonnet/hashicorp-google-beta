...
`google-beta.google_project.withAutoCreateNetwork` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withBillingAccount` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withFolderId` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withLabels` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withName` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withOrgId` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withSkipDelete` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withTimeouts` constructs a mixin object that can be merged into the `google_project`
...
`google-beta.google_project.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_project`
Terraform resource block to set or update the timeouts field.
