...
`google-beta.google_compute_instance_group_named_port.withProject` constructs a mixin object that can be merged into the `google_compute_instance_group_named_port`
