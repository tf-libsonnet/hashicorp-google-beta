...
{
  '#':: d.pkg(name='google_sourcerepo_repository_iam_policy', url='', help='`google_sourcerepo_repository_iam_policy` represents the `google-beta_google_sourcerepo_repository_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(project=project, repository=repository),
    _meta=_meta
  ),
