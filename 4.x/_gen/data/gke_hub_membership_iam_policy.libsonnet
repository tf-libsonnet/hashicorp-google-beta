...
{
  '#':: d.pkg(name='google_gke_hub_membership_iam_policy', url='', help='`google_gke_hub_membership_iam_policy` represents the `google-beta_google_gke_hub_membership_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(location=location, membership_id=membership_id, project=project),
    _meta=_meta
  ),
  ...
  withMembershipId(dataSrcLabel, value): {
    data+: {
      google_gke_hub_membership_iam_policy+: {
        [dataSrcLabel]+: {
          membership_id: value,
