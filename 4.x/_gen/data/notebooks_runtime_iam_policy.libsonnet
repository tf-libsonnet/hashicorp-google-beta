...
{
  '#':: d.pkg(name='google_notebooks_runtime_iam_policy', url='', help='`google_notebooks_runtime_iam_policy` represents the `google-beta_google_notebooks_runtime_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(location=location, project=project, runtime_name=runtime_name),
    _meta=_meta
  ),
  ...
  withRuntimeName(dataSrcLabel, value): {
    data+: {
      google_notebooks_runtime_iam_policy+: {
        [dataSrcLabel]+: {
          runtime_name: value,
