...
{
  '#':: d.pkg(name='google_binary_authorization_attestor_iam_policy', url='', help='`google_binary_authorization_attestor_iam_policy` represents the `google-beta_google_binary_authorization_attestor_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(attestor=attestor, project=project),
    _meta=_meta
  ),
  ...
  withAttestor(dataSrcLabel, value): {
    data+: {
