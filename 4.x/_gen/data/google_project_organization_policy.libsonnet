...
{
  '#':: d.pkg(name='google_project_organization_policy', url='', help='`google_project_organization_policy` represents the `google-beta_google_project_organization_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
