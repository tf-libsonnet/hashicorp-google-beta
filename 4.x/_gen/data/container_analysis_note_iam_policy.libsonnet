...
{
  '#':: d.pkg(name='google_container_analysis_note_iam_policy', url='', help='`google_container_analysis_note_iam_policy` represents the `google-beta_google_container_analysis_note_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(note=note, project=project),
    _meta=_meta
  ),
