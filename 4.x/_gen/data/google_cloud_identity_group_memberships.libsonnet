...
{
  '#':: d.pkg(name='google_cloud_identity_group_memberships', url='', help='`google_cloud_identity_group_memberships` represents the `google-beta_google_cloud_identity_group_memberships` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withGroup':: d.fn(help='`google-beta.google_cloud_identity_group_memberships.withGroup` constructs a mixin object that can be merged into the `google_cloud_identity_group_memberships`\nTerraform data source block to set or update the group field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group` field.\n', args=[]),
