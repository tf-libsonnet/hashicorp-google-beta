...
{
  '#':: d.pkg(name='google_kms_key_ring_iam_policy', url='', help='`google_kms_key_ring_iam_policy` represents the `google-beta_google_kms_key_ring_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(key_ring_id=key_ring_id),
    _meta=_meta
  ),
  ...
  withKeyRingId(dataSrcLabel, value): {
    data+: {
