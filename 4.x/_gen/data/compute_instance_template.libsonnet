...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSelfLinkUnique':: d.fn(help='`google-beta.string.withSelfLinkUnique` constructs a mixin object that can be merged into the `string`\nTerraform data source block to set or update the self_link_unique field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `self_link_unique` field.\n', args=[]),
  withSelfLinkUnique(dataSrcLabel, value): {
    data+: {
      google_compute_instance_template+: {
        [dataSrcLabel]+: {
          self_link_unique: value,
        },
      },
    },
  },
