...
{
  '#':: d.pkg(name='google_service_account_key', url='', help='`google_service_account_key` represents the `google-beta_google_service_account_key` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`google-beta.google_service_account_key.withName` constructs a mixin object that can be merged into the `google_service_account_key`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_service_account_key.withProject` constructs a mixin object that can be merged into the `google_service_account_key`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
