...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withManagedZone':: d.fn(help='`google-beta.google_dns_keys.withManagedZone` constructs a mixin object that can be merged into the `google_dns_keys`\nTerraform data source block to set or update the managed_zone field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `managed_zone` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_dns_keys.withProject` constructs a mixin object that can be merged into the `google_dns_keys`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
