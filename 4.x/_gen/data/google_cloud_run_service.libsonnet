...
{
  '#':: d.pkg(name='google_cloud_run_service', url='', help='`google_cloud_run_service` represents the `google-beta_google_cloud_run_service` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withLocation':: d.fn(help='`google-beta.google_cloud_run_service.withLocation` constructs a mixin object that can be merged into the `google_cloud_run_service`\nTerraform data source block to set or update the location field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google-beta.google_cloud_run_service.withName` constructs a mixin object that can be merged into the `google_cloud_run_service`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_cloud_run_service.withProject` constructs a mixin object that can be merged into the `google_cloud_run_service`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
