...
{
  '#':: d.pkg(name='google_bigquery_datapolicy_data_policy_iam_policy', url='', help='`google_bigquery_datapolicy_data_policy_iam_policy` represents the `google-beta_google_bigquery_datapolicy_data_policy_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(data_policy_id=data_policy_id, location=location, project=project),
    _meta=_meta
  ),
  ...
  withDataPolicyId(dataSrcLabel, value): {
    data+: {
