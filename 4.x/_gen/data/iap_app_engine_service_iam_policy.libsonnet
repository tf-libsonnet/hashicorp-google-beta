...
{
  '#':: d.pkg(name='google_iap_app_engine_service_iam_policy', url='', help='`google_iap_app_engine_service_iam_policy` represents the `google-beta_google_iap_app_engine_service_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(app_id=app_id, project=project, service=service),
    _meta=_meta
  ),
