...
{
  '#':: d.pkg(name='google_compute_addresses', url='', help='`google_compute_addresses` represents the `google-beta_google_compute_addresses` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withFilter':: d.fn(help='`google-beta.google_compute_addresses.withFilter` constructs a mixin object that can be merged into the `google_compute_addresses`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_compute_addresses.withProject` constructs a mixin object that can be merged into the `google_compute_addresses`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`google-beta.google_compute_addresses.withRegion` constructs a mixin object that can be merged into the `google_compute_addresses`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
