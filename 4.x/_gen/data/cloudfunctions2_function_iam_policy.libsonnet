...
{
  '#':: d.pkg(name='google_cloudfunctions2_function_iam_policy', url='', help='`google_cloudfunctions2_function_iam_policy` represents the `google-beta_google_cloudfunctions2_function_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(cloud_function=cloud_function, location=location, project=project),
    _meta=_meta
  ),
