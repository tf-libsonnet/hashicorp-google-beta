...
{
  '#':: d.pkg(name='google_container_attached_install_manifest', url='', help='`google_container_attached_install_manifest` represents the `google-beta_google_container_attached_install_manifest` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
