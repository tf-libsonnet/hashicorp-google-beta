...
{
  '#':: d.pkg(name='google_dataproc_autoscaling_policy_iam_policy', url='', help='`google_dataproc_autoscaling_policy_iam_policy` represents the `google-beta_google_dataproc_autoscaling_policy_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(location=location, policy_id=policy_id, project=project),
    _meta=_meta
  ),
