...
{
  '#':: d.pkg(name='google_firebase_hosting_channel', url='', help='`google_firebase_hosting_channel` represents the `google-beta_google_firebase_hosting_channel` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(channel_id=channel_id, site_id=site_id),
    _meta=_meta
  ),
  ...
  withChannelId(dataSrcLabel, value): {
    data+: {
