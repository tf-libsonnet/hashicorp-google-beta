...
{
  '#':: d.pkg(name='google_folders', url='', help='`google_folders` represents the `google-beta_google_folders` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withParentId':: d.fn(help='`google-beta.google_folders.withParentId` constructs a mixin object that can be merged into the `google_folders`\nTerraform data source block to set or update the parent_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent_id` field.\n', args=[]),
