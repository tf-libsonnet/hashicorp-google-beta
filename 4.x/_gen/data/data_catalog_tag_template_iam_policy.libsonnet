...
{
  '#':: d.pkg(name='google_data_catalog_tag_template_iam_policy', url='', help='`google_data_catalog_tag_template_iam_policy` represents the `google-beta_google_data_catalog_tag_template_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(project=project, region=region, tag_template=tag_template),
    _meta=_meta
  ),
  ...
  withTagTemplate(dataSrcLabel, value): {
    data+: {
      google_data_catalog_tag_template_iam_policy+: {
        [dataSrcLabel]+: {
          tag_template: value,
