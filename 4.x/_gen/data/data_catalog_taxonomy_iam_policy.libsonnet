...
{
  '#':: d.pkg(name='google_data_catalog_taxonomy_iam_policy', url='', help='`google_data_catalog_taxonomy_iam_policy` represents the `google-beta_google_data_catalog_taxonomy_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(project=project, region=region, taxonomy=taxonomy),
    _meta=_meta
  ),
  ...
  withTaxonomy(dataSrcLabel, value): {
    data+: {
      google_data_catalog_taxonomy_iam_policy+: {
        [dataSrcLabel]+: {
          taxonomy: value,
