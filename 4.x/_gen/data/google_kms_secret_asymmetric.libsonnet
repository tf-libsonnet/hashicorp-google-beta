...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCiphertext':: d.fn(help='`google-beta.google_kms_secret_asymmetric.withCiphertext` constructs a mixin object that can be merged into the `google_kms_secret_asymmetric`\nTerraform data source block to set or update the ciphertext field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ciphertext` field.\n', args=[]),
  ...
  '#withCrc32':: d.fn(help='`google-beta.google_kms_secret_asymmetric.withCrc32` constructs a mixin object that can be merged into the `google_kms_secret_asymmetric`\nTerraform data source block to set or update the crc32 field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `crc32` field.\n', args=[]),
  ...
  '#withCryptoKeyVersion':: d.fn(help='`google-beta.google_kms_secret_asymmetric.withCryptoKeyVersion` constructs a mixin object that can be merged into the `google_kms_secret_asymmetric`\nTerraform data source block to set or update the crypto_key_version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `crypto_key_version` field.\n', args=[]),
