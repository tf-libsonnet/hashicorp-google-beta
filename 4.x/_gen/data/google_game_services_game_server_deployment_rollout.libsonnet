...
{
  '#':: d.pkg(name='google_game_services_game_server_deployment_rollout', url='', help='`google_game_services_game_server_deployment_rollout` represents the `google-beta_google_game_services_game_server_deployment_rollout` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
