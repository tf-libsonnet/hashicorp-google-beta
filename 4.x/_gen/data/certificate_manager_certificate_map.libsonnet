...
{
  '#':: d.pkg(name='google_certificate_manager_certificate_map', url='', help='`google_certificate_manager_certificate_map` represents the `google-beta_google_certificate_manager_certificate_map` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
