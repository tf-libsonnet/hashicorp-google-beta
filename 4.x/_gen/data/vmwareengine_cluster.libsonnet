...
{
  '#':: d.pkg(name='google_vmwareengine_cluster', url='', help='`google_vmwareengine_cluster` represents the `google-beta_google_vmwareengine_cluster` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
