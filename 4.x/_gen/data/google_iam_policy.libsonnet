...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  binding:: {
    ...
    '#new':: d.fn(help='\n`google-beta.google_iam_policy.binding.new` constructs a new object with attributes and blocks configured for the `binding`\nTerraform sub block.\n\n\n\n**Args**:\n  - `members` (`list`): \n  - `role` (`string`): \n  - `condition` (`list[obj]`):  When `null`, the `condition` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_iam_policy.binding.condition.new](#fn-google_iam_policyconditionnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `binding` sub block.\n', args=[]),
    new(
      members,
      role,
      condition=null
