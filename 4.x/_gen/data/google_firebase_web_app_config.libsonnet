...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProject':: d.fn(help='`google-beta.google_firebase_web_app_config.withProject` constructs a mixin object that can be merged into the `google_firebase_web_app_config`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withWebAppId':: d.fn(help='`google-beta.google_firebase_web_app_config.withWebAppId` constructs a mixin object that can be merged into the `google_firebase_web_app_config`\nTerraform data source block to set or update the web_app_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `web_app_id` field.\n', args=[]),
