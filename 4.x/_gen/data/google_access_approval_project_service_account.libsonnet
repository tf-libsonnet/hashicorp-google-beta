...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProjectId':: d.fn(help='`google-beta.google_access_approval_project_service_account.withProjectId` constructs a mixin object that can be merged into the `google_access_approval_project_service_account`\nTerraform data source block to set or update the project_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project_id` field.\n', args=[]),
