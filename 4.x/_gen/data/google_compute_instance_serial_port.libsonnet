...
{
  '#':: d.pkg(name='google_compute_instance_serial_port', url='', help='`google_compute_instance_serial_port` represents the `google-beta_google_compute_instance_serial_port` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withInstance':: d.fn(help='`google-beta.google_compute_instance_serial_port.withInstance` constructs a mixin object that can be merged into the `google_compute_instance_serial_port`\nTerraform data source block to set or update the instance field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance` field.\n', args=[]),
  ...
  '#withPort':: d.fn(help='`google-beta.google_compute_instance_serial_port.withPort` constructs a mixin object that can be merged into the `google_compute_instance_serial_port`\nTerraform data source block to set or update the port field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_compute_instance_serial_port.withProject` constructs a mixin object that can be merged into the `google_compute_instance_serial_port`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withZone':: d.fn(help='`google-beta.google_compute_instance_serial_port.withZone` constructs a mixin object that can be merged into the `google_compute_instance_serial_port`\nTerraform data source block to set or update the zone field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zone` field.\n', args=[]),
