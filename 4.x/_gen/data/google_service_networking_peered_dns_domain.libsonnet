...
{
  '#':: d.pkg(name='google_service_networking_peered_dns_domain', url='', help='`google_service_networking_peered_dns_domain` represents the `google-beta_google_service_networking_peered_dns_domain` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
