...
{
  '#':: d.pkg(name='google_cloud_identity_group_lookup', url='', help='`google_cloud_identity_group_lookup` represents the `google-beta_google_cloud_identity_group_lookup` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  group_key:: {
