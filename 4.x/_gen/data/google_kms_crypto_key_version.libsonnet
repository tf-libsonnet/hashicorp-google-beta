...
{
  '#':: d.pkg(name='google_kms_crypto_key_version', url='', help='`google_kms_crypto_key_version` represents the `google-beta_google_kms_crypto_key_version` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withVersion':: d.fn(help='`google-beta.google_kms_crypto_key_version.withVersion` constructs a mixin object that can be merged into the `google_kms_crypto_key_version`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
