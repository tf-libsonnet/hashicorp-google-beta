...
{
  '#':: d.pkg(name='google_service_account_access_token', url='', help='`google_service_account_access_token` represents the `google-beta_google_service_account_access_token` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDelegates':: d.fn(help='`google-beta.google_service_account_access_token.withDelegates` constructs a mixin object that can be merged into the `google_service_account_access_token`\nTerraform data source block to set or update the delegates field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delegates` field.\n', args=[]),
  ...
  '#withLifetime':: d.fn(help='`google-beta.google_service_account_access_token.withLifetime` constructs a mixin object that can be merged into the `google_service_account_access_token`\nTerraform data source block to set or update the lifetime field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lifetime` field.\n', args=[]),
  ...
  '#withScopes':: d.fn(help='`google-beta.google_service_account_access_token.withScopes` constructs a mixin object that can be merged into the `google_service_account_access_token`\nTerraform data source block to set or update the scopes field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scopes` field.\n', args=[]),
  ...
  '#withTargetServiceAccount':: d.fn(help='`google-beta.google_service_account_access_token.withTargetServiceAccount` constructs a mixin object that can be merged into the `google_service_account_access_token`\nTerraform data source block to set or update the target_service_account field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_service_account` field.\n', args=[]),
