...
{
  '#':: d.pkg(name='google_dataproc_metastore_service', url='', help='`google_dataproc_metastore_service` represents the `google-beta_google_dataproc_metastore_service` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
