...
{
  '#':: d.pkg(name='google_storage_bucket_object_content', url='', help='`google_storage_bucket_object_content` represents the `google-beta_google_storage_bucket_object_content` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withBucket':: d.fn(help='`google-beta.google_storage_bucket_object_content.withBucket` constructs a mixin object that can be merged into the `google_storage_bucket_object_content`\nTerraform data source block to set or update the bucket field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withContent':: d.fn(help='`google-beta.google_storage_bucket_object_content.withContent` constructs a mixin object that can be merged into the `google_storage_bucket_object_content`\nTerraform data source block to set or update the content field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `content` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google-beta.google_storage_bucket_object_content.withName` constructs a mixin object that can be merged into the `google_storage_bucket_object_content`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
