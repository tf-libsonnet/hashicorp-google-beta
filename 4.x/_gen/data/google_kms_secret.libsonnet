...
{
  '#':: d.pkg(name='google_kms_secret', url='', help='`google_kms_secret` represents the `google-beta_google_kms_secret` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withAdditionalAuthenticatedData':: d.fn(help='`google-beta.google_kms_secret.withAdditionalAuthenticatedData` constructs a mixin object that can be merged into the `google_kms_secret`\nTerraform data source block to set or update the additional_authenticated_data field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `additional_authenticated_data` field.\n', args=[]),
  ...
  '#withCiphertext':: d.fn(help='`google-beta.google_kms_secret.withCiphertext` constructs a mixin object that can be merged into the `google_kms_secret`\nTerraform data source block to set or update the ciphertext field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ciphertext` field.\n', args=[]),
  ...
  '#withCryptoKey':: d.fn(help='`google-beta.google_kms_secret.withCryptoKey` constructs a mixin object that can be merged into the `google_kms_secret`\nTerraform data source block to set or update the crypto_key field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `crypto_key` field.\n', args=[]),
