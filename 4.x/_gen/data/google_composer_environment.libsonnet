...
{
  '#':: d.pkg(name='google_composer_environment', url='', help='`google_composer_environment` represents the `google-beta_google_composer_environment` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
