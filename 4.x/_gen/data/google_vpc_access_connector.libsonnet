...
{
  '#':: d.pkg(name='google_vpc_access_connector', url='', help='`google_vpc_access_connector` represents the `google-beta_google_vpc_access_connector` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
