...
{
  '#':: d.pkg(name='google_monitoring_notification_channel', url='', help='`google_monitoring_notification_channel` represents the `google-beta_google_monitoring_notification_channel` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
