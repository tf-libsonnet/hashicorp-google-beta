...
{
  '#':: d.pkg(name='google_compute_instance_template', url='', help='`google_compute_instance_template` represents the `google-beta_google_compute_instance_template` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withFilter':: d.fn(help='`google-beta.google_compute_instance_template.withFilter` constructs a mixin object that can be merged into the `google_compute_instance_template`\nTerraform data source block to set or update the filter field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withMostRecent':: d.fn(help='`google-beta.google_compute_instance_template.withMostRecent` constructs a mixin object that can be merged into the `google_compute_instance_template`\nTerraform data source block to set or update the most_recent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `most_recent` field.\n', args=[]),
