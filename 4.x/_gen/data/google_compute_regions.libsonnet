...
{
  '#':: d.pkg(name='google_compute_regions', url='', help='`google_compute_regions` represents the `google-beta_google_compute_regions` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withProject':: d.fn(help='`google-beta.google_compute_regions.withProject` constructs a mixin object that can be merged into the `google_compute_regions`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withStatus':: d.fn(help='`google-beta.google_compute_regions.withStatus` constructs a mixin object that can be merged into the `google_compute_regions`\nTerraform data source block to set or update the status field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
