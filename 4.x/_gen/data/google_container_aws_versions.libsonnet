...
{
  '#':: d.pkg(name='google_container_aws_versions', url='', help='`google_container_aws_versions` represents the `google-beta_google_container_aws_versions` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withLocation':: d.fn(help='`google-beta.google_container_aws_versions.withLocation` constructs a mixin object that can be merged into the `google_container_aws_versions`\nTerraform data source block to set or update the location field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_container_aws_versions.withProject` constructs a mixin object that can be merged into the `google_container_aws_versions`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
