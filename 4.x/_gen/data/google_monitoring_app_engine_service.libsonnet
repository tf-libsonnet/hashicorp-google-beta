...
{
  '#':: d.pkg(name='google_monitoring_app_engine_service', url='', help='`google_monitoring_app_engine_service` represents the `google-beta_google_monitoring_app_engine_service` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withModuleId':: d.fn(help='`google-beta.google_monitoring_app_engine_service.withModuleId` constructs a mixin object that can be merged into the `google_monitoring_app_engine_service`\nTerraform data source block to set or update the module_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `module_id` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_monitoring_app_engine_service.withProject` constructs a mixin object that can be merged into the `google_monitoring_app_engine_service`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
