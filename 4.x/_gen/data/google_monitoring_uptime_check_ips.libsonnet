...
{
  '#':: d.pkg(name='google_monitoring_uptime_check_ips', url='', help='`google_monitoring_uptime_check_ips` represents the `google-beta_google_monitoring_uptime_check_ips` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
