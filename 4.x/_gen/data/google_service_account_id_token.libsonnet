...
{
  '#':: d.pkg(name='google_service_account_id_token', url='', help='`google_service_account_id_token` represents the `google-beta_google_service_account_id_token` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDelegates':: d.fn(help='`google-beta.google_service_account_id_token.withDelegates` constructs a mixin object that can be merged into the `google_service_account_id_token`\nTerraform data source block to set or update the delegates field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delegates` field.\n', args=[]),
  ...
  '#withIncludeEmail':: d.fn(help='`google-beta.google_service_account_id_token.withIncludeEmail` constructs a mixin object that can be merged into the `google_service_account_id_token`\nTerraform data source block to set or update the include_email field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_email` field.\n', args=[]),
  ...
  '#withTargetAudience':: d.fn(help='`google-beta.google_service_account_id_token.withTargetAudience` constructs a mixin object that can be merged into the `google_service_account_id_token`\nTerraform data source block to set or update the target_audience field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_audience` field.\n', args=[]),
  ...
  '#withTargetServiceAccount':: d.fn(help='`google-beta.google_service_account_id_token.withTargetServiceAccount` constructs a mixin object that can be merged into the `google_service_account_id_token`\nTerraform data source block to set or update the target_service_account field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_service_account` field.\n', args=[]),
