...
{
  '#':: d.pkg(name='google_iam_testable_permissions', url='', help='`google_iam_testable_permissions` represents the `google-beta_google_iam_testable_permissions` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withCustomSupportLevel':: d.fn(help='`google-beta.google_iam_testable_permissions.withCustomSupportLevel` constructs a mixin object that can be merged into the `google_iam_testable_permissions`\nTerraform data source block to set or update the custom_support_level field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_support_level` field.\n', args=[]),
  ...
  '#withFullResourceName':: d.fn(help='`google-beta.google_iam_testable_permissions.withFullResourceName` constructs a mixin object that can be merged into the `google_iam_testable_permissions`\nTerraform data source block to set or update the full_resource_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `full_resource_name` field.\n', args=[]),
  ...
  '#withStages':: d.fn(help='`google-beta.google_iam_testable_permissions.withStages` constructs a mixin object that can be merged into the `google_iam_testable_permissions`\nTerraform data source block to set or update the stages field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stages` field.\n', args=[]),
