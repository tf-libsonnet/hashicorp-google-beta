...
{
  '#':: d.pkg(name='google_logging_project_cmek_settings', url='', help='`google_logging_project_cmek_settings` represents the `google-beta_google_logging_project_cmek_settings` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withKmsKeyName':: d.fn(help='`google-beta.google_logging_project_cmek_settings.withKmsKeyName` constructs a mixin object that can be merged into the `google_logging_project_cmek_settings`\nTerraform data source block to set or update the kms_key_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kms_key_name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_logging_project_cmek_settings.withProject` constructs a mixin object that can be merged into the `google_logging_project_cmek_settings`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
