...
{
  '#':: d.pkg(name='google_notebooks_instance_iam_policy', url='', help='`google_notebooks_instance_iam_policy` represents the `google-beta_google_notebooks_instance_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(instance_name=instance_name, location=location, project=project),
    _meta=_meta
  ),
  ...
  withInstanceName(dataSrcLabel, value): {
    data+: {
