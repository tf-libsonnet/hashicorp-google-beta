...
{
  '#':: d.pkg(name='google_firebase_android_app', url='', help='`google_firebase_android_app` represents the `google-beta_google_firebase_android_app` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withAppId':: d.fn(help='`google-beta.google_firebase_android_app.withAppId` constructs a mixin object that can be merged into the `google_firebase_android_app`\nTerraform data source block to set or update the app_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_id` field.\n', args=[]),
