...
{
  '#':: d.pkg(name='google_firebase_android_app_config', url='', help='`google_firebase_android_app_config` represents the `google-beta_google_firebase_android_app_config` Terraform data source.\n\nA Google Cloud Firebase Android application configuration\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    type='google_firebase_android_app_config',
    label=dataSrcLabel,
