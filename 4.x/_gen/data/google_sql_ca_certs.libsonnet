...
{
  '#':: d.pkg(name='google_sql_ca_certs', url='', help='`google_sql_ca_certs` represents the `google-beta_google_sql_ca_certs` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withInstance':: d.fn(help='`google-beta.google_sql_ca_certs.withInstance` constructs a mixin object that can be merged into the `google_sql_ca_certs`\nTerraform data source block to set or update the instance field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_sql_ca_certs.withProject` constructs a mixin object that can be merged into the `google_sql_ca_certs`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
