...
{
  '#':: d.pkg(name='google_bigquery_analytics_hub_listing_iam_policy', url='', help='`google_bigquery_analytics_hub_listing_iam_policy` represents the `google-beta_google_bigquery_analytics_hub_listing_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  withListingId(dataSrcLabel, value): {
    data+: {
      google_bigquery_analytics_hub_listing_iam_policy+: {
        [dataSrcLabel]+: {
          listing_id: value,
