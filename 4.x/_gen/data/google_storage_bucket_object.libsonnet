...
{
  '#':: d.pkg(name='google_storage_bucket_object', url='', help='`google_storage_bucket_object` represents the `google-beta_google_storage_bucket_object` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
