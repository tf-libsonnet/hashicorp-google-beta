...
{
  '#':: d.pkg(name='google_compute_subnetwork_iam_policy', url='', help='`google_compute_subnetwork_iam_policy` represents the `google-beta_google_compute_subnetwork_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(project=project, region=region, subnetwork=subnetwork),
    _meta=_meta
  ),
  ...
  withSubnetwork(dataSrcLabel, value): {
    data+: {
      google_compute_subnetwork_iam_policy+: {
        [dataSrcLabel]+: {
          subnetwork: value,
