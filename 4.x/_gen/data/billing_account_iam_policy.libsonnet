...
{
  '#':: d.pkg(name='google_billing_account_iam_policy', url='', help='`google_billing_account_iam_policy` represents the `google-beta_google_billing_account_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(billing_account_id=billing_account_id),
    _meta=_meta
  ),
  ...
  withBillingAccountId(dataSrcLabel, value): {
    data+: {
