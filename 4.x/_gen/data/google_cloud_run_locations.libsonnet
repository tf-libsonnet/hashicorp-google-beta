...
{
  '#':: d.pkg(name='google_cloud_run_locations', url='', help='`google_cloud_run_locations` represents the `google-beta_google_cloud_run_locations` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withProject':: d.fn(help='`google-beta.google_cloud_run_locations.withProject` constructs a mixin object that can be merged into the `google_cloud_run_locations`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
