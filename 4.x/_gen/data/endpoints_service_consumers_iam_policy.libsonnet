...
{
  '#':: d.pkg(name='google_endpoints_service_consumers_iam_policy', url='', help='`google_endpoints_service_consumers_iam_policy` represents the `google-beta_google_endpoints_service_consumers_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(consumer_project=consumer_project, service_name=service_name),
    _meta=_meta
  ),
  ...
  withConsumerProject(dataSrcLabel, value): {
    data+: {
