...
{
  '#':: d.pkg(name='google_iap_client', url='', help='`google_iap_client` represents the `google-beta_google_iap_client` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withClientId':: d.fn(help='`google-beta.google_iap_client.withClientId` constructs a mixin object that can be merged into the `google_iap_client`\nTerraform data source block to set or update the client_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `client_id` field.\n', args=[]),
