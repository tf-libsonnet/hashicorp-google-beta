...
{
  '#':: d.pkg(name='google_folder', url='', help='`google_folder` represents the `google-beta_google_folder` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withFolder':: d.fn(help='`google-beta.google_folder.withFolder` constructs a mixin object that can be merged into the `google_folder`\nTerraform data source block to set or update the folder field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `folder` field.\n', args=[]),
  ...
  '#withLookupOrganization':: d.fn(help='`google-beta.google_folder.withLookupOrganization` constructs a mixin object that can be merged into the `google_folder`\nTerraform data source block to set or update the lookup_organization field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lookup_organization` field.\n', args=[]),
