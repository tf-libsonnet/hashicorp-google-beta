...
{
  '#':: d.pkg(name='google_organization', url='', help='`google_organization` represents the `google-beta_google_organization` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDomain':: d.fn(help='`google-beta.google_organization.withDomain` constructs a mixin object that can be merged into the `google_organization`\nTerraform data source block to set or update the domain field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `domain` field.\n', args=[]),
  ...
  '#withOrganization':: d.fn(help='`google-beta.google_organization.withOrganization` constructs a mixin object that can be merged into the `google_organization`\nTerraform data source block to set or update the organization field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organization` field.\n', args=[]),
