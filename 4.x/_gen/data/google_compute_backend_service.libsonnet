...
{
  '#':: d.pkg(name='google_compute_backend_service', url='', help='`google_compute_backend_service` represents the `google-beta_google_compute_backend_service` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
