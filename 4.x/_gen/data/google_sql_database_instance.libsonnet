...
{
  '#':: d.pkg(name='google_sql_database_instance', url='', help='`google_sql_database_instance` represents the `google-beta_google_sql_database_instance` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
