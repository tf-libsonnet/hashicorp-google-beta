...
{
  '#':: d.pkg(name='google_sql_database_instances', url='', help='`google_sql_database_instances` represents the `google-beta_google_sql_database_instances` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
