...
{
  '#':: d.pkg(name='google_iam_role', url='', help='`google_iam_role` represents the `google-beta_google_iam_role` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`google-beta.google_iam_role.withName` constructs a mixin object that can be merged into the `google_iam_role`\nTerraform data source block to set or update the name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
