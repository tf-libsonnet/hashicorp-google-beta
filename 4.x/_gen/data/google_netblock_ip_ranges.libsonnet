...
{
  '#':: d.pkg(name='google_netblock_ip_ranges', url='', help='`google_netblock_ip_ranges` represents the `google-beta_google_netblock_ip_ranges` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withRangeType':: d.fn(help='`google-beta.google_netblock_ip_ranges.withRangeType` constructs a mixin object that can be merged into the `google_netblock_ip_ranges`\nTerraform data source block to set or update the range_type field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `range_type` field.\n', args=[]),
