...
{
  '#':: d.pkg(name='google_compute_instance', url='', help='`google_compute_instance` represents the `google-beta_google_compute_instance` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withSelfLink':: d.fn(help='`google-beta.google_compute_instance.withSelfLink` constructs a mixin object that can be merged into the `google_compute_instance`\nTerraform data source block to set or update the self_link field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `self_link` field.\n', args=[]),
