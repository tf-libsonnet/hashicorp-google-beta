...
{
  '#':: d.pkg(name='google_compute_vpn_gateway', url='', help='`google_compute_vpn_gateway` represents the `google-beta_google_compute_vpn_gateway` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
