...
{
  '#':: d.pkg(name='google_vertex_ai_featurestore_iam_policy', url='', help='`google_vertex_ai_featurestore_iam_policy` represents the `google-beta_google_vertex_ai_featurestore_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(featurestore=featurestore, project=project, region=region),
    _meta=_meta
  ),
