...
{
  '#':: d.pkg(name='google_data_catalog_entry_group_iam_policy', url='', help='`google_data_catalog_entry_group_iam_policy` represents the `google-beta_google_data_catalog_entry_group_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(entry_group=entry_group, project=project, region=region),
    _meta=_meta
  ),
  ...
  withEntryGroup(dataSrcLabel, value): {
    data+: {
