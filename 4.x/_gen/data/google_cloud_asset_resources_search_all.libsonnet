...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAssetTypes':: d.fn(help='`google-beta.google_cloud_asset_resources_search_all.withAssetTypes` constructs a mixin object that can be merged into the `google_cloud_asset_resources_search_all`\nTerraform data source block to set or update the asset_types field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `asset_types` field.\n', args=[]),
  ...
  '#withQuery':: d.fn(help='`google-beta.google_cloud_asset_resources_search_all.withQuery` constructs a mixin object that can be merged into the `google_cloud_asset_resources_search_all`\nTerraform data source block to set or update the query field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query` field.\n', args=[]),
  ...
  '#withScope':: d.fn(help='`google-beta.google_cloud_asset_resources_search_all.withScope` constructs a mixin object that can be merged into the `google_cloud_asset_resources_search_all`\nTerraform data source block to set or update the scope field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scope` field.\n', args=[]),
