...
{
  '#':: d.pkg(name='google_access_approval_folder_service_account', url='', help='`google_access_approval_folder_service_account` represents the `google-beta_google_access_approval_folder_service_account` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
