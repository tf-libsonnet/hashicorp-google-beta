...
{
  '#':: d.pkg(name='google_vertex_ai_featurestore_entitytype_iam_policy', url='', help='`google_vertex_ai_featurestore_entitytype_iam_policy` represents the `google-beta_google_vertex_ai_featurestore_entitytype_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(entitytype=entitytype, featurestore=featurestore),
    _meta=_meta
  ),
  ...
  withEntitytype(dataSrcLabel, value): {
    data+: {
  ...
  withFeaturestore(dataSrcLabel, value): {
    data+: {
      google_vertex_ai_featurestore_entitytype_iam_policy+: {
        [dataSrcLabel]+: {
          featurestore: value,
