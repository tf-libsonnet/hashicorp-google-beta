...
{
  '#':: d.pkg(name='google_secret_manager_secret_version', url='', help='`google_secret_manager_secret_version` represents the `google-beta_google_secret_manager_secret_version` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withProject':: d.fn(help='`google-beta.google_secret_manager_secret_version.withProject` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`google-beta.google_secret_manager_secret_version.withVersion` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`\nTerraform data source block to set or update the version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
