...
{
  '#':: d.pkg(name='google_compute_machine_types', url='', help='`google_compute_machine_types` represents the `google-beta_google_compute_machine_types` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
