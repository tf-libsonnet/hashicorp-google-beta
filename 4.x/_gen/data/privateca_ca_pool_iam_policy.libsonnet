...
{
  '#':: d.pkg(name='google_privateca_ca_pool_iam_policy', url='', help='`google_privateca_ca_pool_iam_policy` represents the `google-beta_google_privateca_ca_pool_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(ca_pool=ca_pool, location=location, project=project),
    _meta=_meta
  ),
