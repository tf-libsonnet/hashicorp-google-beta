...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withStoredInfoTypeId':: d.fn(help='`google-beta.string.withStoredInfoTypeId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the stored_info_type_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `stored_info_type_id` field.\n', args=[]),
  withStoredInfoTypeId(resourceLabel, value): {
    resource+: {
      google_data_loss_prevention_stored_info_type+: {
        [resourceLabel]+: {
          stored_info_type_id: value,
        },
      },
    },
  },
