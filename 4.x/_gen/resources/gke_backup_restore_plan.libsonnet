...
{
  '#':: d.pkg(name='google_gke_backup_restore_plan', url='', help='`google_gke_backup_restore_plan` represents the `google-beta_google_gke_backup_restore_plan` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withRestoreConfigMixin':: d.fn(help='`google-beta.list[obj].withRestoreConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the restore_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withRestoreConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `restore_config` field.\n', args=[]),
