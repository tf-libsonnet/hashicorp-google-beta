...
{
  '#':: d.pkg(name='google_compute_region_commitment', url='', help='`google_compute_region_commitment` represents the `google-beta_google_compute_region_commitment` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  license_resource:: {
  ...
  '#withCategory':: d.fn(help='`google-beta.string.withCategory` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the category field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `category` field.\n', args=[]),
  ...
  '#withLicenseResourceMixin':: d.fn(help='`google-beta.list[obj].withLicenseResourceMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the license_resource field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withLicenseResource](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `license_resource` field.\n', args=[]),
