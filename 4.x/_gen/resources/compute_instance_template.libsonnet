...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withResourceManagerTags':: d.fn(help='`google-beta.obj.withResourceManagerTags` constructs a mixin object that can be merged into the `obj`\nTerraform resource block to set or update the resource_manager_tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`obj`): The value to set for the `resource_manager_tags` field.\n', args=[]),
  withResourceManagerTags(resourceLabel, value): {
    resource+: {
      google_compute_instance_template+: {
        [resourceLabel]+: {
          resource_manager_tags: value,
        },
      },
    },
  },
