...
{
  '#':: d.pkg(name='google_compute_region_network_endpoint', url='', help='`google_compute_region_network_endpoint` represents the `google-beta_google_compute_region_network_endpoint` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withRegionNetworkEndpointGroup':: d.fn(help='`google-beta.string.withRegionNetworkEndpointGroup` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the region_network_endpoint_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `region_network_endpoint_group` field.\n', args=[]),
  withRegionNetworkEndpointGroup(resourceLabel, value): {
    resource+: {
      google_compute_region_network_endpoint+: {
        [resourceLabel]+: {
          region_network_endpoint_group: value,
        },
      },
    },
  },
