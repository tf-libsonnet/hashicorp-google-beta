...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withRepositoryEventConfig':: d.fn(help='`google-beta.list[obj].withRepositoryEventConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the repository_event_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withRepositoryEventConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `repository_event_config` field.\n', args=[]),
  withRepositoryEventConfig(resourceLabel, value): {
    resource+: {
      google_cloudbuild_trigger+: {
        [resourceLabel]+: {
          repository_event_config: value,
        },
      },
    },
  },
  '#withRepositoryEventConfigMixin':: d.fn(help='`google-beta.list[obj].withRepositoryEventConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the repository_event_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withRepositoryEventConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `repository_event_config` field.\n', args=[]),
  withRepositoryEventConfigMixin(resourceLabel, value): {
    resource+: {
      google_cloudbuild_trigger+: {
        [resourceLabel]+: {
          repository_event_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
