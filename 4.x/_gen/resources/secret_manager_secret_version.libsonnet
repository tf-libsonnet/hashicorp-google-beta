...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withIsSecretDataBase64':: d.fn(help='`google-beta.bool.withIsSecretDataBase64` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the is_secret_data_base64 field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `is_secret_data_base64` field.\n', args=[]),
  withIsSecretDataBase64(resourceLabel, value): {
    resource+: {
      google_secret_manager_secret_version+: {
        [resourceLabel]+: {
          is_secret_data_base64: value,
        },
      },
    },
  },
