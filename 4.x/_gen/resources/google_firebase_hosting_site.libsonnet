...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAppId':: d.fn(help='`google-beta.google_firebase_hosting_site.withAppId` constructs a mixin object that can be merged into the `google_firebase_hosting_site`\nTerraform resource block to set or update the app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `app_id` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_firebase_hosting_site.withProject` constructs a mixin object that can be merged into the `google_firebase_hosting_site`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withSiteId':: d.fn(help='`google-beta.google_firebase_hosting_site.withSiteId` constructs a mixin object that can be merged into the `google_firebase_hosting_site`\nTerraform resource block to set or update the site_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `site_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_firebase_hosting_site.withTimeouts` constructs a mixin object that can be merged into the `google_firebase_hosting_site`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_firebase_hosting_site.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_firebase_hosting_site`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_firebase_hosting_site.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
