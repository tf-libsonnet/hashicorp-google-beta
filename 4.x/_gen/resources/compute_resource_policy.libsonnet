...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    name,
    description=null,
    disk_consistency_group_policy=null,
  ...
  '#withDiskConsistencyGroupPolicy':: d.fn(help='`google-beta.list[obj].withDiskConsistencyGroupPolicy` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the disk_consistency_group_policy field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withDiskConsistencyGroupPolicyMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `disk_consistency_group_policy` field.\n', args=[]),
  withDiskConsistencyGroupPolicy(resourceLabel, value): {
    resource+: {
      google_compute_resource_policy+: {
        [resourceLabel]+: {
          disk_consistency_group_policy: value,
        },
      },
    },
  },
  '#withDiskConsistencyGroupPolicyMixin':: d.fn(help='`google-beta.list[obj].withDiskConsistencyGroupPolicyMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the disk_consistency_group_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withDiskConsistencyGroupPolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `disk_consistency_group_policy` field.\n', args=[]),
  withDiskConsistencyGroupPolicyMixin(resourceLabel, value): {
    resource+: {
      google_compute_resource_policy+: {
        [resourceLabel]+: {
          disk_consistency_group_policy+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
