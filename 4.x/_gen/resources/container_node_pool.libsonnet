...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withQueuedProvisioning':: d.fn(help='`google-beta.list[obj].withQueuedProvisioning` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the queued_provisioning field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withQueuedProvisioningMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `queued_provisioning` field.\n', args=[]),
  withQueuedProvisioning(resourceLabel, value): {
    resource+: {
      google_container_node_pool+: {
        [resourceLabel]+: {
          queued_provisioning: value,
        },
      },
    },
  },
  '#withQueuedProvisioningMixin':: d.fn(help='`google-beta.list[obj].withQueuedProvisioningMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the queued_provisioning field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withQueuedProvisioning](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `queued_provisioning` field.\n', args=[]),
  withQueuedProvisioningMixin(resourceLabel, value): {
    resource+: {
      google_container_node_pool+: {
        [resourceLabel]+: {
          queued_provisioning+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
