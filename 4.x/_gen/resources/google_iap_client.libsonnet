...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBrand':: d.fn(help='`google-beta.google_iap_client.withBrand` constructs a mixin object that can be merged into the `google_iap_client`\nTerraform resource block to set or update the brand field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `brand` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google-beta.google_iap_client.withDisplayName` constructs a mixin object that can be merged into the `google_iap_client`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_iap_client.withTimeouts` constructs a mixin object that can be merged into the `google_iap_client`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_iap_client.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_iap_client`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_iap_client.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
