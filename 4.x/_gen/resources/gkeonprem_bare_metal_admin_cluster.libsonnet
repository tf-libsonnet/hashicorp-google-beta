...
{
  '#':: d.pkg(name='google_gkeonprem_bare_metal_admin_cluster', url='', help='`google_gkeonprem_bare_metal_admin_cluster` represents the `google-beta_google_gkeonprem_bare_metal_admin_cluster` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  cluster_operations:: {
