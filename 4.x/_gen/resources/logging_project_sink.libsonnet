...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCustomWriterIdentity':: d.fn(help='`google-beta.string.withCustomWriterIdentity` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the custom_writer_identity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `custom_writer_identity` field.\n', args=[]),
  withCustomWriterIdentity(resourceLabel, value): {
    resource+: {
      google_logging_project_sink+: {
        [resourceLabel]+: {
          custom_writer_identity: value,
        },
      },
    },
  },
