...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  http_check:: {
    ...
    ping_config:: {
      '#new':: d.fn(help='\n`google-beta.google_monitoring_uptime_check_config.http_check.ping_config.new` constructs a new object with attributes and blocks configured for the `ping_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `pings_count` (`number`): Number of ICMP pings. A maximum of 3 ICMP pings is currently supported.\n\n**Returns**:\n  - An attribute object that represents the `ping_config` sub block.\n', args=[]),
      new(
        pings_count
      ):: std.prune(a={
  ...
  tcp_check:: {
    ...
    ping_config:: {
      '#new':: d.fn(help='\n`google-beta.google_monitoring_uptime_check_config.tcp_check.ping_config.new` constructs a new object with attributes and blocks configured for the `ping_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `pings_count` (`number`): Number of ICMP pings. A maximum of 3 ICMP pings is currently supported.\n\n**Returns**:\n  - An attribute object that represents the `ping_config` sub block.\n', args=[]),
      new(
        pings_count
      ):: std.prune(a={
        pings_count: pings_count,
  ...
  '#withSyntheticMonitorMixin':: d.fn(help='`google-beta.list[obj].withSyntheticMonitorMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the synthetic_monitor field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withSyntheticMonitor](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `synthetic_monitor` field.\n', args=[]),
