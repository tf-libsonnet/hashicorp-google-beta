...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    display_name,
    description=null,
    is_default_negative_intent=null,
    is_default_welcome_intent=null,
    is_fallback=null,
    labels=null,
    language_code=null,
    parameters=null,
  ...
  '#withIsDefaultNegativeIntent':: d.fn(help='`google-beta.bool.withIsDefaultNegativeIntent` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the is_default_negative_intent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `is_default_negative_intent` field.\n', args=[]),
  withIsDefaultNegativeIntent(resourceLabel, value): {
    resource+: {
      google_dialogflow_cx_intent+: {
        [resourceLabel]+: {
          is_default_negative_intent: value,
        },
      },
    },
  },
  '#withIsDefaultWelcomeIntent':: d.fn(help='`google-beta.bool.withIsDefaultWelcomeIntent` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the is_default_welcome_intent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `is_default_welcome_intent` field.\n', args=[]),
  withIsDefaultWelcomeIntent(resourceLabel, value): {
    resource+: {
      google_dialogflow_cx_intent+: {
        [resourceLabel]+: {
          is_default_welcome_intent: value,
        },
      },
    },
  },
