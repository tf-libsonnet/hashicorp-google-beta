...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnabled':: d.fn(help='`google-beta.google_secret_manager_secret_version.withEnabled` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withSecret':: d.fn(help='`google-beta.google_secret_manager_secret_version.withSecret` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`\nTerraform resource block to set or update the secret field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret` field.\n', args=[]),
  ...
  '#withSecretData':: d.fn(help='`google-beta.google_secret_manager_secret_version.withSecretData` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`\nTerraform resource block to set or update the secret_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `secret_data` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_secret_manager_secret_version.withTimeouts` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_secret_manager_secret_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_secret_manager_secret_version`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_secret_manager_secret_version.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
