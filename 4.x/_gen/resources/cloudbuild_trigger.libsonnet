...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    bitbucket_server_trigger_config=null,
    build=null,
    description=null,
    disabled=null,
    filename=null,
  ...
  '#withBitbucketServerTriggerConfig':: d.fn(help='`google-beta.list[obj].withBitbucketServerTriggerConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the bitbucket_server_trigger_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withBitbucketServerTriggerConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `bitbucket_server_trigger_config` field.\n', args=[]),
  withBitbucketServerTriggerConfig(resourceLabel, value): {
    resource+: {
      google_cloudbuild_trigger+: {
        [resourceLabel]+: {
          bitbucket_server_trigger_config: value,
        },
      },
    },
  },
  '#withBitbucketServerTriggerConfigMixin':: d.fn(help='`google-beta.list[obj].withBitbucketServerTriggerConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the bitbucket_server_trigger_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withBitbucketServerTriggerConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `bitbucket_server_trigger_config` field.\n', args=[]),
  withBitbucketServerTriggerConfigMixin(resourceLabel, value): {
    resource+: {
      google_cloudbuild_trigger+: {
        [resourceLabel]+: {
          bitbucket_server_trigger_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
