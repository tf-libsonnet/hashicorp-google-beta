...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFailoverRatio':: d.fn(help='`google-beta.number.withFailoverRatio` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the failover_ratio field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `failover_ratio` field.\n', args=[]),
