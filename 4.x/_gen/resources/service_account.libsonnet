...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccountId':: d.fn(help='`google-beta.string.withAccountId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `account_id` field.\n', args=[]),
  ...
  '#withCreateIgnoreAlreadyExists':: d.fn(help='`google-beta.bool.withCreateIgnoreAlreadyExists` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the create_ignore_already_exists field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `create_ignore_already_exists` field.\n', args=[]),
  withCreateIgnoreAlreadyExists(resourceLabel, value): {
    resource+: {
      google_service_account+: {
        [resourceLabel]+: {
          create_ignore_already_exists: value,
        },
      },
    },
  },
