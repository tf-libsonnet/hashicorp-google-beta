...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCustomAudiences':: d.fn(help='`google-beta.list.withCustomAudiences` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the custom_audiences field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `custom_audiences` field.\n', args=[]),
  withCustomAudiences(resourceLabel, value): {
    resource+: {
      google_cloud_run_v2_service+: {
        [resourceLabel]+: {
          custom_audiences: value,
        },
      },
    },
  },
