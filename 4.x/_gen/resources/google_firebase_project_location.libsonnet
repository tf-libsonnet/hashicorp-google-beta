...
{
  '#':: d.pkg(name='google_firebase_project_location', url='', help='`google_firebase_project_location` represents the `google-beta_google_firebase_project_location` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLocationId':: d.fn(help='`google-beta.google_firebase_project_location.withLocationId` constructs a mixin object that can be merged into the `google_firebase_project_location`\nTerraform resource block to set or update the location_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location_id` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_firebase_project_location.withProject` constructs a mixin object that can be merged into the `google_firebase_project_location`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_firebase_project_location.withTimeouts` constructs a mixin object that can be merged into the `google_firebase_project_location`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_firebase_project_location.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_firebase_project_location`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_firebase_project_location.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
