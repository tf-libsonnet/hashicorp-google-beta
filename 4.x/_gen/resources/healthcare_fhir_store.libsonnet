...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    enable_history_modifications=null,
  ...
  notification_configs:: {
    ...
    new(
      ...
      send_previous_resource_on_delete=null
    ):: std.prune(a={
      pubsub_topic: pubsub_topic,
  ...
  '#withEnableHistoryModifications':: d.fn(help='`google-beta.bool.withEnableHistoryModifications` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_history_modifications field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_history_modifications` field.\n', args=[]),
  withEnableHistoryModifications(resourceLabel, value): {
    resource+: {
      google_healthcare_fhir_store+: {
        [resourceLabel]+: {
          enable_history_modifications: value,
        },
      },
    },
  },
  '#withEnableUpdateCreate':: d.fn(help='`google-beta.bool.withEnableUpdateCreate` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_update_create field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_update_create` field.\n', args=[]),
  ...
  '#withNotificationConfigsMixin':: d.fn(help='`google-beta.list[obj].withNotificationConfigsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the notification_configs field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withNotificationConfigs](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `notification_configs` field.\n', args=[]),
