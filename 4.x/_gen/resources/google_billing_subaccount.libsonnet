...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeletionPolicy':: d.fn(help='`google-beta.google_billing_subaccount.withDeletionPolicy` constructs a mixin object that can be merged into the `google_billing_subaccount`\nTerraform resource block to set or update the deletion_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deletion_policy` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google-beta.google_billing_subaccount.withDisplayName` constructs a mixin object that can be merged into the `google_billing_subaccount`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withMasterBillingAccount':: d.fn(help='`google-beta.google_billing_subaccount.withMasterBillingAccount` constructs a mixin object that can be merged into the `google_billing_subaccount`\nTerraform resource block to set or update the master_billing_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `master_billing_account` field.\n', args=[]),
