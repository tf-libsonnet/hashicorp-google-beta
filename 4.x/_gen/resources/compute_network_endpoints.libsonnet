...
{
  '#':: d.pkg(name='google_compute_network_endpoints', url='', help='`google_compute_network_endpoints` represents the `google-beta_google_compute_network_endpoints` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  network_endpoints:: {
  ...
  '#withNetworkEndpointsMixin':: d.fn(help='`google-beta.list[obj].withNetworkEndpointsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the network_endpoints field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withNetworkEndpoints](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `network_endpoints` field.\n', args=[]),
