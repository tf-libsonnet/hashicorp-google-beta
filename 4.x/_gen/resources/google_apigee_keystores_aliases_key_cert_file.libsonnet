...
{
  '#':: d.pkg(name='google_apigee_keystores_aliases_key_cert_file', url='', help='`google_apigee_keystores_aliases_key_cert_file` represents the `google-beta_google_apigee_keystores_aliases_key_cert_file` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  certs_info:: {
    cert_info:: {
  ...
  '#withCert':: d.fn(help='`google-beta.string.withCert` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the cert field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `cert` field.\n', args=[]),
  ...
  '#withCertsInfoMixin':: d.fn(help='`google-beta.list[obj].withCertsInfoMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the certs_info field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withCertsInfo](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `certs_info` field.\n', args=[]),
