...
{
  '#':: d.pkg(name='google_database_migration_service_private_connection', url='', help='`google_database_migration_service_private_connection` represents the `google-beta_google_database_migration_service_private_connection` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
