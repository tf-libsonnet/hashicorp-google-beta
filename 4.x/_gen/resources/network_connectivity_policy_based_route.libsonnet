...
{
  '#':: d.pkg(name='google_network_connectivity_policy_based_route', url='', help='`google_network_connectivity_policy_based_route` represents the `google-beta_google_network_connectivity_policy_based_route` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  filter:: {
  ...
  '#withInterconnectAttachmentMixin':: d.fn(help='`google-beta.list[obj].withInterconnectAttachmentMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the interconnect_attachment field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withInterconnectAttachment](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `interconnect_attachment` field.\n', args=[]),
