...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  cluster_config:: {
    ...
    auxiliary_node_groups:: {
      ...
      node_group:: {
        '#new':: d.fn(help='\n`google-beta.google_dataproc_cluster.cluster_config.auxiliary_node_groups.node_group.new` constructs a new object with attributes and blocks configured for the `node_group`\nTerraform sub block.\n\n\n\n**Args**:\n  - `roles` (`list`): Node group roles.\n  - `node_group_config` (`list[obj]`): The node group instance group configuration. When `null`, the `node_group_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_dataproc_cluster.cluster_config.auxiliary_node_groups.node_group.node_group_config.new](#fn-cluster_configcluster_configauxiliary_node_groupsnode_group_confignew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `node_group` sub block.\n', args=[]),
        new(
          roles,
          node_group_config=null
        ):: std.prune(a={
    ...
    dataproc_metric_config:: {
      ...
      '#new':: d.fn(help='\n`google-beta.google_dataproc_cluster.cluster_config.dataproc_metric_config.new` constructs a new object with attributes and blocks configured for the `dataproc_metric_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `metrics` (`list[obj]`): Metrics sources to enable. When `null`, the `metrics` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_dataproc_cluster.cluster_config.dataproc_metric_config.metrics.new](#fn-cluster_configcluster_configmetricsnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `dataproc_metric_config` sub block.\n', args=[]),
      new(
        metrics=null
      ):: std.prune(a={
        metrics: metrics,
    ...
    preemptible_worker_config:: {
      ...
      new(
        disk_config=null,
        instance_flexibility_policy=null,
        num_instances=null,
        preemptibility=null
      ):: std.prune(a={
        disk_config: disk_config,
  ...
  '#withClusterConfigMixin':: d.fn(help='`google-beta.list[obj].withClusterConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the cluster_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withClusterConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `cluster_config` field.\n', args=[]),
  ...
  '#withVirtualClusterConfigMixin':: d.fn(help='`google-beta.list[obj].withVirtualClusterConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the virtual_cluster_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withVirtualClusterConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `virtual_cluster_config` field.\n', args=[]),
