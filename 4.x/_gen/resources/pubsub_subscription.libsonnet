...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCloudStorageConfig':: d.fn(help='`google-beta.list[obj].withCloudStorageConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the cloud_storage_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withCloudStorageConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `cloud_storage_config` field.\n', args=[]),
  withCloudStorageConfig(resourceLabel, value): {
    resource+: {
      google_pubsub_subscription+: {
        [resourceLabel]+: {
          cloud_storage_config: value,
        },
      },
    },
  },
  '#withCloudStorageConfigMixin':: d.fn(help='`google-beta.list[obj].withCloudStorageConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the cloud_storage_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withCloudStorageConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `cloud_storage_config` field.\n', args=[]),
  withCloudStorageConfigMixin(resourceLabel, value): {
    resource+: {
      google_pubsub_subscription+: {
        [resourceLabel]+: {
          cloud_storage_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
