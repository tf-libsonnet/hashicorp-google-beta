...
{
  '#':: d.pkg(name='google_scc_source', url='', help='`google_scc_source` represents the `google-beta_google_scc_source` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`google-beta.google_scc_source.withDescription` constructs a mixin object that can be merged into the `google_scc_source`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google-beta.google_scc_source.withDisplayName` constructs a mixin object that can be merged into the `google_scc_source`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withOrganization':: d.fn(help='`google-beta.google_scc_source.withOrganization` constructs a mixin object that can be merged into the `google_scc_source`\nTerraform resource block to set or update the organization field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organization` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_scc_source.withTimeouts` constructs a mixin object that can be merged into the `google_scc_source`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_scc_source.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_scc_source`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_scc_source.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
