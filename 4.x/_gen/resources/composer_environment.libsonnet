...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  config:: {
    data_retention_config:: {
      ...
      new(
        task_logs_retention_config=null
      ):: std.prune(a={
    ...
    new(
      data_retention_config=null,
      database_config=null,
      enable_private_builds_only=null,
      enable_private_environment=null,
    ...
    node_config:: {
      ...
      new(
        composer_internal_ipv4_cidr_block=null,
        disk_size_gb=null,
    ...
    recovery_config:: {
      ...
      scheduled_snapshots_config:: {
        ...
        new(
          enabled,
          snapshot_creation_schedule=null,
    ...
    software_config:: {
      ...
      new(
        ...
        cloud_data_lineage_integration=null,
        env_variables=null,
        image_version=null,
        pypi_packages=null,
        python_version=null,
        scheduler_count=null,
        web_server_plugins_mode=null
      ):: std.prune(a={
  ...
  '#withStorageConfigMixin':: d.fn(help='`google-beta.list[obj].withStorageConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the storage_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withStorageConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `storage_config` field.\n', args=[]),
