...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  authorization:: {
    admin_groups:: {
      '#new':: d.fn(help='\n`google-beta.google_container_aws_cluster.authorization.admin_groups.new` constructs a new object with attributes and blocks configured for the `admin_groups`\nTerraform sub block.\n\n\n\n**Args**:\n  - `group` (`string`): The name of the group, e.g. `my-group@domain.com`.\n\n**Returns**:\n  - An attribute object that represents the `admin_groups` sub block.\n', args=[]),
      new(
        group
      ):: std.prune(a={
        group: group,
