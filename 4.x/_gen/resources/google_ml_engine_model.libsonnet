...
{
  '#':: d.pkg(name='google_ml_engine_model', url='', help='`google_ml_engine_model` represents the `google-beta_google_ml_engine_model` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  default_version:: {
    '#new':: d.fn(help='\n`google-beta.google_ml_engine_model.default_version.new` constructs a new object with attributes and blocks configured for the `default_version`\nTerraform sub block.\n\n\n\n**Args**:\n  - `name` (`string`): The name specified for the version when it was created.\n\n**Returns**:\n  - An attribute object that represents the `default_version` sub block.\n', args=[]),
    new(
      name
    ):: std.prune(a={
      name: name,
  ...
  '#withDefaultVersion':: d.fn(help='`google-beta.list[obj].withDefaultVersion` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the default_version field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withDefaultVersionMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `default_version` field.\n', args=[]),
  ...
  '#withDefaultVersionMixin':: d.fn(help='`google-beta.list[obj].withDefaultVersionMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the default_version field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withDefaultVersion](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `default_version` field.\n', args=[]),
