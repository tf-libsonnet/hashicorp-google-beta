...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClassificationThreshold':: d.fn(help='`google-beta.number.withClassificationThreshold` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the classification_threshold field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `classification_threshold` field.\n', args=[]),
  ...
  '#withMatchMode':: d.fn(help='`google-beta.string.withMatchMode` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the match_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `match_mode` field.\n', args=[]),
