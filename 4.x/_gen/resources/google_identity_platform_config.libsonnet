...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAutodeleteAnonymousUsers':: d.fn(help='`google-beta.google_identity_platform_config.withAutodeleteAnonymousUsers` constructs a mixin object that can be merged into the `google_identity_platform_config`\nTerraform resource block to set or update the autodelete_anonymous_users field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `autodelete_anonymous_users` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_identity_platform_config.withProject` constructs a mixin object that can be merged into the `google_identity_platform_config`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_identity_platform_config.withTimeouts` constructs a mixin object that can be merged into the `google_identity_platform_config`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_identity_platform_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_identity_platform_config`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_identity_platform_config.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
