...
{
  '#':: d.pkg(name='google_vertex_ai_feature_group', url='', help='`google_vertex_ai_feature_group` represents the `google-beta_google_vertex_ai_feature_group` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  big_query:: {
    big_query_source:: {
  ...
  '#withBigQueryMixin':: d.fn(help='`google-beta.list[obj].withBigQueryMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the big_query field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withBigQuery](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `big_query` field.\n', args=[]),
