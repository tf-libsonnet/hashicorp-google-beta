...
{
  '#':: d.pkg(name='google_network_security_url_lists', url='', help='`google_network_security_url_lists` represents the `google-beta_google_network_security_url_lists` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withValues':: d.fn(help='`google-beta.list.withValues` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the values field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `values` field.\n', args=[]),
