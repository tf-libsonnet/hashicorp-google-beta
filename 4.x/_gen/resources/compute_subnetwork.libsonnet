...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAllowSubnetCidrRoutesOverlap':: d.fn(help='`google-beta.bool.withAllowSubnetCidrRoutesOverlap` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the allow_subnet_cidr_routes_overlap field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `allow_subnet_cidr_routes_overlap` field.\n', args=[]),
  withAllowSubnetCidrRoutesOverlap(resourceLabel, value): {
    resource+: {
      google_compute_subnetwork+: {
        [resourceLabel]+: {
          allow_subnet_cidr_routes_overlap: value,
        },
      },
    },
  },
  ...
  '#withExternalIpv6Prefix':: d.fn(help='`google-beta.string.withExternalIpv6Prefix` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the external_ipv6_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `external_ipv6_prefix` field.\n', args=[]),
  withExternalIpv6Prefix(resourceLabel, value): {
    resource+: {
      google_compute_subnetwork+: {
        [resourceLabel]+: {
          external_ipv6_prefix: value,
        },
      },
    },
  },
