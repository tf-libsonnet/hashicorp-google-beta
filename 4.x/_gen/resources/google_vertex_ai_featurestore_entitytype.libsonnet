...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withOfflineStorageTtlDays':: d.fn(help='`google-beta.number.withOfflineStorageTtlDays` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the offline_storage_ttl_days field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `offline_storage_ttl_days` field.\n', args=[]),
  withOfflineStorageTtlDays(resourceLabel, value): {
    resource+: {
      google_vertex_ai_featurestore_entitytype+: {
        [resourceLabel]+: {
          offline_storage_ttl_days: value,
        },
      },
    },
  },
