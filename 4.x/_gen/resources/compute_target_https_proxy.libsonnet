...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCertificateManagerCertificates':: d.fn(help='`google-beta.list.withCertificateManagerCertificates` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the certificate_manager_certificates field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `certificate_manager_certificates` field.\n', args=[]),
  withCertificateManagerCertificates(resourceLabel, value): {
    resource+: {
      google_compute_target_https_proxy+: {
        [resourceLabel]+: {
          certificate_manager_certificates: value,
        },
      },
    },
  },
