...
{
  '#':: d.pkg(name='google_scc_source_iam_policy', url='', help='`google_scc_source_iam_policy` represents the `google-beta_google_scc_source_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withOrganization':: d.fn(help='`google-beta.google_scc_source_iam_policy.withOrganization` constructs a mixin object that can be merged into the `google_scc_source_iam_policy`\nTerraform resource block to set or update the organization field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organization` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google-beta.google_scc_source_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `google_scc_source_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withSource':: d.fn(help='`google-beta.google_scc_source_iam_policy.withSource` constructs a mixin object that can be merged into the `google_scc_source_iam_policy`\nTerraform resource block to set or update the source field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `source` field.\n', args=[]),
