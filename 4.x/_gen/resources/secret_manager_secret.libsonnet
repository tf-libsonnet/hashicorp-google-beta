...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withVersionAliases':: d.fn(help='`google-beta.obj.withVersionAliases` constructs a mixin object that can be merged into the `obj`\nTerraform resource block to set or update the version_aliases field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`obj`): The value to set for the `version_aliases` field.\n', args=[]),
  withVersionAliases(resourceLabel, value): {
    resource+: {
      google_secret_manager_secret+: {
        [resourceLabel]+: {
          version_aliases: value,
        },
      },
    },
  },
