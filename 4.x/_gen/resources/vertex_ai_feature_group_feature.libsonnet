...
{
  '#':: d.pkg(name='google_vertex_ai_feature_group_feature', url='', help='`google_vertex_ai_feature_group_feature` represents the `google-beta_google_vertex_ai_feature_group_feature` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withFeatureGroup':: d.fn(help='`google-beta.string.withFeatureGroup` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the feature_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `feature_group` field.\n', args=[]),
