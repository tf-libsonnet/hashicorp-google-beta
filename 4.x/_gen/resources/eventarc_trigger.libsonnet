...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEventDataContentType':: d.fn(help='`google-beta.string.withEventDataContentType` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the event_data_content_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `event_data_content_type` field.\n', args=[]),
  withEventDataContentType(resourceLabel, value): {
    resource+: {
      google_eventarc_trigger+: {
        [resourceLabel]+: {
          event_data_content_type: value,
        },
      },
    },
  },
