...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDeployParameters':: d.fn(help='`google-beta.obj.withDeployParameters` constructs a mixin object that can be merged into the `obj`\nTerraform resource block to set or update the deploy_parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`obj`): The value to set for the `deploy_parameters` field.\n', args=[]),
  withDeployParameters(resourceLabel, value): {
    resource+: {
      google_clouddeploy_target+: {
        [resourceLabel]+: {
  ...
  '#withMultiTargetMixin':: d.fn(help='`google-beta.list[obj].withMultiTargetMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the multi_target field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withMultiTarget](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `multi_target` field.\n', args=[]),
  withMultiTargetMixin(resourceLabel, value): {
    resource+: {
      google_clouddeploy_target+: {
        [resourceLabel]+: {
          multi_target+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
