...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisableVpcPeering':: d.fn(help='`google-beta.bool.withDisableVpcPeering` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the disable_vpc_peering field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `disable_vpc_peering` field.\n', args=[]),
  withDisableVpcPeering(resourceLabel, value): {
    resource+: {
      google_apigee_organization+: {
        [resourceLabel]+: {
          disable_vpc_peering: value,
        },
      },
    },
  },
