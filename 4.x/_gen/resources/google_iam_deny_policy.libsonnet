...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisplayName':: d.fn(help='`google-beta.google_iam_deny_policy.withDisplayName` constructs a mixin object that can be merged into the `google_iam_deny_policy`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google-beta.google_iam_deny_policy.withName` constructs a mixin object that can be merged into the `google_iam_deny_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withParent':: d.fn(help='`google-beta.google_iam_deny_policy.withParent` constructs a mixin object that can be merged into the `google_iam_deny_policy`\nTerraform resource block to set or update the parent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
  ...
  '#withRules':: d.fn(help='`google-beta.google_iam_deny_policy.withRules` constructs a mixin object that can be merged into the `google_iam_deny_policy`\nTerraform resource block to set or update the rules field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rules` field.\n', args=[]),
  ...
  '#withRulesMixin':: d.fn(help='`google-beta.google_iam_deny_policy.withRulesMixin` constructs a mixin object that can be merged into the `google_iam_deny_policy`\nTerraform resource block to set or update the rules field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_iam_deny_policy.withRules](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `rules` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_iam_deny_policy.withTimeouts` constructs a mixin object that can be merged into the `google_iam_deny_policy`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_iam_deny_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_iam_deny_policy`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_iam_deny_policy.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
