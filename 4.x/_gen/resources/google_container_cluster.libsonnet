...
{
  '#':: d.pkg(name='google_container_cluster', url='', help='`google_container_cluster` represents the `google-beta_google_container_cluster` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  addons_config:: {
    cloudrun_config:: {
  ...
  node_pool:: {
    ...
    node_config:: {
      ...
      '#new':: d.fn(help='\n`google-beta.google_container_cluster.node_pool.node_config.new` constructs a new object with attributes and blocks configured for the `node_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `boot_disk_kms_key` (`string`): The Customer Managed Encryption Key used to encrypt the boot disk attached to each node in the node pool. When `null`, the `boot_disk_kms_key` field will be omitted from the resulting object.\n  - `disk_size_gb` (`number`): Size of the disk attached to each node, specified in GB. The smallest allowed disk size is 10GB. When `null`, the `disk_size_gb` field will be omitted from the resulting object.\n  - `disk_type` (`string`): Type of the disk attached to each node. Such as pd-standard, pd-balanced or pd-ssd When `null`, the `disk_type` field will be omitted from the resulting object.\n  - `guest_accelerator` (`list`): List of the type and count of accelerator cards attached to the instance. When `null`, the `guest_accelerator` field will be omitted from the resulting object.\n  - `image_type` (`string`): The image type to use for this node. Note that for a given image type, the latest version of it will be used. When `null`, the `image_type` field will be omitted from the resulting object.\n  - `labels` (`obj`): The map of Kubernetes labels (key/value pairs) to be applied to each node. These will added in addition to any default label(s) that Kubernetes may apply to the node. When `null`, the `labels` field will be omitted from the resulting object.\n  - `local_ssd_count` (`number`): The number of local SSD disks to be attached to the node. When `null`, the `local_ssd_count` field will be omitted from the resulting object.\n  - `logging_variant` (`string`): Type of logging agent that is used as the default value for node pools in the cluster. Valid values include DEFAULT and MAX_THROUGHPUT. When `null`, the `logging_variant` field will be omitted from the resulting object.\n  - `machine_type` (`string`): The name of a Google Compute Engine machine type. When `null`, the `machine_type` field will be omitted from the resulting object.\n  - `metadata` (`obj`): The metadata key/value pairs assigned to instances in the cluster. When `null`, the `metadata` field will be omitted from the resulting object.\n  - `min_cpu_platform` (`string`): Minimum CPU platform to be used by this instance. The instance may be scheduled on the specified or newer CPU platform. When `null`, the `min_cpu_platform` field will be omitted from the resulting object.\n  - `node_group` (`string`): Setting this field will assign instances of this pool to run on the specified node group. This is useful for running workloads on sole tenant nodes. When `null`, the `node_group` field will be omitted from the resulting object.\n  - `oauth_scopes` (`list`): The set of Google API scopes to be made available on all of the node VMs. When `null`, the `oauth_scopes` field will be omitted from the resulting object.\n  - `preemptible` (`bool`): Whether the nodes are created as preemptible VM instances. When `null`, the `preemptible` field will be omitted from the resulting object.\n  - `resource_labels` (`obj`): The GCE resource labels (a map of key/value pairs) to be applied to the node pool. When `null`, the `resource_labels` field will be omitted from the resulting object.\n  - `service_account` (`string`): The Google Cloud Platform Service Account to be used by the node VMs. When `null`, the `service_account` field will be omitted from the resulting object.\n  - `spot` (`bool`): Whether the nodes are created as spot VM instances. When `null`, the `spot` field will be omitted from the resulting object.\n  - `tags` (`list`): The list of instance tags applied to all nodes. When `null`, the `tags` field will be omitted from the resulting object.\n  - `taint` (`list`): List of Kubernetes taints to be applied to each node. When `null`, the `taint` field will be omitted from the resulting object.\n  - `ephemeral_storage_config` (`list[obj]`): Parameters for the ephemeral storage filesystem. When `null`, the `ephemeral_storage_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.ephemeral_storage_config.new](#fn-nodeconfigephemeralstorageconfignew) constructor.\n  - `gcfs_config` (`list[obj]`): GCFS configuration for this node. When `null`, the `gcfs_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.gcfs_config.new](#fn-nodeconfiggcfsconfignew) constructor.\n  - `gvnic` (`list[obj]`): Enable or disable gvnic in the node pool. When `null`, the `gvnic` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.gvnic.new](#fn-nodeconfiggvnicnew) constructor.\n  - `kubelet_config` (`list[obj]`): Node kubelet configs. When `null`, the `kubelet_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.kubelet_config.new](#fn-nodeconfigkubeletconfignew) constructor.\n  - `linux_node_config` (`list[obj]`): Parameters that can be configured on Linux nodes. When `null`, the `linux_node_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.linux_node_config.new](#fn-nodeconfiglinuxnodeconfignew) constructor.\n  - `reservation_affinity` (`list[obj]`): The reservation affinity configuration for the node pool. When `null`, the `reservation_affinity` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.reservation_affinity.new](#fn-nodeconfigreservationaffinitynew) constructor.\n  - `sandbox_config` (`list[obj]`): Sandbox configuration for this node. When `null`, the `sandbox_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.sandbox_config.new](#fn-nodeconfigsandboxconfignew) constructor.\n  - `shielded_instance_config` (`list[obj]`): Shielded Instance options. When `null`, the `shielded_instance_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.shielded_instance_config.new](#fn-nodeconfigshieldedinstanceconfignew) constructor.\n  - `workload_metadata_config` (`list[obj]`): The workload metadata configuration for this node. When `null`, the `workload_metadata_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_container_cluster.node_pool.node_config.workload_metadata_config.new](#fn-nodeconfigworkloadmetadataconfignew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `node_config` sub block.\n', args=[]),
      new(
        boot_disk_kms_key=null,
        disk_size_gb=null,
        disk_type=null,
  ...
  '#withAddonsConfig':: d.fn(help='`google-beta.google_container_cluster.withAddonsConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the addons_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `addons_config` field.\n', args=[]),
  ...
  '#withAddonsConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withAddonsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the addons_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withAddonsConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `addons_config` field.\n', args=[]),
  ...
  '#withAuthenticatorGroupsConfig':: d.fn(help='`google-beta.google_container_cluster.withAuthenticatorGroupsConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the authenticator_groups_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authenticator_groups_config` field.\n', args=[]),
  ...
  '#withAuthenticatorGroupsConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withAuthenticatorGroupsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the authenticator_groups_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withAuthenticatorGroupsConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authenticator_groups_config` field.\n', args=[]),
  ...
  '#withBinaryAuthorization':: d.fn(help='`google-beta.google_container_cluster.withBinaryAuthorization` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the binary_authorization field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `binary_authorization` field.\n', args=[]),
  ...
  '#withBinaryAuthorizationMixin':: d.fn(help='`google-beta.google_container_cluster.withBinaryAuthorizationMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the binary_authorization field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withBinaryAuthorization](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `binary_authorization` field.\n', args=[]),
  ...
  '#withClusterAutoscaling':: d.fn(help='`google-beta.google_container_cluster.withClusterAutoscaling` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the cluster_autoscaling field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_autoscaling` field.\n', args=[]),
  ...
  '#withClusterAutoscalingMixin':: d.fn(help='`google-beta.google_container_cluster.withClusterAutoscalingMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the cluster_autoscaling field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withClusterAutoscaling](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_autoscaling` field.\n', args=[]),
  ...
  '#withClusterIpv4Cidr':: d.fn(help='`google-beta.google_container_cluster.withClusterIpv4Cidr` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the cluster_ipv4_cidr field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_ipv4_cidr` field.\n', args=[]),
  ...
  '#withClusterTelemetry':: d.fn(help='`google-beta.google_container_cluster.withClusterTelemetry` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the cluster_telemetry field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_telemetry` field.\n', args=[]),
  withClusterTelemetry(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          cluster_telemetry: value,
        },
      },
    },
  },
  '#withClusterTelemetryMixin':: d.fn(help='`google-beta.google_container_cluster.withClusterTelemetryMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the cluster_telemetry field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withClusterTelemetry](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_telemetry` field.\n', args=[]),
  withClusterTelemetryMixin(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          cluster_telemetry+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withConfidentialNodes':: d.fn(help='`google-beta.google_container_cluster.withConfidentialNodes` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the confidential_nodes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `confidential_nodes` field.\n', args=[]),
  ...
  '#withConfidentialNodesMixin':: d.fn(help='`google-beta.google_container_cluster.withConfidentialNodesMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the confidential_nodes field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withConfidentialNodes](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `confidential_nodes` field.\n', args=[]),
  ...
  '#withCostManagementConfig':: d.fn(help='`google-beta.google_container_cluster.withCostManagementConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the cost_management_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cost_management_config` field.\n', args=[]),
  ...
  '#withCostManagementConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withCostManagementConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the cost_management_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withCostManagementConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cost_management_config` field.\n', args=[]),
  ...
  '#withDatabaseEncryption':: d.fn(help='`google-beta.google_container_cluster.withDatabaseEncryption` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the database_encryption field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_encryption` field.\n', args=[]),
  ...
  '#withDatabaseEncryptionMixin':: d.fn(help='`google-beta.google_container_cluster.withDatabaseEncryptionMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the database_encryption field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withDatabaseEncryption](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database_encryption` field.\n', args=[]),
  ...
  '#withDatapathProvider':: d.fn(help='`google-beta.google_container_cluster.withDatapathProvider` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the datapath_provider field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `datapath_provider` field.\n', args=[]),
  ...
  '#withDefaultMaxPodsPerNode':: d.fn(help='`google-beta.google_container_cluster.withDefaultMaxPodsPerNode` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the default_max_pods_per_node field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_max_pods_per_node` field.\n', args=[]),
  ...
  '#withDefaultSnatStatus':: d.fn(help='`google-beta.google_container_cluster.withDefaultSnatStatus` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the default_snat_status field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_snat_status` field.\n', args=[]),
  ...
  '#withDefaultSnatStatusMixin':: d.fn(help='`google-beta.google_container_cluster.withDefaultSnatStatusMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the default_snat_status field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withDefaultSnatStatus](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_snat_status` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`google-beta.google_container_cluster.withDescription` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDnsConfig':: d.fn(help='`google-beta.google_container_cluster.withDnsConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the dns_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dns_config` field.\n', args=[]),
  ...
  '#withDnsConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withDnsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the dns_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withDnsConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dns_config` field.\n', args=[]),
  ...
  '#withEnableAutopilot':: d.fn(help='`google-beta.google_container_cluster.withEnableAutopilot` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_autopilot field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_autopilot` field.\n', args=[]),
  ...
  '#withEnableBinaryAuthorization':: d.fn(help='`google-beta.google_container_cluster.withEnableBinaryAuthorization` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_binary_authorization field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_binary_authorization` field.\n', args=[]),
  ...
  '#withEnableIntranodeVisibility':: d.fn(help='`google-beta.google_container_cluster.withEnableIntranodeVisibility` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_intranode_visibility field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_intranode_visibility` field.\n', args=[]),
  ...
  '#withEnableKubernetesAlpha':: d.fn(help='`google-beta.google_container_cluster.withEnableKubernetesAlpha` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_kubernetes_alpha field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_kubernetes_alpha` field.\n', args=[]),
  ...
  '#withEnableL4IlbSubsetting':: d.fn(help='`google-beta.google_container_cluster.withEnableL4IlbSubsetting` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_l4_ilb_subsetting field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_l4_ilb_subsetting` field.\n', args=[]),
  ...
  '#withEnableLegacyAbac':: d.fn(help='`google-beta.google_container_cluster.withEnableLegacyAbac` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_legacy_abac field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_legacy_abac` field.\n', args=[]),
  ...
  '#withEnableShieldedNodes':: d.fn(help='`google-beta.google_container_cluster.withEnableShieldedNodes` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_shielded_nodes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_shielded_nodes` field.\n', args=[]),
  ...
  '#withEnableTpu':: d.fn(help='`google-beta.google_container_cluster.withEnableTpu` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the enable_tpu field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_tpu` field.\n', args=[]),
  ...
  '#withIdentityServiceConfig':: d.fn(help='`google-beta.google_container_cluster.withIdentityServiceConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the identity_service_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity_service_config` field.\n', args=[]),
  withIdentityServiceConfig(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          identity_service_config: value,
        },
      },
    },
  },
  '#withIdentityServiceConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withIdentityServiceConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the identity_service_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withIdentityServiceConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `identity_service_config` field.\n', args=[]),
  withIdentityServiceConfigMixin(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          identity_service_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withInitialNodeCount':: d.fn(help='`google-beta.google_container_cluster.withInitialNodeCount` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the initial_node_count field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `initial_node_count` field.\n', args=[]),
  ...
  '#withIpAllocationPolicy':: d.fn(help='`google-beta.google_container_cluster.withIpAllocationPolicy` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the ip_allocation_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_allocation_policy` field.\n', args=[]),
  ...
  '#withIpAllocationPolicyMixin':: d.fn(help='`google-beta.google_container_cluster.withIpAllocationPolicyMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the ip_allocation_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withIpAllocationPolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_allocation_policy` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google-beta.google_container_cluster.withLocation` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withLoggingConfig':: d.fn(help='`google-beta.google_container_cluster.withLoggingConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the logging_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_config` field.\n', args=[]),
  ...
  '#withLoggingConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withLoggingConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the logging_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withLoggingConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_config` field.\n', args=[]),
  ...
  '#withLoggingService':: d.fn(help='`google-beta.google_container_cluster.withLoggingService` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the logging_service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `logging_service` field.\n', args=[]),
  ...
  '#withMaintenancePolicy':: d.fn(help='`google-beta.google_container_cluster.withMaintenancePolicy` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the maintenance_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `maintenance_policy` field.\n', args=[]),
  ...
  '#withMaintenancePolicyMixin':: d.fn(help='`google-beta.google_container_cluster.withMaintenancePolicyMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the maintenance_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withMaintenancePolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `maintenance_policy` field.\n', args=[]),
  ...
  '#withMasterAuth':: d.fn(help='`google-beta.google_container_cluster.withMasterAuth` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the master_auth field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `master_auth` field.\n', args=[]),
  ...
  '#withMasterAuthMixin':: d.fn(help='`google-beta.google_container_cluster.withMasterAuthMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the master_auth field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withMasterAuth](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `master_auth` field.\n', args=[]),
  ...
  '#withMasterAuthorizedNetworksConfig':: d.fn(help='`google-beta.google_container_cluster.withMasterAuthorizedNetworksConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the master_authorized_networks_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `master_authorized_networks_config` field.\n', args=[]),
  ...
  '#withMasterAuthorizedNetworksConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withMasterAuthorizedNetworksConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the master_authorized_networks_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withMasterAuthorizedNetworksConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `master_authorized_networks_config` field.\n', args=[]),
  ...
  '#withMeshCertificates':: d.fn(help='`google-beta.google_container_cluster.withMeshCertificates` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the mesh_certificates field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mesh_certificates` field.\n', args=[]),
  ...
  '#withMeshCertificatesMixin':: d.fn(help='`google-beta.google_container_cluster.withMeshCertificatesMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the mesh_certificates field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withMeshCertificates](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mesh_certificates` field.\n', args=[]),
  ...
  '#withMinMasterVersion':: d.fn(help='`google-beta.google_container_cluster.withMinMasterVersion` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the min_master_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `min_master_version` field.\n', args=[]),
  ...
  '#withMonitoringConfig':: d.fn(help='`google-beta.google_container_cluster.withMonitoringConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the monitoring_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitoring_config` field.\n', args=[]),
  ...
  '#withMonitoringConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withMonitoringConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the monitoring_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withMonitoringConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitoring_config` field.\n', args=[]),
  ...
  '#withMonitoringService':: d.fn(help='`google-beta.google_container_cluster.withMonitoringService` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the monitoring_service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `monitoring_service` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google-beta.google_container_cluster.withName` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNetwork':: d.fn(help='`google-beta.google_container_cluster.withNetwork` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the network field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network` field.\n', args=[]),
  ...
  '#withNetworkPolicy':: d.fn(help='`google-beta.google_container_cluster.withNetworkPolicy` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the network_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_policy` field.\n', args=[]),
  ...
  '#withNetworkPolicyMixin':: d.fn(help='`google-beta.google_container_cluster.withNetworkPolicyMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the network_policy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withNetworkPolicy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_policy` field.\n', args=[]),
  ...
  '#withNetworkingMode':: d.fn(help='`google-beta.google_container_cluster.withNetworkingMode` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the networking_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `networking_mode` field.\n', args=[]),
  ...
  '#withNodeConfig':: d.fn(help='`google-beta.google_container_cluster.withNodeConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_config` field.\n', args=[]),
  ...
  '#withNodeConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withNodeConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withNodeConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_config` field.\n', args=[]),
  ...
  '#withNodeLocations':: d.fn(help='`google-beta.google_container_cluster.withNodeLocations` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_locations field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_locations` field.\n', args=[]),
  ...
  '#withNodePool':: d.fn(help='`google-beta.google_container_cluster.withNodePool` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_pool field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_pool` field.\n', args=[]),
  ...
  '#withNodePoolAutoConfig':: d.fn(help='`google-beta.google_container_cluster.withNodePoolAutoConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_pool_auto_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_pool_auto_config` field.\n', args=[]),
  withNodePoolAutoConfig(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          node_pool_auto_config: value,
        },
      },
    },
  },
  '#withNodePoolAutoConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withNodePoolAutoConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_pool_auto_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withNodePoolAutoConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_pool_auto_config` field.\n', args=[]),
  withNodePoolAutoConfigMixin(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          node_pool_auto_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withNodePoolDefaults':: d.fn(help='`google-beta.google_container_cluster.withNodePoolDefaults` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_pool_defaults field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_pool_defaults` field.\n', args=[]),
  ...
  '#withNodePoolDefaultsMixin':: d.fn(help='`google-beta.google_container_cluster.withNodePoolDefaultsMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_pool_defaults field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withNodePoolDefaults](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_pool_defaults` field.\n', args=[]),
  ...
  '#withNodePoolMixin':: d.fn(help='`google-beta.google_container_cluster.withNodePoolMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_pool field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withNodePool](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_pool` field.\n', args=[]),
  ...
  '#withNodeVersion':: d.fn(help='`google-beta.google_container_cluster.withNodeVersion` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the node_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `node_version` field.\n', args=[]),
  ...
  '#withNotificationConfig':: d.fn(help='`google-beta.google_container_cluster.withNotificationConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the notification_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notification_config` field.\n', args=[]),
  ...
  '#withNotificationConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withNotificationConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the notification_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withNotificationConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `notification_config` field.\n', args=[]),
  ...
  '#withPodSecurityPolicyConfig':: d.fn(help='`google-beta.google_container_cluster.withPodSecurityPolicyConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the pod_security_policy_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pod_security_policy_config` field.\n', args=[]),
  withPodSecurityPolicyConfig(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          pod_security_policy_config: value,
        },
      },
    },
  },
  '#withPodSecurityPolicyConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withPodSecurityPolicyConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the pod_security_policy_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withPodSecurityPolicyConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `pod_security_policy_config` field.\n', args=[]),
  withPodSecurityPolicyConfigMixin(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          pod_security_policy_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withPrivateClusterConfig':: d.fn(help='`google-beta.google_container_cluster.withPrivateClusterConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the private_cluster_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_cluster_config` field.\n', args=[]),
  ...
  '#withPrivateClusterConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withPrivateClusterConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the private_cluster_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withPrivateClusterConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_cluster_config` field.\n', args=[]),
  ...
  '#withPrivateIpv6GoogleAccess':: d.fn(help='`google-beta.google_container_cluster.withPrivateIpv6GoogleAccess` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the private_ipv6_google_access field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_ipv6_google_access` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_container_cluster.withProject` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withReleaseChannel':: d.fn(help='`google-beta.google_container_cluster.withReleaseChannel` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the release_channel field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `release_channel` field.\n', args=[]),
  ...
  '#withReleaseChannelMixin':: d.fn(help='`google-beta.google_container_cluster.withReleaseChannelMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the release_channel field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withReleaseChannel](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `release_channel` field.\n', args=[]),
  ...
  '#withRemoveDefaultNodePool':: d.fn(help='`google-beta.google_container_cluster.withRemoveDefaultNodePool` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the remove_default_node_pool field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `remove_default_node_pool` field.\n', args=[]),
  ...
  '#withResourceLabels':: d.fn(help='`google-beta.google_container_cluster.withResourceLabels` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the resource_labels field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_labels` field.\n', args=[]),
  ...
  '#withResourceUsageExportConfig':: d.fn(help='`google-beta.google_container_cluster.withResourceUsageExportConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the resource_usage_export_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_usage_export_config` field.\n', args=[]),
  ...
  '#withResourceUsageExportConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withResourceUsageExportConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the resource_usage_export_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withResourceUsageExportConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_usage_export_config` field.\n', args=[]),
  ...
  '#withServiceExternalIpsConfig':: d.fn(help='`google-beta.google_container_cluster.withServiceExternalIpsConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the service_external_ips_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_external_ips_config` field.\n', args=[]),
  ...
  '#withServiceExternalIpsConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withServiceExternalIpsConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the service_external_ips_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withServiceExternalIpsConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_external_ips_config` field.\n', args=[]),
  ...
  '#withSubnetwork':: d.fn(help='`google-beta.google_container_cluster.withSubnetwork` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the subnetwork field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `subnetwork` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_container_cluster.withTimeouts` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_container_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_container_cluster.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTpuConfig':: d.fn(help='`google-beta.google_container_cluster.withTpuConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the tpu_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tpu_config` field.\n', args=[]),
  withTpuConfig(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          tpu_config: value,
  ...
  '#withTpuConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withTpuConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the tpu_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withTpuConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tpu_config` field.\n', args=[]),
  withTpuConfigMixin(resourceLabel, value):: {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          tpu_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withVerticalPodAutoscaling':: d.fn(help='`google-beta.google_container_cluster.withVerticalPodAutoscaling` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the vertical_pod_autoscaling field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vertical_pod_autoscaling` field.\n', args=[]),
  ...
  '#withVerticalPodAutoscalingMixin':: d.fn(help='`google-beta.google_container_cluster.withVerticalPodAutoscalingMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the vertical_pod_autoscaling field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withVerticalPodAutoscaling](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vertical_pod_autoscaling` field.\n', args=[]),
  ...
  '#withWorkloadIdentityConfig':: d.fn(help='`google-beta.google_container_cluster.withWorkloadIdentityConfig` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the workload_identity_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workload_identity_config` field.\n', args=[]),
  ...
  '#withWorkloadIdentityConfigMixin':: d.fn(help='`google-beta.google_container_cluster.withWorkloadIdentityConfigMixin` constructs a mixin object that can be merged into the `google_container_cluster`\nTerraform resource block to set or update the workload_identity_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_container_cluster.withWorkloadIdentityConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `workload_identity_config` field.\n', args=[]),
