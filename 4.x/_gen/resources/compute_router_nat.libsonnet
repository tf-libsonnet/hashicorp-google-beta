  ...
  rules:: {
    action:: {
      ...
      new(
        ...
        source_nat_active_ranges=null,
        source_nat_drain_ips=null,
        source_nat_drain_ranges=null
      ):: std.prune(a={
