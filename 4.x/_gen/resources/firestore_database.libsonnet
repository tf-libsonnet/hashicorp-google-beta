...
{
  '#':: d.pkg(name='google_firestore_database', url='', help='`google_firestore_database` represents the `google-beta_google_firestore_database` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withConcurrencyMode':: d.fn(help='`google-beta.string.withConcurrencyMode` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the concurrency_mode field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `concurrency_mode` field.\n', args=[]),
  ...
  '#withDeleteProtectionState':: d.fn(help='`google-beta.string.withDeleteProtectionState` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the delete_protection_state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `delete_protection_state` field.\n', args=[]),
  withDeleteProtectionState(resourceLabel, value): {
    resource+: {
      google_firestore_database+: {
        [resourceLabel]+: {
          delete_protection_state: value,
        },
      },
    },
  },
