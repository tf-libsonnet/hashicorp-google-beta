...
{
  '#':: d.pkg(name='google_workstations_workstation_config_iam_member', url='', help='`google_workstations_workstation_config_iam_member` represents the `google-beta_google_workstations_workstation_config_iam_member` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  condition:: {
  ...
  new(
    ...
    type='google_workstations_workstation_config_iam_member',
    label=resourceLabel,
    attrs=self.newAttrs(
      condition=condition,
      location=location,
