...
{
  '#':: d.pkg(name='google_network_connectivity_hub', url='', help='`google_network_connectivity_hub` represents the `google-beta_google_network_connectivity_hub` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`google-beta.google_network_connectivity_hub.withDescription` constructs a mixin object that can be merged into the `google_network_connectivity_hub`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withLabels':: d.fn(help='`google-beta.google_network_connectivity_hub.withLabels` constructs a mixin object that can be merged into the `google_network_connectivity_hub`\nTerraform resource block to set or update the labels field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `labels` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google-beta.google_network_connectivity_hub.withName` constructs a mixin object that can be merged into the `google_network_connectivity_hub`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_network_connectivity_hub.withProject` constructs a mixin object that can be merged into the `google_network_connectivity_hub`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_network_connectivity_hub.withTimeouts` constructs a mixin object that can be merged into the `google_network_connectivity_hub`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_network_connectivity_hub.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_network_connectivity_hub`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_network_connectivity_hub.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
