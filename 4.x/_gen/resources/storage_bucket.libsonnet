...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnableObjectRetention':: d.fn(help='`google-beta.bool.withEnableObjectRetention` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_object_retention field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_object_retention` field.\n', args=[]),
  withEnableObjectRetention(resourceLabel, value): {
    resource+: {
      google_storage_bucket+: {
        [resourceLabel]+: {
          enable_object_retention: value,
        },
      },
    },
  },
  ...
  '#withRpo':: d.fn(help='`google-beta.string.withRpo` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the rpo field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `rpo` field.\n', args=[]),
  withRpo(resourceLabel, value): {
    resource+: {
      google_storage_bucket+: {
        [resourceLabel]+: {
          rpo: value,
