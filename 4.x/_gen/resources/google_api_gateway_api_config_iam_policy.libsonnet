...
{
  '#':: d.pkg(name='google_api_gateway_api_config_iam_policy', url='', help='`google_api_gateway_api_config_iam_policy` represents the `google-beta_google_api_gateway_api_config_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withApi':: d.fn(help='`google-beta.google_api_gateway_api_config_iam_policy.withApi` constructs a mixin object that can be merged into the `google_api_gateway_api_config_iam_policy`\nTerraform resource block to set or update the api field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api` field.\n', args=[]),
  ...
  '#withApiConfig':: d.fn(help='`google-beta.google_api_gateway_api_config_iam_policy.withApiConfig` constructs a mixin object that can be merged into the `google_api_gateway_api_config_iam_policy`\nTerraform resource block to set or update the api_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `api_config` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google-beta.google_api_gateway_api_config_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `google_api_gateway_api_config_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_api_gateway_api_config_iam_policy.withProject` constructs a mixin object that can be merged into the `google_api_gateway_api_config_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
