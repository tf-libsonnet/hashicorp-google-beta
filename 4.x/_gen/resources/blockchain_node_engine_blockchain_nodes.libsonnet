...
{
  '#':: d.pkg(name='google_blockchain_node_engine_blockchain_nodes', url='', help='`google_blockchain_node_engine_blockchain_nodes` represents the `google-beta_google_blockchain_node_engine_blockchain_nodes` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ethereum_details:: {
    geth_details:: {
  ...
  timeouts:: {
    '#new':: d.fn(help='\n`google-beta.google_blockchain_node_engine_blockchain_nodes.timeouts.new` constructs a new object with attributes and blocks configured for the `timeouts`\nTerraform sub block.\n\n\n\n**Args**:\n  - `create` (`string`): Set the `create` field on the resulting object. When `null`, the `create` field will be omitted from the resulting object.\n  - `delete` (`string`): Set the `delete` field on the resulting object. When `null`, the `delete` field will be omitted from the resulting object.\n  - `update` (`string`): Set the `update` field on the resulting object. When `null`, the `update` field will be omitted from the resulting object.\n\n**Returns**:\n  - An attribute object that represents the `timeouts` sub block.\n', args=[]),
    new(
      create=null,
      delete=null,
      update=null
  ...
  '#withBlockchainType':: d.fn(help='`google-beta.string.withBlockchainType` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the blockchain_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `blockchain_type` field.\n', args=[]),
  ...
  '#withEthereumDetailsMixin':: d.fn(help='`google-beta.list[obj].withEthereumDetailsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the ethereum_details field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withEthereumDetails](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `ethereum_details` field.\n', args=[]),
