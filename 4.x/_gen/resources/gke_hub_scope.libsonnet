...
{
  '#':: d.pkg(name='google_gke_hub_scope', url='', help='`google_gke_hub_scope` represents the `google-beta_google_gke_hub_scope` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    label=resourceLabel,
    attrs=self.newAttrs(project=project, scope_id=scope_id, timeouts=timeouts),
    _meta=_meta
  ),
