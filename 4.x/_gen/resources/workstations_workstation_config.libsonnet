...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisableTcpConnections':: d.fn(help='`google-beta.bool.withDisableTcpConnections` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the disable_tcp_connections field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `disable_tcp_connections` field.\n', args=[]),
  withDisableTcpConnections(resourceLabel, value): {
    resource+: {
      google_workstations_workstation_config+: {
        [resourceLabel]+: {
          disable_tcp_connections: value,
        },
      },
    },
  },
  ...
  '#withEnableAuditAgent':: d.fn(help='`google-beta.bool.withEnableAuditAgent` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_audit_agent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_audit_agent` field.\n', args=[]),
  withEnableAuditAgent(resourceLabel, value): {
    resource+: {
      google_workstations_workstation_config+: {
        [resourceLabel]+: {
          enable_audit_agent: value,
        },
      },
    },
  },
  ...
  '#withReadinessChecks':: d.fn(help='`google-beta.list[obj].withReadinessChecks` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the readiness_checks field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withReadinessChecksMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `readiness_checks` field.\n', args=[]),
  withReadinessChecks(resourceLabel, value): {
    resource+: {
      google_workstations_workstation_config+: {
        [resourceLabel]+: {
          readiness_checks: value,
        },
      },
    },
  },
  '#withReadinessChecksMixin':: d.fn(help='`google-beta.list[obj].withReadinessChecksMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the readiness_checks field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withReadinessChecks](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `readiness_checks` field.\n', args=[]),
  withReadinessChecksMixin(resourceLabel, value): {
    resource+: {
      google_workstations_workstation_config+: {
        [resourceLabel]+: {
          readiness_checks+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  '#withReplicaZones':: d.fn(help='`google-beta.list.withReplicaZones` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the replica_zones field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `replica_zones` field.\n', args=[]),
