...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLinkedVpcNetwork':: d.fn(help='`google-beta.list[obj].withLinkedVpcNetwork` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the linked_vpc_network field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withLinkedVpcNetworkMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `linked_vpc_network` field.\n', args=[]),
  withLinkedVpcNetwork(resourceLabel, value): {
    resource+: {
      google_network_connectivity_spoke+: {
        [resourceLabel]+: {
          linked_vpc_network: value,
        },
      },
    },
  },
  '#withLinkedVpcNetworkMixin':: d.fn(help='`google-beta.list[obj].withLinkedVpcNetworkMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the linked_vpc_network field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withLinkedVpcNetwork](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `linked_vpc_network` field.\n', args=[]),
  withLinkedVpcNetworkMixin(resourceLabel, value): {
    resource+: {
      google_network_connectivity_spoke+: {
        [resourceLabel]+: {
          linked_vpc_network+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
