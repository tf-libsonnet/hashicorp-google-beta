...
{
  '#':: d.pkg(name='google_firebaserules_release', url='', help='`google_firebaserules_release` represents the `google-beta_google_firebaserules_release` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`google-beta.google_firebaserules_release.withName` constructs a mixin object that can be merged into the `google_firebaserules_release`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_firebaserules_release.withProject` constructs a mixin object that can be merged into the `google_firebaserules_release`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRulesetName':: d.fn(help='`google-beta.google_firebaserules_release.withRulesetName` constructs a mixin object that can be merged into the `google_firebaserules_release`\nTerraform resource block to set or update the ruleset_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ruleset_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_firebaserules_release.withTimeouts` constructs a mixin object that can be merged into the `google_firebaserules_release`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_firebaserules_release.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_firebaserules_release`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_firebaserules_release.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
