...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  timeouts:: {
    '#new':: d.fn(help='\n`google-beta.google_compute_backend_service_signed_url_key.timeouts.new` constructs a new object with attributes and blocks configured for the `timeouts`\nTerraform sub block.\n\n\n\n**Args**:\n  - `create` (`string`):  When `null`, the `create` field will be omitted from the resulting object.\n  - `delete` (`string`):  When `null`, the `delete` field will be omitted from the resulting object.\n\n**Returns**:\n  - An attribute object that represents the `timeouts` sub block.\n', args=[]),
    new(
      create=null,
      delete=null
    ):: std.prune(a={
  ...
  '#withBackendService':: d.fn(help='`google-beta.google_compute_backend_service_signed_url_key.withBackendService` constructs a mixin object that can be merged into the `google_compute_backend_service_signed_url_key`\nTerraform resource block to set or update the backend_service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_service` field.\n', args=[]),
  ...
  '#withKeyValue':: d.fn(help='`google-beta.google_compute_backend_service_signed_url_key.withKeyValue` constructs a mixin object that can be merged into the `google_compute_backend_service_signed_url_key`\nTerraform resource block to set or update the key_value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_value` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google-beta.google_compute_backend_service_signed_url_key.withName` constructs a mixin object that can be merged into the `google_compute_backend_service_signed_url_key`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_compute_backend_service_signed_url_key.withProject` constructs a mixin object that can be merged into the `google_compute_backend_service_signed_url_key`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_compute_backend_service_signed_url_key.withTimeouts` constructs a mixin object that can be merged into the `google_compute_backend_service_signed_url_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_compute_backend_service_signed_url_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_compute_backend_service_signed_url_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_compute_backend_service_signed_url_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
