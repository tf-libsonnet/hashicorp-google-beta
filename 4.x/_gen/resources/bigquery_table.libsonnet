...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMaxStaleness':: d.fn(help='`google-beta.string.withMaxStaleness` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the max_staleness field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `max_staleness` field.\n', args=[]),
  ...
  '#withRequirePartitionFilter':: d.fn(help='`google-beta.bool.withRequirePartitionFilter` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the require_partition_filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `require_partition_filter` field.\n', args=[]),
  withRequirePartitionFilter(resourceLabel, value): {
    resource+: {
      google_bigquery_table+: {
        [resourceLabel]+: {
  ...
  '#withTableConstraintsMixin':: d.fn(help='`google-beta.list[obj].withTableConstraintsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the table_constraints field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withTableConstraints](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `table_constraints` field.\n', args=[]),
  ...
  '#withTableReplicationInfo':: d.fn(help='`google-beta.list[obj].withTableReplicationInfo` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the table_replication_info field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withTableReplicationInfoMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `table_replication_info` field.\n', args=[]),
  withTableReplicationInfo(resourceLabel, value): {
    resource+: {
      google_bigquery_table+: {
        [resourceLabel]+: {
          table_replication_info: value,
        },
      },
    },
  },
  '#withTableReplicationInfoMixin':: d.fn(help='`google-beta.list[obj].withTableReplicationInfoMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the table_replication_info field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withTableReplicationInfo](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `table_replication_info` field.\n', args=[]),
  withTableReplicationInfoMixin(resourceLabel, value): {
    resource+: {
      google_bigquery_table+: {
        [resourceLabel]+: {
          table_replication_info+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
