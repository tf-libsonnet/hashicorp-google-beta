...
{
  '#':: d.pkg(name='google_scc_project_custom_module', url='', help='`google_scc_project_custom_module` represents the `google-beta_google_scc_project_custom_module` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  custom_config:: {
    custom_output:: {
