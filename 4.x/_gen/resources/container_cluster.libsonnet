...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  addons_config:: {
    ...
    new(
      ...
      gcs_fuse_csi_driver_config=null,
  ...
  ip_allocation_policy:: {
    ...
    new(
      additional_pod_ranges_config=null,
  ...
  node_pool:: {
    ...
    node_config:: {
      ...
      taint:: {
        '#new':: d.fn(help='\n`google-beta.google_container_cluster.node_pool.node_config.taint.new` constructs a new object with attributes and blocks configured for the `taint`\nTerraform sub block.\n\n\n\n**Args**:\n  - `effect` (`string`): Effect for taint.\n  - `key` (`string`): Key for taint.\n  - `value` (`string`): Value for taint.\n\n**Returns**:\n  - An attribute object that represents the `taint` sub block.\n', args=[]),
        new(
          effect,
          key,
          value
  ...
  protect_config:: {
    ...
    new(
      ...
      workload_vulnerability_mode=null
    ):: std.prune(a={
  ...
  '#withAllowNetAdmin':: d.fn(help='`google-beta.bool.withAllowNetAdmin` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the allow_net_admin field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `allow_net_admin` field.\n', args=[]),
  withAllowNetAdmin(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          allow_net_admin: value,
        },
      },
    },
  },
  ...
  '#withEnableFqdnNetworkPolicy':: d.fn(help='`google-beta.bool.withEnableFqdnNetworkPolicy` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_fqdn_network_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_fqdn_network_policy` field.\n', args=[]),
  withEnableFqdnNetworkPolicy(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          enable_fqdn_network_policy: value,
        },
      },
    },
  },
  ...
  '#withEnableK8SBetaApis':: d.fn(help='`google-beta.list[obj].withEnableK8SBetaApis` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the enable_k8s_beta_apis field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withEnableK8SBetaApisMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `enable_k8s_beta_apis` field.\n', args=[]),
  withEnableK8SBetaApis(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          enable_k8s_beta_apis: value,
        },
      },
    },
  },
  '#withEnableK8SBetaApisMixin':: d.fn(help='`google-beta.list[obj].withEnableK8SBetaApisMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the enable_k8s_beta_apis field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withEnableK8SBetaApis](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `enable_k8s_beta_apis` field.\n', args=[]),
  withEnableK8SBetaApisMixin(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          enable_k8s_beta_apis+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withEnableMultiNetworking':: d.fn(help='`google-beta.bool.withEnableMultiNetworking` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_multi_networking field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_multi_networking` field.\n', args=[]),
  withEnableMultiNetworking(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          enable_multi_networking: value,
        },
      },
    },
  },
  ...
  '#withGatewayApiConfigMixin':: d.fn(help='`google-beta.list[obj].withGatewayApiConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the gateway_api_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withGatewayApiConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `gateway_api_config` field.\n', args=[]),
  ...
  '#withProtectConfig':: d.fn(help='`google-beta.list[obj].withProtectConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the protect_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withProtectConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `protect_config` field.\n', args=[]),
  withProtectConfig(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          protect_config: value,
        },
      },
    },
  },
  '#withProtectConfigMixin':: d.fn(help='`google-beta.list[obj].withProtectConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the protect_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withProtectConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `protect_config` field.\n', args=[]),
  withProtectConfigMixin(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          protect_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withSecurityPostureConfig':: d.fn(help='`google-beta.list[obj].withSecurityPostureConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the security_posture_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withSecurityPostureConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `security_posture_config` field.\n', args=[]),
  withSecurityPostureConfig(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          security_posture_config: value,
        },
      },
    },
  },
  '#withSecurityPostureConfigMixin':: d.fn(help='`google-beta.list[obj].withSecurityPostureConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the security_posture_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withSecurityPostureConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `security_posture_config` field.\n', args=[]),
  withSecurityPostureConfigMixin(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          security_posture_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withWorkloadAltsConfig':: d.fn(help='`google-beta.list[obj].withWorkloadAltsConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the workload_alts_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withWorkloadAltsConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `workload_alts_config` field.\n', args=[]),
  withWorkloadAltsConfig(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          workload_alts_config: value,
        },
      },
    },
  },
  '#withWorkloadAltsConfigMixin':: d.fn(help='`google-beta.list[obj].withWorkloadAltsConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the workload_alts_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withWorkloadAltsConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `workload_alts_config` field.\n', args=[]),
  withWorkloadAltsConfigMixin(resourceLabel, value): {
    resource+: {
      google_container_cluster+: {
        [resourceLabel]+: {
          workload_alts_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
