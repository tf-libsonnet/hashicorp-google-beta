...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNetworkFirewallPolicyEnforcementOrder':: d.fn(help='`google-beta.string.withNetworkFirewallPolicyEnforcementOrder` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the network_firewall_policy_enforcement_order field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `network_firewall_policy_enforcement_order` field.\n', args=[]),
  withNetworkFirewallPolicyEnforcementOrder(resourceLabel, value): {
    resource+: {
      google_compute_network+: {
        [resourceLabel]+: {
          network_firewall_policy_enforcement_order: value,
        },
      },
    },
  },
