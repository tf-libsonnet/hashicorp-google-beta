...
{
  '#':: d.pkg(name='google_certificate_manager_trust_config', url='', help='`google_certificate_manager_trust_config` represents the `google-beta_google_certificate_manager_trust_config` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withTrustStoresMixin':: d.fn(help='`google-beta.list[obj].withTrustStoresMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the trust_stores field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withTrustStores](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `trust_stores` field.\n', args=[]),
