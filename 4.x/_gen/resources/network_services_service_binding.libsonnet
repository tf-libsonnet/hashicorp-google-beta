...
{
  '#':: d.pkg(name='google_network_services_service_binding', url='', help='`google_network_services_service_binding` represents the `google-beta_google_network_services_service_binding` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    type='google_network_services_service_binding',
    label=resourceLabel,
    attrs=self.newAttrs(
