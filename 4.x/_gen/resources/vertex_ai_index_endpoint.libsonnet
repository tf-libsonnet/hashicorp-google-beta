...
{
  '#':: d.pkg(name='google_vertex_ai_index_endpoint', url='', help='`google_vertex_ai_index_endpoint` represents the `google-beta_google_vertex_ai_index_endpoint` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPrivateServiceConnectConfig':: d.fn(help='`google-beta.list[obj].withPrivateServiceConnectConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the private_service_connect_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withPrivateServiceConnectConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `private_service_connect_config` field.\n', args=[]),
  withPrivateServiceConnectConfig(resourceLabel, value): {
    resource+: {
      google_vertex_ai_index_endpoint+: {
        [resourceLabel]+: {
          private_service_connect_config: value,
        },
      },
    },
  },
  '#withPrivateServiceConnectConfigMixin':: d.fn(help='`google-beta.list[obj].withPrivateServiceConnectConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the private_service_connect_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withPrivateServiceConnectConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `private_service_connect_config` field.\n', args=[]),
  withPrivateServiceConnectConfigMixin(resourceLabel, value): {
    resource+: {
      google_vertex_ai_index_endpoint+: {
        [resourceLabel]+: {
          private_service_connect_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
