...
{
  '#':: d.pkg(name='google_certificate_manager_certificate_issuance_config', url='', help='`google_certificate_manager_certificate_issuance_config` represents the `google-beta_google_certificate_manager_certificate_issuance_config` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCertificateAuthorityConfigMixin':: d.fn(help='`google-beta.list[obj].withCertificateAuthorityConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the certificate_authority_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withCertificateAuthorityConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `certificate_authority_config` field.\n', args=[]),
  ...
  '#withKeyAlgorithm':: d.fn(help='`google-beta.string.withKeyAlgorithm` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the key_algorithm field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `key_algorithm` field.\n', args=[]),
