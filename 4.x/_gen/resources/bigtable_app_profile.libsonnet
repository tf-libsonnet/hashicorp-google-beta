...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSingleClusterRoutingMixin':: d.fn(help='`google-beta.list[obj].withSingleClusterRoutingMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the single_cluster_routing field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withSingleClusterRouting](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `single_cluster_routing` field.\n', args=[]),
  ...
  '#withStandardIsolation':: d.fn(help='`google-beta.list[obj].withStandardIsolation` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the standard_isolation field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withStandardIsolationMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `standard_isolation` field.\n', args=[]),
  withStandardIsolation(resourceLabel, value): {
    resource+: {
      google_bigtable_app_profile+: {
        [resourceLabel]+: {
          standard_isolation: value,
        },
      },
    },
  },
  '#withStandardIsolationMixin':: d.fn(help='`google-beta.list[obj].withStandardIsolationMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the standard_isolation field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withStandardIsolation](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `standard_isolation` field.\n', args=[]),
  withStandardIsolationMixin(resourceLabel, value): {
    resource+: {
      google_bigtable_app_profile+: {
        [resourceLabel]+: {
          standard_isolation+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
