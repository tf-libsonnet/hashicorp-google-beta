...
{
  '#':: d.pkg(name='google_scc_organization_custom_module', url='', help='`google_scc_organization_custom_module` represents the `google-beta_google_scc_organization_custom_module` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  custom_config:: {
    custom_output:: {
  ...
  '#withCustomConfigMixin':: d.fn(help='`google-beta.list[obj].withCustomConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the custom_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withCustomConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `custom_config` field.\n', args=[]),
