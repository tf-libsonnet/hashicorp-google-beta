...
{
  '#':: d.pkg(name='google_iam_access_boundary_policy', url='', help='`google_iam_access_boundary_policy` represents the `google-beta_google_iam_access_boundary_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
