...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDryRunSpec':: d.fn(help='`google-beta.list[obj].withDryRunSpec` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the dry_run_spec field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withDryRunSpecMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `dry_run_spec` field.\n', args=[]),
  withDryRunSpec(resourceLabel, value): {
    resource+: {
  ...
  '#withDryRunSpecMixin':: d.fn(help='`google-beta.list[obj].withDryRunSpecMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the dry_run_spec field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withDryRunSpec](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `dry_run_spec` field.\n', args=[]),
  withDryRunSpecMixin(resourceLabel, value): {
    resource+: {
      google_org_policy_policy+: {
        [resourceLabel]+: {
          dry_run_spec+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
