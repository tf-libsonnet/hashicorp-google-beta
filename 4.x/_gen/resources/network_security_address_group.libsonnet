...
{
  '#':: d.pkg(name='google_network_security_address_group', url='', help='`google_network_security_address_group` represents the `google-beta_google_network_security_address_group` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withItems':: d.fn(help='`google-beta.list.withItems` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the items field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `items` field.\n', args=[]),
