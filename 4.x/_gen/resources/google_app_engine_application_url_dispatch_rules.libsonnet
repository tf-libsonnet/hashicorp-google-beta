...
{
  '#':: d.pkg(name='google_app_engine_application_url_dispatch_rules', url='', help='`google_app_engine_application_url_dispatch_rules` represents the `google-beta_google_app_engine_application_url_dispatch_rules` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  dispatch_rules:: {
  ...
  '#withDispatchRules':: d.fn(help='`google-beta.google_app_engine_application_url_dispatch_rules.withDispatchRules` constructs a mixin object that can be merged into the `google_app_engine_application_url_dispatch_rules`\nTerraform resource block to set or update the dispatch_rules field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dispatch_rules` field.\n', args=[]),
  ...
  '#withDispatchRulesMixin':: d.fn(help='`google-beta.google_app_engine_application_url_dispatch_rules.withDispatchRulesMixin` constructs a mixin object that can be merged into the `google_app_engine_application_url_dispatch_rules`\nTerraform resource block to set or update the dispatch_rules field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_app_engine_application_url_dispatch_rules.withDispatchRules](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dispatch_rules` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google-beta.google_app_engine_application_url_dispatch_rules.withProject` constructs a mixin object that can be merged into the `google_app_engine_application_url_dispatch_rules`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_app_engine_application_url_dispatch_rules.withTimeouts` constructs a mixin object that can be merged into the `google_app_engine_application_url_dispatch_rules`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_app_engine_application_url_dispatch_rules.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_app_engine_application_url_dispatch_rules`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_app_engine_application_url_dispatch_rules.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
