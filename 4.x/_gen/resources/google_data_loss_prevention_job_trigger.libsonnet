...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  triggers:: {
    '#new':: d.fn(help='\n`google-beta.google_data_loss_prevention_job_trigger.triggers.new` constructs a new object with attributes and blocks configured for the `triggers`\nTerraform sub block.\n\n\n\n**Args**:\n  - `schedule` (`list[obj]`): Schedule for triggered jobs When `null`, the `schedule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_data_loss_prevention_job_trigger.triggers.schedule.new](#fn-schedulenew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `triggers` sub block.\n', args=[]),
    new(
      schedule=null
    ):: std.prune(a={
      schedule: schedule,
