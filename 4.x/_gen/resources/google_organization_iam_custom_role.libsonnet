...
{
  '#':: d.pkg(name='google_organization_iam_custom_role', url='', help='`google_organization_iam_custom_role` represents the `google-beta_google_organization_iam_custom_role` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`google-beta.google_organization_iam_custom_role.withDescription` constructs a mixin object that can be merged into the `google_organization_iam_custom_role`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withOrgId':: d.fn(help='`google-beta.google_organization_iam_custom_role.withOrgId` constructs a mixin object that can be merged into the `google_organization_iam_custom_role`\nTerraform resource block to set or update the org_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `org_id` field.\n', args=[]),
  ...
  '#withPermissions':: d.fn(help='`google-beta.google_organization_iam_custom_role.withPermissions` constructs a mixin object that can be merged into the `google_organization_iam_custom_role`\nTerraform resource block to set or update the permissions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permissions` field.\n', args=[]),
  ...
  '#withRoleId':: d.fn(help='`google-beta.google_organization_iam_custom_role.withRoleId` constructs a mixin object that can be merged into the `google_organization_iam_custom_role`\nTerraform resource block to set or update the role_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_id` field.\n', args=[]),
  ...
  '#withStage':: d.fn(help='`google-beta.google_organization_iam_custom_role.withStage` constructs a mixin object that can be merged into the `google_organization_iam_custom_role`\nTerraform resource block to set or update the stage field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage` field.\n', args=[]),
  ...
  '#withTitle':: d.fn(help='`google-beta.google_organization_iam_custom_role.withTitle` constructs a mixin object that can be merged into the `google_organization_iam_custom_role`\nTerraform resource block to set or update the title field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `title` field.\n', args=[]),
