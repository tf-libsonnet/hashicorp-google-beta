...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withTriggerId':: d.fn(help='`google-beta.string.withTriggerId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the trigger_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `trigger_id` field.\n', args=[]),
  withTriggerId(resourceLabel, value): {
    resource+: {
      google_data_loss_prevention_job_trigger+: {
        [resourceLabel]+: {
          trigger_id: value,
