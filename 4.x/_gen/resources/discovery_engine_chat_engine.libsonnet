...
{
  '#':: d.pkg(name='google_discovery_engine_chat_engine', url='', help='`google_discovery_engine_chat_engine` represents the `google-beta_google_discovery_engine_chat_engine` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  chat_engine_config:: {
  ...
  '#withChatEngineConfigMixin':: d.fn(help='`google-beta.list[obj].withChatEngineConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the chat_engine_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withChatEngineConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `chat_engine_config` field.\n', args=[]),
