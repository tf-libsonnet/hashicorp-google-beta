...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    enable_ipv6=null,
    ip_address=null,
    ipv6_nexthop_address=null,
    md5_authentication_key=null,
    peer_ip_address=null,
    peer_ipv6_nexthop_address=null,
    project=null,
    region=null,
  ...
  '#withAdvertisedIpRangesMixin':: d.fn(help='`google-beta.list[obj].withAdvertisedIpRangesMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the advertised_ip_ranges field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withAdvertisedIpRanges](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `advertised_ip_ranges` field.\n', args=[]),
  ...
  '#withBfdMixin':: d.fn(help='`google-beta.list[obj].withBfdMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the bfd field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withBfd](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `bfd` field.\n', args=[]),
  ...
  '#withEnable':: d.fn(help='`google-beta.bool.withEnable` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable` field.\n', args=[]),
  ...
  '#withEnableIpv6':: d.fn(help='`google-beta.bool.withEnableIpv6` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_ipv6 field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_ipv6` field.\n', args=[]),
  withEnableIpv6(resourceLabel, value): {
    resource+: {
      google_compute_router_peer+: {
        [resourceLabel]+: {
          enable_ipv6: value,
  ...
  '#withIpv6NexthopAddress':: d.fn(help='`google-beta.string.withIpv6NexthopAddress` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the ipv6_nexthop_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `ipv6_nexthop_address` field.\n', args=[]),
  withIpv6NexthopAddress(resourceLabel, value): {
    resource+: {
      google_compute_router_peer+: {
        [resourceLabel]+: {
          ipv6_nexthop_address: value,
        },
      },
    },
  },
  '#withMd5AuthenticationKey':: d.fn(help='`google-beta.list[obj].withMd5AuthenticationKey` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the md5_authentication_key field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withMd5AuthenticationKeyMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `md5_authentication_key` field.\n', args=[]),
  withMd5AuthenticationKey(resourceLabel, value): {
    resource+: {
      google_compute_router_peer+: {
        [resourceLabel]+: {
          md5_authentication_key: value,
        },
      },
    },
  },
  '#withMd5AuthenticationKeyMixin':: d.fn(help='`google-beta.list[obj].withMd5AuthenticationKeyMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the md5_authentication_key field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withMd5AuthenticationKey](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `md5_authentication_key` field.\n', args=[]),
  withMd5AuthenticationKeyMixin(resourceLabel, value): {
    resource+: {
      google_compute_router_peer+: {
        [resourceLabel]+: {
          md5_authentication_key+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withPeerAsn':: d.fn(help='`google-beta.number.withPeerAsn` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the peer_asn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `peer_asn` field.\n', args=[]),
  ...
  '#withPeerIpv6NexthopAddress':: d.fn(help='`google-beta.string.withPeerIpv6NexthopAddress` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the peer_ipv6_nexthop_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `peer_ipv6_nexthop_address` field.\n', args=[]),
  withPeerIpv6NexthopAddress(resourceLabel, value): {
    resource+: {
      google_compute_router_peer+: {
        [resourceLabel]+: {
          peer_ipv6_nexthop_address: value,
        },
      },
    },
  },
  ...
  '#withRouter':: d.fn(help='`google-beta.string.withRouter` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the router field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `router` field.\n', args=[]),
  ...
  '#withRouterApplianceInstance':: d.fn(help='`google-beta.string.withRouterApplianceInstance` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the router_appliance_instance field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `router_appliance_instance` field.\n', args=[]),
  withRouterApplianceInstance(resourceLabel, value): {
    resource+: {
      google_compute_router_peer+: {
        [resourceLabel]+: {
          router_appliance_instance: value,
        },
      },
    },
  },
