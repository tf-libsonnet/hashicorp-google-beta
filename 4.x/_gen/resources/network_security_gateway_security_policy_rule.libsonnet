...
{
  '#':: d.pkg(name='google_network_security_gateway_security_policy_rule', url='', help='`google_network_security_gateway_security_policy_rule` represents the `google-beta_google_network_security_gateway_security_policy_rule` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBasicProfile':: d.fn(help='`google-beta.string.withBasicProfile` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the basic_profile field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `basic_profile` field.\n', args=[]),
  ...
  '#withSessionMatcher':: d.fn(help='`google-beta.string.withSessionMatcher` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the session_matcher field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `session_matcher` field.\n', args=[]),
