...
{
  '#':: d.pkg(name='google_billing_budget', url='', help='`google_billing_budget` represents the `google-beta_google_billing_budget` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  all_updates_rule:: {
  ...
  '#new':: d.fn(help="\n`google-beta.google_billing_budget.new` injects a new `google-beta_google_billing_budget` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    google-beta.google_billing_budget.new('some_id')\n\nYou can get the reference to the `id` field of the created `google-beta.google_billing_budget` using the reference:\n\n    $._ref.google-beta_google_billing_budget.some_id.get('id')\n\nThis is the same as directly entering `\"${ google-beta_google_billing_budget.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `billing_account` (`string`): ID of the billing account to set a budget on.\n  - `display_name` (`string`): User data for display name in UI. Must be \u0026lt;= 60 chars. When `null`, the `display_name` field will be omitted from the resulting object.\n  - `all_updates_rule` (`list[obj]`): Defines notifications that are sent on every update to the\nbilling account\u0026#39;s spend, regardless of the thresholds defined\nusing threshold rules. When `null`, the `all_updates_rule` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_billing_budget.all_updates_rule.new](#fn-googlebillingbudgetallupdatesrulenew) constructor.\n  - `amount` (`list[obj]`): The budgeted amount for each usage period. When `null`, the `amount` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_billing_budget.amount.new](#fn-googlebillingbudgetamountnew) constructor.\n  - `budget_filter` (`list[obj]`): Filters that define which resources are used to compute the actual\nspend against the budget. When `null`, the `budget_filter` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_billing_budget.budget_filter.new](#fn-googlebillingbudgetbudgetfilternew) constructor.\n  - `threshold_rules` (`list[obj]`): Rules that trigger alerts (notifications of thresholds being\ncrossed) when spend exceeds the specified percentages of the\nbudget. When `null`, the `threshold_rules` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_billing_budget.threshold_rules.new](#fn-googlebillingbudgetthresholdrulesnew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google-beta.google_billing_budget.timeouts.new](#fn-googlebillingbudgettimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    billing_account,
  ...
  '#withAllUpdatesRule':: d.fn(help='`google-beta.google_billing_budget.withAllUpdatesRule` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the all_updates_rule field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `all_updates_rule` field.\n', args=[]),
  ...
  '#withAllUpdatesRuleMixin':: d.fn(help='`google-beta.google_billing_budget.withAllUpdatesRuleMixin` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the all_updates_rule field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_billing_budget.withAllUpdatesRule](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `all_updates_rule` field.\n', args=[]),
  ...
  '#withAmount':: d.fn(help='`google-beta.google_billing_budget.withAmount` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the amount field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `amount` field.\n', args=[]),
  ...
  '#withAmountMixin':: d.fn(help='`google-beta.google_billing_budget.withAmountMixin` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the amount field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_billing_budget.withAmount](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `amount` field.\n', args=[]),
  ...
  '#withBillingAccount':: d.fn(help='`google-beta.google_billing_budget.withBillingAccount` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the billing_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `billing_account` field.\n', args=[]),
  ...
  '#withBudgetFilter':: d.fn(help='`google-beta.google_billing_budget.withBudgetFilter` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the budget_filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `budget_filter` field.\n', args=[]),
  ...
  '#withBudgetFilterMixin':: d.fn(help='`google-beta.google_billing_budget.withBudgetFilterMixin` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the budget_filter field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_billing_budget.withBudgetFilter](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `budget_filter` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google-beta.google_billing_budget.withDisplayName` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withThresholdRules':: d.fn(help='`google-beta.google_billing_budget.withThresholdRules` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the threshold_rules field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `threshold_rules` field.\n', args=[]),
  ...
  '#withThresholdRulesMixin':: d.fn(help='`google-beta.google_billing_budget.withThresholdRulesMixin` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the threshold_rules field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.google_billing_budget.withThresholdRules](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `threshold_rules` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google-beta.google_billing_budget.withTimeouts` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google-beta.google_billing_budget.withTimeoutsMixin` constructs a mixin object that can be merged into the `google_billing_budget`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google-beta.google_billing_budget.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
