...
{
  '#':: d.pkg(name='google_scc_event_threat_detection_custom_module', url='', help='`google_scc_event_threat_detection_custom_module` represents the `google-beta_google_scc_event_threat_detection_custom_module` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withEnablementState':: d.fn(help='`google-beta.string.withEnablementState` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the enablement_state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `enablement_state` field.\n', args=[]),
