...
{
  '#':: d.pkg(name='google_data_catalog_policy_tag_iam_policy', url='', help='`google_data_catalog_policy_tag_iam_policy` represents the `google-beta_google_data_catalog_policy_tag_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicyData':: d.fn(help='`google-beta.google_data_catalog_policy_tag_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withPolicyTag':: d.fn(help='`google-beta.google_data_catalog_policy_tag_iam_policy.withPolicyTag` constructs a mixin object that can be merged into the `google_data_catalog_policy_tag_iam_policy`\nTerraform resource block to set or update the policy_tag field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_tag` field.\n', args=[]),
