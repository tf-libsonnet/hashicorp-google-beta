...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAsyncPrimaryDiskMixin':: d.fn(help='`google-beta.list[obj].withAsyncPrimaryDiskMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the async_primary_disk field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withAsyncPrimaryDisk](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `async_primary_disk` field.\n', args=[]),
  ...
  '#withEnableConfidentialCompute':: d.fn(help='`google-beta.bool.withEnableConfidentialCompute` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the enable_confidential_compute field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `enable_confidential_compute` field.\n', args=[]),
  withEnableConfidentialCompute(resourceLabel, value): {
    resource+: {
      google_compute_disk+: {
        [resourceLabel]+: {
  ...
  '#withProvisionedThroughput':: d.fn(help='`google-beta.number.withProvisionedThroughput` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the provisioned_throughput field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `provisioned_throughput` field.\n', args=[]),
