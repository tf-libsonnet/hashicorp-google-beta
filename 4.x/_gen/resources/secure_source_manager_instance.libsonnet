...
{
  '#':: d.pkg(name='google_secure_source_manager_instance', url='', help='`google_secure_source_manager_instance` represents the `google-beta_google_secure_source_manager_instance` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPrivateConfig':: d.fn(help='`google-beta.list[obj].withPrivateConfig` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the private_config field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withPrivateConfigMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `private_config` field.\n', args=[]),
  withPrivateConfig(resourceLabel, value): {
    resource+: {
      google_secure_source_manager_instance+: {
        [resourceLabel]+: {
          private_config: value,
        },
      },
    },
  },
  '#withPrivateConfigMixin':: d.fn(help='`google-beta.list[obj].withPrivateConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the private_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withPrivateConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `private_config` field.\n', args=[]),
  withPrivateConfigMixin(resourceLabel, value): {
    resource+: {
      google_secure_source_manager_instance+: {
        [resourceLabel]+: {
          private_config+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
