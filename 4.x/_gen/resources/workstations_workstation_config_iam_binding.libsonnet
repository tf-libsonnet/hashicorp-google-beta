...
{
  '#':: d.pkg(name='google_workstations_workstation_config_iam_binding', url='', help='`google_workstations_workstation_config_iam_binding` represents the `google-beta_google_workstations_workstation_config_iam_binding` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  condition:: {
  ...
  new(
    ...
    type='google_workstations_workstation_config_iam_binding',
    label=resourceLabel,
    attrs=self.newAttrs(
      condition=condition,
      location=location,
