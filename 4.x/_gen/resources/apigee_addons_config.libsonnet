...
{
  '#':: d.pkg(name='google_apigee_addons_config', url='', help='`google_apigee_addons_config` represents the `google-beta_google_apigee_addons_config` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  addons_config:: {
  ...
  '#withOrg':: d.fn(help='`google-beta.string.withOrg` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the org field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `org` field.\n', args=[]),
