...
{
  '#':: d.pkg(name='google_workbench_instance', url='', help='`google_workbench_instance` represents the `google-beta_google_workbench_instance` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  gce_setup:: {
    accelerator_configs:: {
  ...
  '#withGceSetupMixin':: d.fn(help='`google-beta.list[obj].withGceSetupMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the gce_setup field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withGceSetup](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `gce_setup` field.\n', args=[]),
