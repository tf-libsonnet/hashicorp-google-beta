...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccessRestrictions':: d.fn(help='`google-beta.list[obj].withAccessRestrictions` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the access_restrictions field.\n\nThis function will replace the array with the passed in `value`. If you wish to instead append the\npassed in value to the existing array, use the [google-beta.list[obj].withAccessRestrictionsMixin](TODO) function.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `access_restrictions` field.\n', args=[]),
  withAccessRestrictions(resourceLabel, value): {
    resource+: {
      google_iam_workforce_pool+: {
        [resourceLabel]+: {
          access_restrictions: value,
        },
      },
    },
  },
  '#withAccessRestrictionsMixin':: d.fn(help='`google-beta.list[obj].withAccessRestrictionsMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the access_restrictions field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google-beta.list[obj].withAccessRestrictions](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `access_restrictions` field.\n', args=[]),
  withAccessRestrictionsMixin(resourceLabel, value): {
    resource+: {
      google_iam_workforce_pool+: {
        [resourceLabel]+: {
          access_restrictions+: if std.isArray(v=value) then value else [value],
        },
      },
    },
  },
  ...
  '#withSessionDuration':: d.fn(help='`google-beta.string.withSessionDuration` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the session_duration field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `session_duration` field.\n', args=[]),
