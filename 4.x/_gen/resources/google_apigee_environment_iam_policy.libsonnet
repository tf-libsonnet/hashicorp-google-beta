...
{
  '#':: d.pkg(name='google_apigee_environment_iam_policy', url='', help='`google_apigee_environment_iam_policy` represents the `google-beta_google_apigee_environment_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withEnvId':: d.fn(help='`google-beta.google_apigee_environment_iam_policy.withEnvId` constructs a mixin object that can be merged into the `google_apigee_environment_iam_policy`\nTerraform resource block to set or update the env_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `env_id` field.\n', args=[]),
  ...
  '#withOrgId':: d.fn(help='`google-beta.google_apigee_environment_iam_policy.withOrgId` constructs a mixin object that can be merged into the `google_apigee_environment_iam_policy`\nTerraform resource block to set or update the org_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `org_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google-beta.google_apigee_environment_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `google_apigee_environment_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
