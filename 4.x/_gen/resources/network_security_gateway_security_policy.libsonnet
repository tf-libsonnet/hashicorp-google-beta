...
{
  '#':: d.pkg(name='google_network_security_gateway_security_policy', url='', help='`google_network_security_gateway_security_policy` represents the `google-beta_google_network_security_gateway_security_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withTlsInspectionPolicy':: d.fn(help='`google-beta.string.withTlsInspectionPolicy` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the tls_inspection_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `tls_inspection_policy` field.\n', args=[]),
  withTlsInspectionPolicy(resourceLabel, value): {
    resource+: {
      google_network_security_gateway_security_policy+: {
        [resourceLabel]+: {
          tls_inspection_policy: value,
        },
      },
    },
  },
